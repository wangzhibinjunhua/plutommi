...
extern void mmi_vrsi_rcg_play_prompt_callback(mdi_result event, void *user_data);
...
extern void mmi_vrsi_mdi_callback_hdlr(mdi_result result, void *user_data);
...
extern void mmi_vrsi_setting_menu_pre_entry(void);
...
extern mmi_ret mmi_vrsi_phb_evt_hdlr(mmi_event_struct* param);
...
extern void mmi_vrsi_ndial_multiple_record_show_hint(U16 **name_ptr);
...
extern void mmi_vrsi_ndial_dial_entry_for_sendkey(void);


#if defined(__MMI_VRSI_TRAIN_TAG__)
extern mmi_ret mmi_vrsi_delete_contact_callback(mmi_event_struct* para);
...
extern void mmi_vrsi_ddial_dial_number_for_sendkey(void);
...
extern void mmi_vrsi_redial_dial_number_for_sendkey(void);
