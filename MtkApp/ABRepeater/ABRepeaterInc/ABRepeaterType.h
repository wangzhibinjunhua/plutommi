...
typedef struct
{
    ...
    MMI_BOOL is_main_sel_btn_down;
    MMI_BOOL is_absection_sel_btn_down;
    MMI_BOOL is_init_scrolling_text;
    MMI_BOOL is_replay_on;
    MMI_BOOL is_short_name;
    
    S16 absection_sel_btn;
