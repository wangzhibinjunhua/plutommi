...
typedef struct
{
    ...
    U16 volume_dec_button_up_img_id,volume_dec_button_down_img_id,volume_dec_button_disable_img_id;
    
    S16 volume_inc_x,volume_inc_y;
    U16 volume_inc_button_up_img_id,volume_inc_button_down_img_id,volume_inc_button_disable_img_id;
...
/* not following coding convention for consistency */
typedef enum
{
    AB_VOLUMECTRL_DEC,
    AB_VOLUMECTRL_INC,
    AB_VOLUMECTRL_TOTAL
}mmi_abrepeat_volumectrl_type_enum;
