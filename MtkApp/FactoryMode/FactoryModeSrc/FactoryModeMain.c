...
#else /*defined(__MMI_ENGINEER_MODE__)*/
...
const mmi_fm_test_item_struct g_fm_test_item_tab[] =
{
    ...
    /* Vibrator */
// del by donghanchao     {MENU_ID_FM_VIBRATOR,               mmi_fm_select_vibrator,             (mmi_fm_highlight_func)mmi_fm_vibrator_highlight},
    ...
    /* Ringtone */
// del by donghanchao     {MENU_ID_FM_RINGTONE,               (mmi_fm_select_func)mmi_fm_select_ring_tone,            (mmi_fm_highlight_func)mmi_fm_ring_tone_highlight},
    ...
    /* Receiver */
// del by donghanchao     {MENU_ID_FM_RECEIVER,               (mmi_fm_select_func)mmi_fm_select_receiver_hdlr,        (mmi_fm_highlight_func)mmi_fm_highlight_receiver_hdlr},
 
#endif /* __MMI_FM_PLUTO_6261_SLIM__ */

    /* ADC */
// del by donghanchao    {MENU_ID_FM_ADC,                    (mmi_fm_select_func)mmi_fm_select_adc_menu,             mmi_fm_default_func},

    /*Headset*/
// del by donghanchao    {MENU_ID_FM_HEADSET,                (mmi_fm_select_func)mmi_fm_select_headset,              (mmi_fm_highlight_func)mmi_fm_highlight_headset},

    /* RTC */
// del by donghanchao     {MENU_ID_FM_RTC,                    (mmi_fm_select_func)mmi_fm_select_rtc,                  mmi_fm_default_func},
#ifndef __MMI_FM_PLUTO_6261_SLIM__
