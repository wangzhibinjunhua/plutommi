 ...
 * $Log$
 *
 * 11 10 2015 zhen.tian
 * [MAUI_03548059] [FactoryrMode]Add  some test items for MT2503
 * .
 *
 * 11 10 2015 zhen.tian
 * [MAUI_03548059] [FactoryrMode]Add  some test items for MT2503
 * .
 *
 * 11 06 2015 zhen.tian
 * [MAUI_03548059] [FactoryrMode]Add  some test items for MT2503
 * .
 *
 * 07 06 2015 zhen.tian
 * [MAUI_03526267] [Factory Mode]fix build error.
 * .
 *
 * 10 23 2013 yuan.yin
...
#ifdef __HC_S6100__
    //<STRING id = "STR_ID_FM_TEST_DISTANCE_SENSOR"/>    
    //<STRING id = "STR_ID_FM_TEST_MIC"/>
    //<STRING id = "STR_ID_FM_TEST_GPS"/>
    <STRING id = "STR_ID_FM_TEST_DISTANCE_SENSOR">DISTANCE</STRING>
    <STRING id = "STR_ID_FM_TEST_MIC">MIC</STRING>
    <STRING id = "STR_ID_FM_TEST_GPS">Test GPS</STRING>
    <STRING id = "STR_ID_FM_TESTED_GPS">GPS</STRING>
    <STRING id = "STR_ID_FM_MOTION_SENSOR">Motion</STRING>
    <STRING id = "STR_ID_FM_MOVE_SENSOR">plaease move the sensor!</STRING>
#endif
...
// del by donghanchao		<MENUITEM_ID>MENU_ID_FM_VERSION</MENUITEM_ID>  
#ifdef __HC_S6100__
		<MENUITEM id="MENU_ID_FM_TEST_DISTANCE_SENSOR" str="STR_ID_FM_TEST_DISTANCE_SENSOR"/>
		//<MENUITEM id="MENU_ID_FM_TEST_MIC" str="STR_ID_FM_TEST_MIC"/>
		<MENUITEM id="MENU_ID_FM_TEST_GPS" str="STR_ID_FM_TEST_GPS"/>
		<MENUITEM id="MENU_ID_FM_TEST_MOTION" str="STR_ID_FM_MOTION_SENSOR"/>
    ...
    #endif
#ifndef __MMI_FM_MERGE_AUTO_TEST__	
// del by donghanchao        <MENUITEM id="MENU_ID_FM_VIBRATOR" str="STR_ID_FM_VIBRATOR"/>
        <MENUITEM id="MENU_ID_FM_LOUDSPK" str="STR_ID_FM_LOUDSPK"/> 
#endif /* __MMI_FM_MERGE_AUTO_TEST__ */

// del by donghanchao        <MENUITEM id="MENU_ID_FM_RINGTONE" str="STR_GLOBAL_RINGTONE"/>
...
// del by donghanchao        <MENUITEM_ID>MENU_ID_FM_LCD</MENUITEM_ID>
        
#ifndef __MMI_FM_MERGE_AUTO_TEST__	      
    #ifdef __MMI_FM_LCD_CONTRAST__        
        <MENUITEM_ID>MENU_ID_FM_LCD_CONTRAST</MENUITEM_ID>
    #endif                        
// del by donghanchao        <MENUITEM id="MENU_ID_FM_RECEIVER" str="STR_ID_FM_RECEIVER"/>
#endif /* __MMI_FM_MERGE_AUTO_TEST__ */
// del by donghanchao        <MENUITEM id="MENU_ID_FM_ADC" str="STR_ID_FM_ADC"/>            
...
// del by donghanchao        <MENUITEM id="MENU_ID_FM_RTC" str="STR_ID_FM_RTC"/>        
#ifndef __MMI_FM_MERGE_AUTO_TEST__	
    #ifdef __MMI_FM_MTBF__            
    ...
    */
     ...
     #ifdef __MMI_FACTORY_MODE__
// del by donghanchao         <MENUITEM_ID>MENU_ID_FM_MISC_AUTO_TEST_SETTING</MENUITEM_ID>
    #endif 
...
#ifdef __HC_S6100__
    <SCREEN id = "SCR_ID_FM_GPS_TEST"/> 
    <SCREEN id = "SCR_ID_FM_DISTANCE_TEST"/> 
    <SCREEN id = "SCR_ID_FM_MOTION_TEST"/> 
#endif
