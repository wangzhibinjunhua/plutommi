...
** 1.6   JAVA_CM_DELETE
*****************************************************************************/
extern void mmi_java_mids_delete(kal_uint32 mids_id, kal_char* mids_storage_id);
...
#ifndef __MMI_JAVA_INSTALL_DELETE_MENU__
#define __MMI_JAVA_INSTALL_DELETE_MENU__
#endif
    
#ifndef __MMI_JAVA_INSTALL_AUTHENTICATION__
#define __MMI_JAVA_INSTALL_AUTHENTICATION__
#endif
    
#ifndef __MMI_JAVA_INSTALL_PUSHINSTALL__
#define __MMI_JAVA_INSTALL_PUSHINSTALL__
#endif
    
#ifndef __MMI_JAVA_INSTALL_SEND_REPORT__
#define __MMI_JAVA_INSTALL_SEND_REPORT__
#endif
    
#ifndef __MMI_JAVA_INSTALL_DELETE_NOTIFIER__
#define __MMI_JAVA_INSTALL_DELETE_NOTIFIER__
#endif
    
#ifndef __MMI_JAVA_MIDS_UPDATE_CONFIRM__
#define __MMI_JAVA_MIDS_UPDATE_CONFIRM__
#endif

#ifndef __MMI_JAVA_INSTALL_DOWNLOAD_JAR_IND__
#define __MMI_JAVA_INSTALL_DOWNLOAD_JAR_IND__ 
#endif

#ifndef __MMI_JAVA_GLOBAL_SETTING__
#define __MMI_JAVA_GLOBAL_SETTING__
#endif

#endif /*J2ME_SLIM_MEMORY_SUPPORT*/

#ifndef __MMI_JAVA_LAUNCH_AFTER_INSTALL__
#define __MMI_JAVA_LAUNCH_AFTER_INSTALL__
#endif
...
extern void mmi_java_report_status(mmi_java_cmd_enum java_cmd,kal_int32 error_code,S8 * mids_storage_id,U16 * mids_name,S8 * mids_version);
/*****************************************************************************
 * RMS
 ************************************/
...
#ifdef __OP02__
extern void mmi_java_recv_timealarm_push_get_setting_cnf_hdlr(void *MsgStruct);
#endif
extern void mmi_java_send_timealarm_push_res(U32 session_id, S8 permission, MMI_BOOL execute);
...
extern void mmi_java_timealarm_push_callback(U32 session_id, S8 permission, MMI_BOOL execute);
extern U8 mmi_java_timealarm_push_dummy_endkey_hdlr(void *ptr);
...
extern void mmi_java_display_is_busy_for_minimize_mode(void);
extern MMI_BOOL mmi_java_check_and_display(void);
extern void mmi_java_send_l4_get_lai_req(void);
extern void mmi_java_update_mids_runtime_info_req(kal_int32 vm_id);
...
extern void mmi_java_send_mids_get_confirm_res(MMI_BOOL confirm);
...
extern S8 *mmi_java_ucs2cat_secure(S8 *strDestination, const S8 *strSource, S32 destSize);
...
typedef struct
{
    ...
    S8 fmgr_hyperlink_sub_title[(FMGR_SUB_TITLE_LENGTH + 1)<<1];
...
extern void mmi_java_entry_setting_with_inline_cui(void); // extern func of funandgamessrc.c
extern U16 mmi_java_get_nw_inline_item_id(void);
...
extern void mmi_java_entry_menu_ask_terminate_cb(MMI_BOOL terminate);
...
typedef struct _mmi_java_nw_cntx_t
{
    ...
    MMI_ID sg_id_parent;
    MMI_ID sg_id_dtcnt;
    MMI_ID sg_id_always_ask;
    MMI_ID sg_id_bearer_fallback;
    MMI_ID sg_id_inline_editor;
    #ifndef __COSMOS_MMI_PACKAGE__
    jam_mids_network_struct network;
    #else
    vapp_jam_mids_network_struct network;
    vapp_jam_mids_network_struct network2;
    kal_uint8 sim_index;
    #endif
    jam_nw_dynamic_data_struct *always_ask_ptr;
    jam_nw_dynamic_data_struct *bearer_fallback_ptr;
    S8 account_name[2 * (MAX_DATA_ACCOUNT_NAME_LEN + DATA_ACCOUNT_NAME_SUFFIX_LEN + 1) * ENCODING_LENGTH];
