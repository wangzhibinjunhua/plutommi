 ...
 * RETURNS
 *****************************************************************************/
S8 *mmi_java_ucs2cat_secure(S8 *strDestination, const S8 *strSource, S32 destSize)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
#ifdef WAP_SUPPORT/* The folloing API is not available in cosmos */
#ifndef __COSMOS_MMI_PACKAGE__
 ...
 *  void
 *****************************************************************************/
void mmi_java_display_is_busy_internal(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if(mmi_frm_scrn_enter(GRP_ID_JAVA_BUSY, SCR_J2ME_SCREEN_NOT_READY, mmi_java_widget_not_ready,mmi_java_display_is_busy_internal, MMI_FRM_FG_ONLY_SCRN))
    {
...
void mmi_java_display_is_busy_for_pause_mode(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_popup_display_ext(STR_JAVA_BUSY_FOR_PAUSE_MODE, MMI_EVENT_FAILURE, NULL);
 ...
 *  void
 *****************************************************************************/
void mmi_java_display_is_busy_for_minimize_mode(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_popup_display_ext(STR_JAVA_BUSY_FOR_MINIMIZE_MODE, MMI_EVENT_FAILURE, NULL);
}
 ...
 *  MMI_TRUE or MMI_FALSE
 *****************************************************************************/
MMI_BOOL mmi_java_check_and_display(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /*----------------------------------------------------------------*/
#ifndef __MVM__
    if (jam_mvm_is_pause_mode(0))
    {
        mmi_java_display_is_busy_for_pause_mode();
        return MMI_TRUE;
    }
    else if(jam_mvm_is_minimize_mode(0))
    {
        mmi_java_display_is_busy_for_minimize_mode();
        return MMI_TRUE;
    }
    else if (jam_vm_is_busy())
    {
        mmi_java_display_is_busy();
        return MMI_TRUE;
    }
 ...
 *  MMI_TRUE or MMI_FALSE
 *****************************************************************************/
MMI_BOOL mmi_java_check_and_display_is_busy(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
void mmi_java_entry_get_permission_ext(void)
{
    ...
    {
        mmi_java_ucs2cat_secure((S8*)buffer, (S8*)mmi_java_get_permission_msg.appendix,
...
#elif defined (__COSMOS_MMI_PACKAGE__)   
    vapp_java_get_permission_entry(buffer,title_id);
#endif
}
 ...
 *  void
 *****************************************************************************/
void mmi_java_send_mids_get_confirm_res(MMI_BOOL confirm)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    mmi_java_send_message_from_active_mod(MOD_JAM, MMI_J2ME_SAP,
        MSG_ID_MMI_JAVA_GET_CONFIRM_RES, msg);
}
...
/*****************************************************************************
 * FUNCTION
 *  mmi_java_entry_mids_get_confirm_del_cb
 * DESCRIPTION
 ...
 *  return if we want to stop delete the screen
 *****************************************************************************/
U8 mmi_java_entry_mids_get_confirm_del_cb(void *in_param)
{
...
void mmi_java_entry_mids_get_confirm(void)
{
    ...
    if(mmi_frm_scrn_enter(APP_JAVA, SCR_JAVA_GET_CONFIRM, NULL, mmi_java_entry_mids_get_confirm,MMI_FRM_FULL_SCRN))
    {
    guiBuffer = mmi_frm_scrn_get_gui_buf(APP_JAVA, SCR_JAVA_GET_CONFIRM);
...
void mmi_java_send_message_from_active_mod( kal_int32 dst_id, kal_int32 sap_id, kal_int32 msg_id, void *local_para_ptr)
{
    ...
    msg_send5(src_mod_id, dst_id, sap_id, (msg_type) msg_id, 
...
void mmi_java_send_l4_get_imsi_req(void)
{
    ...
    mmi_java_send_message_from_active_mod(MOD_L4C, MMI_L4C_SAP, PRT_GET_IMSI_REQ, NULL);
}
