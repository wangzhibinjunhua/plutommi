...
{                                         
    ...
    pszUCS2Filename = get_ctrl_buffer((mmi_ucs2strlen((S8*)FMGR_DEFAULT_FOLDER_RECEIVED) +5)<<1);                                         
    kal_wsprintf(pszUCS2Filename,"C:\\\0");                                               
    mmi_ucs2cat((S8*)pszUCS2Filename,(S8*)FMGR_DEFAULT_FOLDER_RECEIVED);                  
    mmi_ucs2cat((S8*)pszUCS2Filename,(S8*)L"*");                                          
    ...
    {                                     
        ...
        {                                 
            ...
            {                             
                ...
                {                         
                    str_len = mmi_ucs2strlen((S8*)dummy);                                 
                    if(!mmi_ucs2cmp((S8*)(dummy + str_len - 4), (S8*)(L".jad")) ||        
                        !mmi_ucs2cmp((S8*)(dummy + str_len - 4), (S8*)(L".JAD")) ||       
                        !mmi_ucs2cmp((S8*)(dummy + str_len - 4), (S8*)(L".jar")) ||       
                        !mmi_ucs2cmp((S8*)(dummy + str_len - 4), (S8*)(L".JAR")))         
                    {                     
                        dir_len =  mmi_ucs2strlen((S8*)pszUCS2Filename);                  
                        delete_file_path = get_ctrl_buffer((dir_len+str_len+1)<<1);       
                        mmi_ucs2cpy((S8*)delete_file_path,(S8*)pszUCS2Filename);          
                        delete_file_path[dir_len-1] = L'\0';                              
                        mmi_ucs2cat((S8*)delete_file_path,(S8*)dummy);                    
...
{                                         
    ...
    if(jad_file_name)                     
    {                                     
        mmi_jad_file_name = (U16*)get_ctrl_buffer((mmi_ucs2strlen((S8*)jad_file_name)+1) * ENCODING_LENGTH);                              
        mmi_ucs2cpy((S8*)mmi_jad_file_name, (S8*)jad_file_name);                          
    }                                     
    if(jar_file_name)                     
    {                                     
        mmi_jar_file_name = (U16*)get_ctrl_buffer((mmi_ucs2strlen((S8*)jar_file_name)+1) * ENCODING_LENGTH);                              
        mmi_ucs2cpy((S8*)mmi_jar_file_name, (S8*)jar_file_name);                          
    }                                     
                                          
    if(download_url)                      
    {                                     
        mmi_download_url = (U16*)get_ctrl_buffer((mmi_ucs2strlen((S8*)download_url)+1) * ENCODING_LENGTH);                                
...
{                                         
    ...
    if(mmi_jad_file_name)                 
    {                                     
        mmi_saved_jad_file_name = (U16 *)get_ctrl_buffer((mmi_ucs2strlen((S8*)mmi_jad_file_name)+1) * ENCODING_LENGTH);                   
        mmi_ucs2cpy((S8*)mmi_saved_jad_file_name, (S8*)mmi_jad_file_name);                
    }                                     
    if(mmi_jar_file_name)                 
    {                                     
        mmi_saved_jar_file_name = (U16 *)get_ctrl_buffer((mmi_ucs2strlen((S8*)mmi_jar_file_name)+1) * ENCODING_LENGTH);                   
        mmi_ucs2cpy((S8*)mmi_saved_jar_file_name, (S8*)mmi_jar_file_name);                
    }                                     
                                          
    if(mmi_download_url)                  
    {                                     
        mmi_saved_download_url = (U16 *)get_ctrl_buffer((mmi_ucs2strlen((S8*)mmi_download_url)+1) * ENCODING_LENGTH);                     
        mmi_ucs2cpy((S8*)mmi_saved_download_url, (S8*)mmi_download_url);                  
    }                                     
...
{                                         
    ...
    if(mmi_saved_jad_file_name)           
    {                                     
        mmi_jad_file_name = (U16 *)get_ctrl_buffer((mmi_ucs2strlen((S8*)mmi_saved_jad_file_name)+1) * ENCODING_LENGTH);                   
        mmi_ucs2cpy((S8*)mmi_jad_file_name, (S8*)mmi_saved_jad_file_name);                
    }                                     
    if(mmi_saved_jar_file_name)           
    {                                     
        mmi_jar_file_name = (U16 *)get_ctrl_buffer((mmi_ucs2strlen((S8*)mmi_saved_jar_file_name)+1) * ENCODING_LENGTH);                   
        mmi_ucs2cpy((S8*)mmi_jar_file_name, (S8*)mmi_saved_jar_file_name);                
    }                                     
                                          
    if(mmi_saved_download_url)            
    {                                     
        mmi_download_url = (U16 *)get_ctrl_buffer((mmi_ucs2strlen((S8*)mmi_saved_download_url)+1) * ENCODING_LENGTH);                     
        mmi_ucs2cpy((S8*)mmi_download_url, (S8*)mmi_saved_download_url);                  
    }                                     
...
{                                         
    if (jad_path)                         
    {                                     
        mmi_jad_file_name = (U16*)get_ctrl_buffer((mmi_ucs2strlen((S8*)jad_path)+1) * ENCODING_LENGTH);                                   
        mmi_ucs2cpy((S8*)mmi_jad_file_name, (S8*)jad_path);                               
    }                                     
...
{                                         
    ...
    {                                     
        ...
        mmi_jar_file_name = (U16*)get_ctrl_buffer((mmi_ucs2strlen((S8*)jar_path)+1) * ENCODING_LENGTH);                                   
        mmi_ucs2cpy((S8*)mmi_jar_file_name, (S8*)jar_path);                               
    }                                     
...
{                                         
    ...
    {                                     
        ...
        {                                 
            str_length = mmi_ucs2strlen((S8*)msg->list_of_items[0]);                      
            ...
            mmi_ucs2ncpy((S8*)g_mmi_java_current_installing_mids_name, (S8*)msg->list_of_items[0], str_length);                           
        }                                 
    }                                     
...
{                                         
    ...
    {                                     
        mmi_ucs2ncpy((S8*)menu_data[i].item_list[0], (S8*)g_java.mids_info[i + start_index - g_java.mids_info_start].mids_name, MAX_SUBMENU_CHARACTERS);                                  
        ...
        {                                 
            ...
            mmi_ucs2cat((S8*)temp_string,(S8*)GetString(STR_JAVA_INFO_BYTE));             
            mmi_ucs2ncpy((S8*)menu_data[i].item_list[2],(S8*)temp_string,20);             
        }                                 
        else                              
        {                                 
            kal_wsprintf(temp_string, "%d \0", mids_size);                                
            mmi_ucs2cat((S8*)temp_string,(S8*)GetString(STR_JAVA_INFO_BYTES));            
            mmi_ucs2ncpy((S8*)menu_data[i].item_list[2],(S8*)temp_string,20);             
        }                                 
#if 0                                     
/* under construction !*/
...
{                                         
    ...
    mmi_ucs2cpy((S8*)g_java_str_of_delete_mids_menu_confirm,(S8*)str);                    
    for (i=0; i<str_len; i++)             
    {                                   
    ...
    mmi_ucs2cat((S8*)g_java_str_of_delete_mids_menu_confirm,(S8*)str2);                   
    mmi_ucs2cat((S8*)g_java_str_of_delete_mids_menu_confirm,(S8*)&str[i+2]);              
 ...
 *  void                                  
 *****************************************************************************/           
void mmi_java_entry_terminate_vm_confirm(void)                                            
{                                         
    /*----------------------------------------------------------------*/                  
    /* Local Variables*/                  
    /*----------------------------------------------------------------*/                  
...
void mmi_java_recv_mids_install_cnf(void *MsgStruct)                                      
{
    ...
    mmi_java_app_factory_record_struct record = {0};
    /*----------------------------------------------------------------*/                  
    /* Code Body      */                  
    /*----------------------------------------------------------------*/                  
    #ifdef __COSMOS_MMI_PACKAGE__
    ...
    //ASSERT(g_java.mids_install_state > INSTALL_VALID_STATE || g_java.mids_install_state == INSTALL_ABORT_STATE);
    if(!g_mmi_java_is_background_display)                                             
    {                                 
        mmi_frm_scrn_close(g_java_installer_cui_gid,SCR_JAVA_DUMMY);                  
    }                                 
    ...
    {                                 
        ...
        mmi_java_report_status(g_mmi_java_current_running_cmd,msg->error_code,(S8*)msg->mids_storage_id,(U16*)msg->mids_name,(S8*)msg->mids_version);                                 
        /* install success delete delete_menu */                                      
        if(!g_mmi_java_is_background_display)                                         
        {                             
            mmi_frm_scrn_close(g_java_installer_cui_gid,SCR_JAVA_DELETE_MENU);        
            mmi_frm_scrn_close(g_java_installer_cui_gid,SCR_JAVA_DELETE_MENU_CONFIRM);
        ...
        {                             
            ...
            mmi_frm_scrn_close(g_java_installer_cui_gid,SCR_JAVA_LAUNCH_AFTER_INSTALL);                                               
            mmi_frm_scrn_close(g_java_installer_cui_gid,SCR_JAVA_PUSH_INSTALL_CONFIRM);                                               
        ...
        {                             
            ...
            srv_java_appfactory_gen_app_name_after_install(g_java_current_install_app_name, msg->mids_name, msg->mids_vendor);
            memcpy(record.app_name,g_java_current_install_app_name,MMI_APP_NAME_MAX_LEN);
            memcpy(
                record.mids_name,
                msg->mids_name,
            ...
            {
                srv_java_appfactory_add_record(&record, KAL_TRUE);
            }
            else
            {
                srv_java_appfactory_add_record(&record, KAL_FALSE);
            }
        ...
        {       
            ...
            if(!g_mmi_java_is_background_display)                                     
            {
                ...
                {                         
                    ...
                    g_mmi_java_install_drm_path_aquire_right = get_ctrl_buffer((mmi_ucs2strlen((S8*)msg->drm_file_path)+1)<<1);       
                    memcpy(g_mmi_java_install_drm_path_aquire_right,msg->drm_file_path,((mmi_ucs2strlen((S8*)msg->drm_file_path)+1)<<1));                                             
                }
                #endif
...
{                                         
    ...
    {                                     
        ...
        mmi_ucs2cpy((S8*)jad_file, (S8*)file_path);                                       
        ...
        {                                 
            ...
            mmi_ucs2cpy((S8*)jar_file, (S8*)file_path);                                   
            if(jar_file[len - 2]=='a')
            {   
                jar_file[len - 1] = 'r';      
            }
        ...
        g_mmi_java_current_running_cmd = MMI_JAVA_CMD_INSTALL_BY_USER;                    
        mmi_java_mids_install(jad_file, jar_file, L"file://", MMI_FALSE);              
    }                                     
    else                                  
    {                                     
        jar_file = get_ctrl_buffer((len + 1) << 1);                                       
...
{                                         
    ...
    for(index = 0; index<data_size; index++)
    {
        ...
        mmi_ucs2cpy((S8*) menu_data[index].item_list[0], GetString(ptr->title_idx));
...
{                                         
    ...
    if(mmi_jad_file_name)                 
    {                                     
        content->jad_file_path = (U16 *)get_ctrl_buffer((mmi_ucs2strlen((S8*)mmi_jad_file_name)+1) * ENCODING_LENGTH);                    
        mmi_ucs2cpy((S8*)content->jad_file_path, (S8*)mmi_jad_file_name);                 
    }                                     
    else                                  
    {                                     
    ...
    if(mmi_jar_file_name)                 
    {                                     
        content->jar_file_path = (U16 *)get_ctrl_buffer((mmi_ucs2strlen((S8*)mmi_jar_file_name)+1) * ENCODING_LENGTH);                    
        mmi_ucs2cpy((S8*)content->jar_file_path, (S8*)mmi_jar_file_name);                 
    }                                     
    else                                  
    {                                     
        /* it means jad installation, but jar is downloaded as drm_file_path */           
        content->jar_file_path = (U16 *)get_ctrl_buffer((mmi_ucs2strlen((S8*)drm_file_path)+1)<<2);                                       
        mmi_ucs2cpy((S8*)content->jar_file_path, (S8*)drm_file_path);                     
    }                                     
    if(drm_file_path)                     
    {                                     
        content->drm_file_path = (U16 *)get_ctrl_buffer((mmi_ucs2strlen((S8*)drm_file_path)+1)<<2);                                       
        mmi_ucs2cpy((S8*)content->drm_file_path, (S8*)drm_file_path);                     
    }                                     
    else                                  
    {                                     
...
{                                         
    ...
    {                                     
        mmi_download_url = (U16 *)get_ctrl_buffer((mmi_ucs2strlen((S8*)content->download_url)+1) * ENCODING_LENGTH);                      
        mmi_ucs2cpy((S8*)mmi_download_url, (S8*)content->download_url);                   
    }                                     
                                          
    if(content->jad_file_path)            
    {                                     
        mmi_jad_file_name = (U16 *)get_ctrl_buffer((mmi_ucs2strlen((S8*)content->jad_file_path)+1) * ENCODING_LENGTH);                    
        mmi_ucs2cpy((S8*)mmi_jad_file_name, (S8*)content->jad_file_path);                 
    }                                     
    if(content->jar_file_path)            
    {                                     
        mmi_jar_file_name = (U16 *)get_ctrl_buffer((mmi_ucs2strlen((S8*)content->jar_file_path)+1) * ENCODING_LENGTH);                    
        mmi_ucs2cpy((S8*)mmi_jar_file_name, (S8*)content->jar_file_path);                 
    }                                     
...
{                                         
    ...
    {                                     
        if (mmi_ucs2cmp((S8*)current_node->content.drm_file_path, (S8*)drm_file_path) == 0)                                               
        {                                 
            found = MMI_TRUE;             
...
mmi_java_get_push_install_node(S8* drmfilename)                                           
{                                         
    /*----------------------------------------------------------------*/                  
    /* Local Variables*/                  
    /*----------------------------------------------------------------*/                  
    ...
    {                                     
        if ( current_node->content.drm_file_path && drmfilename && mmi_ucs2cmp((S8*)current_node->content.drm_file_path, (S8*)drmfilename) == 0)                                          
        {                                 
...
{                                         
    ...
    /* Code Body      */                  
    /*----------------------------------------------------------------*/                  
    current_node = mmi_java_get_push_install_node((S8*)g_mmi_java_install_drm_path_push_install);                                         
    if(current_node){                     
...
{                                         
    ...
    /*----------------------------------------------------------------*/                  
        ...
        {                                 
            mmi_ucs2ncpy((S8*)str2,(S8*)&g_mmi_java_install_drm_path_push_install[j+1],MMI_JAVA_MAX_DRM_FILE_NAME);                       
        }                                 
        mmi_ucs2cat((S8*)str1,(S8*)str2); 
        mmi_ucs2cat((S8*)str1,(S8*)&str[i+2]);                                            
    return str1;
...
{                                         
    ...
    if( current_scomo_cmd_info_ptr == NULL
        ...
        || mmi_ucs2strlen((const S8 *) current_scomo_cmd_info_ptr->pkg_install_path) <= 4 
        || current_scomo_cmd_info_ptr->pkg_network_url == NULL                            
        || mmi_ucs2strlen((const S8 *) current_scomo_cmd_info_ptr->pkg_network_url) == 0) 
    {                                     
    ...
    mmi_asc_to_ucs2((S8 *)wdownload_url,(S8 *)current_scomo_cmd_info_ptr->pkg_network_url);                                               
    /* check install path, whethe it is jad path,if yes then set jad path, otherwise set jar path*/                                       
    len = mmi_ucs2strlen((const S8 *) current_scomo_cmd_info_ptr->pkg_install_path);      
    /*find filename from install file path end*/                                          
    wfilename = (kal_wchar*)mmi_ucs2rchr((const S8 * )current_scomo_cmd_info_ptr->pkg_install_path,(U16)L'\\');                           
    if(wfilename == NULL)                 
    {                                     
    ...
    len = 3 + mmi_ucs2strlen((const S8*)FMGR_DEFAULT_FOLDER_RECEIVED);                    
    len += mmi_ucs2strlen((const S8*) wfilename)+1;                                       
    save_path = get_ctrl_buffer(len<<1);  
    drv  = SRV_FMGR_PUBLIC_DRV;                
    save_path[0] =  drv;save_path[1] =  0;
    mmi_ucs2cat((S8 *) save_path,(const S8 *) L":\\");                                    
    mmi_ucs2cat((S8 *) save_path,(const S8 *) FMGR_DEFAULT_FOLDER_RECEIVED);              
    ...
    mmi_ucs2cat((S8 *) save_path,(const S8 *) wfilename);                                 
    ...
    len = mmi_ucs2strlen((const S8 *)save_path);                                          
    if(0 == mmi_ucs2icmp((const S8 *)(save_path+len-4),(const S8 *)L".jad"))              
    {                                     
...
{                                         
    ...
    ShowCategory74Screen(                 
        ...
        mmi_ucs2strlen((S8*) get_string(confirm_str)),
        NULL);                            
...
{                                         
    ...
    if( current_scomo_cmd_info_ptr == NULL
        ...
        || mmi_ucs2strlen((const S8 *) current_scomo_cmd_info_ptr->app_software_id) == 0) 
    {                                     
        mmi_java_report_status(current_dm_cmd,J2ME_INVALID_REQUEST,NULL,NULL,NULL);       
        return;                           
    }                                     
    mmi_java_mids_delete(-1,(kal_char*)current_scomo_cmd_info_ptr->app_software_id);      
}                                         
...
{                                         
    ...
    if(mids_name!=NULL&&(len = mmi_ucs2strlen((const S8*)mids_name))>0){                  
        len = len < DM_MAX_ID_LEN-1? len+1 : DM_MAX_ID_LEN-1;                             
...
{                                         
    ...
    len = (3 + mmi_ucs2strlen((const S8*)FMGR_DEFAULT_FOLDER_RECEIVED)+mmi_ucs2strlen((const S8*)TEMP_PATH)+1)<<1;                        
    wpath =(kal_wchar*)get_ctrl_buffer(len);                                              
    wpath[0] =  SRV_FMGR_PUBLIC_DRV;wpath[1] =  0;                                             
    mmi_ucs2cat((S8 *) wpath,(const S8 *) L":\\");                                        
    mmi_ucs2cat((S8 *) wpath,(const S8 *) FMGR_DEFAULT_FOLDER_RECEIVED);                  
    mmi_ucs2cat((S8 *) wpath,(const S8 *) TEMP_PATH);                                     
...
void mmi_java_report_status(              
        ...
        S8* mids_storage_id,              
        U16* mids_name,                   
        S8* mids_version)/*parameter unused if no define macro : review 004*/             
{                                         
    /*----------------------------------------------------------------*/                  
    /* Local Variables*/                  
    /*----------------------------------------------------------------*/                  
 ...
 *  void
 *****************************************************************************/
void mmi_java_mids_delete(kal_uint32 mids_id, kal_char* mids_storage_id)
{
    /*----------------------------------------------------------------*/
    /* Local Variables*/
    /*----------------------------------------------------------------*/
...
void mmi_java_send_mids_delete_req(void)
{
   ...
   g_mmi_java_is_background_display = MMI_FALSE;
   g_mmi_java_current_running_cmd = MMI_JAVA_CMD_REMOVE_BY_USER;
   mmi_java_mids_delete(mids_id,NULL);
}   
...
void mmi_java_mids_check_reinstall(void)
{
...
mmi_ret mmi_java_mids_after_delete_proc(mmi_event_struct* evt)                           
{ 
    switch(evt->evt_id)                   
    {          
        case EVT_ID_POPUP_QUIT:   
...
void mmi_java_recv_mids_delete_cnf(void *MsgStruct)
{
    ...
    mmi_java_report_status(g_mmi_java_current_running_cmd, msg->error_code,(S8 *)msg->mids_storage_id, NULL,NULL);
    ...
    if (msg->error_code == J2ME_NO_ERROR)
    {
...
#ifdef __MMI_VUI_SHELL_SHORTCUTS__
        {
            ...
            mmi_shct_java_del_notify((S8*)mids_storage_id_w);
        }
#endif /* __MMI_VUI_SHELL_SHORTCUTS__ */
#endif
#endif
    }
    else if(msg->error_code == MIDLET_RUNNING)
    {
...
/*****************************************************************************
 * FUNCTION
 *  mmi_java_notify_delete_hdlr
 * DESCRIPTION
 *  deleteCB of notify dialog to prevent from deleted
 *  
 * PARAMETERS
 *  in_param      [void*]        
 * RETURNS
 *  U8
 *****************************************************************************/
U8 mmi_java_notify_delete_hdlr(void *in_param)
{
    /*----------------------------------------------------------------*/
    /* Local Variables*/
    /*----------------------------------------------------------------*/
