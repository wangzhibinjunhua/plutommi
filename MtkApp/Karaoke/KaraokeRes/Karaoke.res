...
>
  ...
  <CACHEDATA type="byte" id="NVRAM_KARAOKE_AUD_MUTE" restore_flag="TRUE">
        ...
        <DESCRIPTION>Karaoke aud mute</DESCRIPTION>
  </CACHEDATA>
  
  <CACHEDATA type="byte" id="NVRAM_KARAOKE_MIC_MUTE" restore_flag="TRUE">
        <DEFAULT_VALUE> [0X00] </DEFAULT_VALUE>
        <DESCRIPTION>Karaoke mic mute</DESCRIPTION>
  </CACHEDATA>
  
  <CACHEDATA type="byte" id="NVRAM_KARAOKE_REMIX_AUD_MUTE" restore_flag="TRUE">
        <DEFAULT_VALUE> [0X00] </DEFAULT_VALUE>
        <DESCRIPTION>Karaoke remix aud mute</DESCRIPTION>
  </CACHEDATA>
  
  <CACHEDATA type="byte" id="NVRAM_KARAOKE_REMIX_MIC_MUTE" restore_flag="TRUE">
        <DEFAULT_VALUE> [0X00] </DEFAULT_VALUE>
        <DESCRIPTION>Karaoke remix mic mute</DESCRIPTION>
  </CACHEDATA>
