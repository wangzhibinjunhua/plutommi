...
/* fix flickering of state icon with disable PQ */
...
kal_bool g_vdorec_is_need_to_resume_PQ = KAL_FALSE;
#endif
...
static MMI_BOOL mmi_vdorec_get_PQ_status(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
static void mmi_vdorec_set_PQ_status(MMI_BOOL is_enable)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
static void mmi_vdorec_entry_app_internal(void)
{
    ...
    /* fix flickering of state icon with disable PQ */
    #ifdef __FIX_BUG_ABOUT_PQ__
    if(mmi_vdorec_get_PQ_status())
    {
        gdi_color_engine_custom_off();
        mmi_vdorec_set_PQ_status(MMI_FALSE);	
        g_vdorec_is_need_to_resume_PQ = KAL_TRUE;
    }
    #endif
...
static void mmi_vdorec_exit_app(void)
{
	...
	/* fix flickering of state icon with disable PQ */
    #ifdef __FIX_BUG_ABOUT_PQ__
    if(g_vdorec_is_need_to_resume_PQ == KAL_TRUE)
    {
        gdi_color_engine_custom_on();
        mmi_vdorec_set_PQ_status(MMI_TRUE);
        g_vdorec_is_need_to_resume_PQ = KAL_FALSE;
    }				
    #endif    
