...
//#define MMI_EM_PROF_CLIP_SCREEN_BOLDER      (18)
#define MMI_EM_PROF_TEXT_MAX_CHAR           (15)
#define MMI_EM_PROF_HORIZONTAL_VIEW         (1)

#define MMI_EM_IMGDEC_FOLDER_INPUT_SCREEN_INFO      1
#define MMI_EM_IMGDEC_FOLDER_FILELIST_MEM_SIZE      2048
...
/* under construction !*/
/* under construction !*/
#endif /* defined(__MMI_EM_PROFILING_IMG_DEC__) */
