...
{
    srv_callset_answer_mode_switch_mode(SRV_CALLSET_ANSWER_MODE_AUTO_EM, MENU_ID_EM_MISC_ON == menu_id);
...
#ifdef __MMI_EM_MISC_AUTO_ANSWER__
    case MENU_ID_EM_MISC_AUTO_ANSWER:
        mmi_em_misc_set_item_on_off((MMI_BOOL)(srv_callset_answer_mode_get_mode() & SRV_CALLSET_ANSWER_MODE_AUTO_EM), event);
        break;
#endif /*__MMI_EM_MISC_AUTO_ANSWER__*/
