...
const U8 em_hid_control_data_desktop[EM_BT_HID_NUM_OF_CTRL_DATA][EM_BT_HID_MAX_CTRL_DATA_LENGTH] =
{
...
static void mmi_em_bt_hid_trans_data()
{
    mmi_em_bt_hid_interrupt_data_req(
        ...
        (U8*)em_hid_control_data_desktop[g_mmi_em_bt_hid_cntx.trans_data_flag]);
}
