...
#ifndef MMI_EM_DEBUG_INFO_H
#define MMI_EM_DEBUG_INFO_H
...
extern void mmi_em_debug_info_menu_event_hdlr(cui_menu_event_struct *event);
#endif



#endif /* MMI_EM_DEBUG_INFO_H */ 
