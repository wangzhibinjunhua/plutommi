...
#define MMI_AVATAR_M3D_HAIR_START_ID    101
#define MMI_AVATAR_M3D_HEAD_START_ID    201
#define MMI_AVATAR_M3D_BODY_START_ID    301
#define MMI_AVATAR_M3D_DRESS_START_ID   401

#define MMI_AVATAR_M3D_HAIR_PARENT_ID    1
#define MMI_AVATAR_M3D_HEAD_PARENT_ID    2
#define MMI_AVATAR_M3D_BODY_PARENT_ID    3
...
/* Array Index: touch_object */
typedef enum
{
    AVATAR_TOUCH_HEAD = 0,      /* 0 */
    AVATAR_TOUCH_HAIR,          /* 1 */
    AVATAR_TOUCH_EYE,           /* 2 */
    AVATAR_TOUCH_BROW,          /* 3 */
    AVATAR_TOUCH_LIP,           /* 4 */
    AVATAR_TOUCH_DECORATION,    /* 5 */
    AVATAR_TOUCH_BODY,          /* 6 */    
    AVATAR_TOUCH_TOP_ICON_NUM,  /* 7 */ 
    
    AVATAR_TOUCH_MAGNIFY = AVATAR_TOUCH_TOP_ICON_NUM,   /* 7 */   
    AVATAR_TOUCH_MINIFY,    /* 8 */    
    AVATAR_TOUCH_MOVEUP,    /* 9 */
    AVATAR_TOUCH_MOVEDOWN,  /* 10 */
    AVATAR_TOUCH_STRETCH,   /* 11 */
    AVATAR_TOUCH_SHRINK,    /* 12 */
    AVATAR_TOUCH_COLOR,     /* 13 */

    AVATAR_TOUCH_LARROW,    /* 14 */
    AVATAR_TOUCH_RARROW,    /* 15 */

    AVATAR_TOUCH_TOP_LARROW,/* 16 */
    AVATAR_TOUCH_TOP_RARROW,/* 17 */

    AVATAR_TOUCH_LSK,       /* 18 */
    AVATAR_TOUCH_RSK,       /* 19 */
    AVATAR_TOUCH_NUM,       /* 20 */
    AVATAR_TOUCH_NONE = AVATAR_TOUCH_NUM
...
typedef struct
{
    ...
    S16 selected_face;
    S16 selected_dress;
    S16 selected_item[AVATAR_TOUCH_TOP_ICON_NUM];
