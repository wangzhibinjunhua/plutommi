...
#define MMI_AVATAR_APP_MEMORY_SIZE (MMI_AVATAR_DISPLAY_WINDOW_WIDTH*MMI_AVATAR_DISPLAY_WINDOW_HEIGHT*2)// (240*320*2)
...
typedef enum
{
    AVATAR_ICON_STATUS_DISABLE,
    AVATAR_ICON_STATUS_ENABLE,    
    AVATAR_ICON_STATUS_CLICKED
...
typedef struct 
{
    ...
    /* top section */
    avatar_osd_icon_struct touch_object[AVATAR_TOUCH_NUM];
 ...
 *******************************************************************************/
    ...
    S16 item_page[AVATAR_TOUCH_TOP_ICON_NUM];  
    S16                         selected_item_idx;
    S16                         selected_item_page;
...
****************************************************************/
extern void mmi_avatar_highlight_app(void);
extern void mmi_avatar_list_highlight_hdlr(S32 idx);
extern void mmi_avatar_highlight_new(void);
extern void mmi_avatar_highlight_edit(void);
extern void mmi_avatar_highlight_play(void);
extern void mmi_avatar_highlight_delete(void);
extern void mmi_avatar_highlight_rename(void);
extern void mmi_avatar_highlight_delete_all(void);
extern void mmi_avatar_highlight_save(void);
extern void mmi_avatar_highlight_exit(void);
extern void mmi_avatar_hilight_text_sel_inp_method(void);
extern void mmi_avatar_hilight_text_edit_done(void);
