...
extern void mmi_bgsnd_cs_playback_highlight_hdlr(S32 index);
extern void mmi_bgsnd_cs_playback_save_confirm(void);
extern void mmi_bgsnd_cs_playback_save(void);
extern void mmi_bgsnd_cs_playback_setup_done(void);
extern void mmi_bgsnd_cs_playback_abort(void);
extern void mmi_bgsnd_entry_cs_effect_list_group_enter(mmi_event_struct *event);


extern void mmi_bgsnd_cs_effect_highlight_callback(void);
extern void mmi_bgsnd_cs_effect_highlight_hdlr(S32 index);
extern void mmi_bgsnd_entry_cs_effect_list(cui_menu_event_struct *menu_evt);
...
extern void mmi_bgsnd_cs_ext_pre_entry_option(mmi_event_struct *menu_evt);
extern void mmi_bgsnd_entry_cs_ext_effect_option(void);
extern void mmi_bgsnd_cs_ext_effect_select_item(void);
extern void mmi_bgsnd_cs_ext_effect_select_from_fmgr(mmi_id grp_id);
extern void mmi_bgsnd_cs_ext_effect_select_file_done(mmi_id bgsnd_fmgr_gid);
...
extern void mmi_bgsnd_entry_cm_effect_list(cui_menu_event_struct *menu_evt);
extern void mmi_bgsnd_exit_cm_effect_list(void);
extern void mmi_bgsnd_cm_effect_apply_change(void);
extern void mmi_bgsnd_cm_setting_done(void);
extern void mmi_bgsnd_entry_cm_effect_list_group_enter(mmi_event_struct *event);
...
extern MMI_BOOL mmi_bgsnd_hfp_volume_sync_callback(U8 volume, MMI_BOOL is_mute);
#endif
