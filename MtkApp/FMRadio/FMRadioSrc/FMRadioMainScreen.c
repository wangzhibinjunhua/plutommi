...
MMI_BOOL is_fmrdo_lsk = MMI_FALSE;
MMI_BOOL is_fmrdo_rsk = MMI_FALSE;
...
void mmi_fmrdo_redraw_main_all(void)
{
    ...
    mmi_fmrdo_redraw_main_push_button(
        ...
        (BOOL) (g_fmrdo.is_button_down && (g_fmrdo.selected_button == FMRDO_BUTTON_SEARCH_DOWN)));
    mmi_fmrdo_redraw_main_push_button(
        FMRDO_BUTTON_SEARCH_UP,
        (BOOL) (g_fmrdo.is_button_down && (g_fmrdo.selected_button == FMRDO_BUTTON_SEARCH_UP)));
#else /* __MMI_SLIM_IMG_RES__ */
...
/*****************************************************************************
* FUNCTION
*  mmi_fmrdo_softkey_touch_pen_down_hdlr
* DESCRIPTION
...
*  Boolean
*****************************************************************************/
static MMI_BOOL mmi_fmrdo_softkey_touch_pen_down_hdlr(mmi_pen_point_struct pos)
{
/*----------------------------------------------------------------*/
/* Local Variables                                                                                     */
/*----------------------------------------------------------------*/
...
void mmi_fmrdo_pen_down_hdlr(mmi_pen_point_struct pos)
{
	...
	if(mmi_fmrdo_softkey_touch_pen_down_hdlr(pos) == MMI_TRUE)
	 return;	
    ...
    switch (fmrdo_draw_cntx_p->pen_event)
    {
        ...
        case FMRDO_PEN_MAIN_SETTING:
            ...
            {
                mmi_fmrdo_redraw_main_push_down_button((U8)2, TRUE);
            }
            break;
        case FMRDO_PEN_MAIN_VOLUME_INC:
            if (!mmi_fmrdo_need_disable_push_button((fmrdo_main_button_enum)1))
            {
                mmi_fmrdo_redraw_main_push_down_button((U8)1, TRUE);
        ...
        case FMRDO_PEN_MAIN_VOLUME_DEC:
            ...
            {
                mmi_fmrdo_redraw_main_push_down_button((U8)0, TRUE);
...
/*****************************************************************************
* FUNCTION
*  mmi_fmrdo_softkey_touch_pen_up_hdlr
* DESCRIPTION
...
*  Boolean
*****************************************************************************/
static MMI_BOOL mmi_fmrdo_softkey_touch_pen_up_hdlr(mmi_pen_point_struct pos)
{
/*----------------------------------------------------------------*/
/* Local Variables                                                                                     */
/*----------------------------------------------------------------*/
    ...
    if(is_fmrdo_lsk == MMI_TRUE)
    	{    	    
            ...
            if(GUI_BUTTON_PEN_UP_INSIDE == button_event)
            {
                ...
                is_fmrdo_lsk = MMI_FALSE;
                return MMI_TRUE;
            }
    	}
    if(is_fmrdo_rsk == MMI_TRUE)
    	{
...
void mmi_fmrdo_pen_up_hdlr(mmi_pen_point_struct pos)
{
	...
	if(mmi_fmrdo_softkey_touch_pen_up_hdlr(pos) == MMI_TRUE)
	 return;
    ...
    switch (fmrdo_draw_cntx_p->pen_event)
    {
        ...
        case FMRDO_PEN_MAIN_SETTING:
            if (!mmi_fmrdo_need_disable_push_button((fmrdo_main_button_enum)2))
            {
                ...
                point.x = pos.x - skin_p->setting_x;
                point.y = pos.y - skin_p->setting_y;
                mmi_fmrdo_redraw_main_push_down_button((U8)2, FALSE);
                if (mmi_pen_check_inside_polygon(area, point))
                {
        ...
        case FMRDO_PEN_MAIN_VOLUME_DEC:
            if (!mmi_fmrdo_need_disable_push_button((fmrdo_main_button_enum)0))
            {
                mmi_fmrdo_redraw_main_push_down_button((U8)0, FALSE);
            }
            else
            {
                g_fmrdo.is_button_down = FALSE;
...
void mmi_fmrdo_pen_move_hdlr(mmi_pen_point_struct pos)
{
    ...
    switch (fmrdo_draw_cntx_p->pen_event)
    {
        ...
        case FMRDO_PEN_MAIN_VOLUME_INC:
            if (!mmi_fmrdo_need_disable_push_button((fmrdo_main_button_enum)1))
            {
                ...
                {
                    mmi_fmrdo_redraw_main_push_down_button((U8)1, FALSE);
                }
            }
            break;
        case FMRDO_PEN_MAIN_VOLUME_DEC:
    ...
    #endif /* (!defined(__MMI_SLIM_IMG_RES__) */
        case FMRDO_PEN_LSK:
            ret = translate_softkey_pen_event(MMI_LEFT_SOFTKEY, MMI_PEN_EVENT_MOVE, t_pos.x, t_pos.y, &button_event);
			if(ret == MMI_TRUE)
			 {
              if (button_event == GUI_BUTTON_PEN_MOVE_INSIDE)
            {
                mmi_fmrdo_redraw_main_LSK_down();
            }
              if(button_event == GUI_BUTTON_PEN_MOVE_OUTSIDE)
            {
                mmi_fmrdo_redraw_main_LSK_up();
                g_fmrdo.is_button_down = FALSE;
            }
            ...
            break;
        case FMRDO_PEN_RSK:
            ret = translate_softkey_pen_event(MMI_RIGHT_SOFTKEY, MMI_PEN_EVENT_MOVE, t_pos.x, t_pos.y, &button_event);
			if(ret == MMI_TRUE)
			 {			 
              if (button_event == GUI_BUTTON_PEN_MOVE_INSIDE)
            {
