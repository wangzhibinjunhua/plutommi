...
void mmi_fmrdo_scheduler_init_settings(void)
{
    ...
    g_prev_channel = 0;
    g_fmrdo.scheduler_running = FALSE;
    g_fmrdo.schedule_restorable = FALSE;
    g_delete_fm_screen = TRUE;
}
...
void mmi_fmrdo_scheduler_finish_restore(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_fmrdo_scheduler_restore(FALSE);
}
...
void mmi_fmrdo_scheduler_restore(pBOOL timer_expired)
{
    ...
    {
        g_fmrdo.schedule_restorable = FALSE;
        g_fmrdo.scheduler_running = TRUE;
    }
 ...
 *  void
 *****************************************************************************/
U8 mmi_fmrdo_scheduler_alarm_expiry_handler(U8 index, U16 *period, BOOL power_on_state)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    g_fmrdo.bootup_state = (BOOL) power_on_state;
 ...
 *  scheduler state
 *****************************************************************************/
BOOL mmi_fmrdo_scheduler_running(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
