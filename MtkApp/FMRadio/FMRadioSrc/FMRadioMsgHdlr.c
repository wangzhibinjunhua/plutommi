 ...
 *  
 *****************************************************************************/
BOOL mmi_fmrdo_continued(S32 result, void *user_data)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
void mmi_fmrdo_preempted(S32 result, void *user_data)
{
    ...
    g_fmrdo.is_power_on = FALSE; /* change state, in order to avoid power off noise */ 
 ...
 *  void
 *****************************************************************************/
void mmi_fmrdo_power_on_check(BOOL turn_on)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
 ...
 *  void
 *****************************************************************************/
void mmi_fmrdo_hw_search_frequency_start(U16 start_freq, BOOL is_step_up)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
/* under construction !*/
    ...
    if (g_fmrdo.in_main_screen && g_fmrdo.is_power_on)
    {
        ...
        mmi_fmrdo_redraw_main_push_button(
            FMRDO_BUTTON_STEP_DOWN,FALSE);
        mmi_fmrdo_redraw_main_push_button(
            FMRDO_BUTTON_STEP_UP,FALSE);
#endif
#endif
...
void mmi_fmrdo_search_frequency(BOOL is_valid)
{
    ...
    if (!is_valid && fmrdo_search_one.freq != fmrdo_search_one.stop_freq)
    {
        ...
        if (g_fmrdo.in_main_screen)
        {
            mmi_fmrdo_redraw_main_frequency(fmrdo_search_one.stop_freq, TRUE);
 ...
 *  void
 *****************************************************************************/
void mmi_fmrdo_bt_open_callback(S32 result)
{
