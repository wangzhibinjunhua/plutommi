 ...
 * BOOL
 *****************************************************************************/
BOOL mmi_fmgr_util_file_limit_check(S32 type, PS8 filename, PS8 *error_str_pp)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
    ...
    /* assign buffer */
    *error_str_pp = (S8*)g_fmgr_file_limit_error_str;
    memset((S8*)g_fmgr_file_limit_error_str, 0, FILE_LIMIT_ERROR_BUF_SIZE);

    if(string_id)
    {
        mmi_ucs2ncpy((S8*)g_fmgr_file_limit_error_str,
                     (PS8)(GetString(string_id)),
