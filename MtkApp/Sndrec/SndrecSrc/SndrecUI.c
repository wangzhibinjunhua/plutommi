 ...
 * $Log$
 *
 * 10 30 2014 ankur.saxena
 * removed!
 * Included scr locker header file.
 *
 * 04 22 2014 deepak.singhrawat
 * removed!
 * .
 *
 * 04 17 2014 deepak.singhrawat
 * removed!
 * .
 *
...
void mmi_sndrec_mainscr_lsk_up_hdlr(void)
{
    ...
    MMI_BOOL is_draw_npr = MMI_TRUE;    /* Flag to draw next, prev and record button, for  performance */
#endif 
