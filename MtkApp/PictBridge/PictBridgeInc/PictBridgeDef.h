...
#define PICT_XML_DIR  L"Z:\\@pictbridge\\"
#define PICT_XML_PATH L"Z:\\@pictbridge\\pict.xml"
...
{
    PICT_PAPER_DEFAULT = 0x01,  /* 1 */
    PICT_PAPER_POSTCARD = 0x02, /* 2 */
    PICT_PAPER_4x6 = 0x04,      /* 3 */
    PICT_PAPER_LETTER = 0x08,   /* 4 */
    PICT_PAPER_A4 = 0x10,       /* 5 */
    PICT_PAPER_L = 0x20,        /* 6 */
    PICT_PAPER_2L = 0x40,       /* 7 */
    PICT_PAPER_MAX = 8          /* 7 + 1 to save other paper size realted capability */
};
