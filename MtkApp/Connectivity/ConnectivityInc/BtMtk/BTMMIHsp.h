...
{                                                                                             \
    MMI_TRACE(MMI_CONN_TRC_G7_BT, MMI_BT_G7_BT_HSG_STATE_TRANS, g_mmi_bth_hsg_cntx.state, x);\
}
...
#define MMI_BTH_HSG_MAX_DEV_NAME_LEN      80
...
typedef struct
{
    ...
    U8 incoming_dev_name[MMI_BTH_HSG_MAX_DEV_NAME_LEN];
	
     MMI_BOOL  cancel_connect; 
...
extern void mmi_bth_hsg_connection_authorize_ind_hdler(void *msg);
