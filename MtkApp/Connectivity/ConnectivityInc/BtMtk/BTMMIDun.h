...
#define MMI_BTH_DUN_MAX_DEV_NAME_LEN 80
...
typedef enum
{
    ...
    MMI_BTH_DUN_STAT_AUTHORIZING,
    MMI_BTH_DUN_STAT_AUTHORIZED,
...
void mmi_bth_dun_disconnect_req_hdler(srv_bt_cm_bt_addr device_addr, U32 connect_id);
