...
extern void mmi_bth_hsg_connect_req_hdler(srv_bt_cm_bt_addr device_addr);
extern void mmi_bth_hsg_disconnect_req_hdler(srv_bt_cm_bt_addr device_addr, U32 connect_id);
...
extern void mmi_bth_hsg_connection_authorize_rsp_hdler(srv_bt_cm_bt_addr bt_addr, U32 result);

extern MMI_BOOL mmi_bth_hsg_cancel_connect(void);
