...
#if defined(__MMI_WEBCAM__) && !defined(__COSMOS_MMI__)
...
enum STR_LIST_EXTDEV_CONNECT
{
    STR_EXTDEV_CONNECT_BEGIN = STR_EXTDEV_IRDA_LAST,
    STR_EXTDEV_CONNECT_LAST
};
/***************************************************************************** 
* Image Define
*****************************************************************************/
...
enum IMG_LIST_EXTDEV_BT
{
    ...
    IMG_BT_SET_PERMISSION,
    IMG_BT_SET_VIS,
    IMG_BT_SET_VIS_PERMANENT_ON,
    IMG_BT_SET_VIS_TEMPORARY_ON,
    IMG_BT_SET_VIS_OFF,
    IMG_BT_SET,
    IMG_EXTDEV_BT_LAST
...
enum IMG_LIST_EXTDEV_CONNECT
{
    IMG_EXTDEV_CONNECT_BEGIN = IMG_EXTDEV_BT_LAST,
    IMG_EXTDEV_CONNECT_LAST
};
/***************************************************************************** 
* Screen Define
****************************************************************************/
...
enum SCR_EXTDEV_CONNECT
{
    SCR_EXTDEV_CONNECT_BEGIN = SCR_EXTDEV_IRDA_LAST,
    SCR_EXTDEV_CONNECTIVITY,
    SCR_EXTDEV_CONNECT_LAST
};
