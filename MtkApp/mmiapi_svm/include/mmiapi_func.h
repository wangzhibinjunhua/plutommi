...
extern void mmiapi_close_phb_cui(void);
...
extern void mmiapi_sms_get_smsc_addr_req(mmiapi_sms_get_smsc_addr_req_struct *msg, module_type mod_src);
extern void mmiapi_sms_get_smsc_addr_rsp(void *data, module_type mod_src, U16 result);
...
extern void mmiapi_ui_show_mmi_textbox_editor_req(mmiapi_ui_show_mmi_textbox_req_struct *msg, module_type mod_src);

extern void mmiapi_ui_exit_mmi_textbox_editor_req(mmiapi_ui_show_mmi_textbox_req_struct *msg, module_type mod_src);

extern void mmiapi_ui_update_title_mmi_textbox_editor_req(
                mmiapi_ui_show_mmi_textbox_req_struct *msg,
                module_type mod_src);
extern void mmiapi_ui_update_ticker_mmi_textbox_editor_req(
                mmiapi_ui_show_mmi_textbox_req_struct *msg,
                module_type mod_src);
extern void mmiapi_ui_update_text_mmi_textbox_editor_req(
                mmiapi_ui_show_mmi_textbox_req_struct *msg,
                module_type mod_src);
extern void mmiapi_ui_update_commands_mmi_textbox_editor_req(
                mmiapi_ui_show_mmi_textbox_req_struct *msg,
                module_type mod_src);

extern void mmiapi_ui_show_mmi_menu_req(mmiapi_ui_show_mmi_menu_req_struct * msg,module_type mod_src);

extern void mmiapi_ui_hide_mmi_menu_req(mmiapi_ui_show_mmi_menu_req_struct * msg,module_type mod_src);

#ifdef __J2ME__
extern void mmiapi_ui_show_mmi_datefield_date_req(
                mmiapi_ui_show_mmi_datefield_req_struct *msg,
                module_type mod_src);

extern void mmiapi_ui_hide_mmi_datafield_date_req(
                mmiapi_ui_show_mmi_datefield_req_struct *msg,
                module_type mod_src);
#endif

/* extern void mmiapi_ui_entry_menu_screen_req(void); */
