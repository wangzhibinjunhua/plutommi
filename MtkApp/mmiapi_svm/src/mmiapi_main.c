...
#define MMIAPI_MAX_CLIENTS    8
#else
//enlarge the clients to resolve MAUI_01796879
//#define MMIAPI_MAX_CLIENTS    4
#define MMIAPI_MAX_CLIENTS    5
#endif

mmi_ret mmiapi_enter_idle_screen_proc(mmi_event_struct *evt);

/* global data */
 kal_mutexid mmiapi_mutex_control = NULL;
...
void mmiapi_init_engine(void)
{
    ...
    SetProtocolEventHandler((PsFuncPtr) mmiapi_sms_get_smsc_addr_req, (U16) MSG_ID_MMIAPI_SMS_GET_SMSC_ADDR_REQ);
 ...
 //   SetProtocolEventHandler((PsFuncPtr) mmiapi_unread_push_icon_ind, MSG_ID_MMIAPI_UNREAD_PUSH_ICON_IND);
...
#ifdef __PLUTO_MMI_PACKAGE__
    mmi_frm_cb_reg_event(EVT_ID_IDLE_GROUP_ENTER, mmiapi_enter_idle_screen_proc, NULL);
#elif defined(__COSMOS_MMI_PACKAGE__)
    mmi_frm_cb_reg_event(EVT_ID_VAPP_LAUNCHER_ACTIVE, mmiapi_enter_idle_screen_proc, NULL);
#endif
#ifdef __J2ME__
    /* UI service */

    SetProtocolEventHandler(
        (PsFuncPtr) mmiapi_ui_update_ticker_mmi_textbox_editor_req,
        (U16) MSG_ID_MMIAPI_UI_UPDATE_TICKER_TEXTBOX_EDITOR_REQ);

    SetProtocolEventHandler(
        (PsFuncPtr) mmiapi_ui_update_text_mmi_textbox_editor_req,
        (U16) MSG_ID_MMIAPI_UI_UPDATE_TEXT_TEXTBOX_EDITOR_REQ);

    SetProtocolEventHandler(
        (PsFuncPtr) mmiapi_ui_update_commands_mmi_textbox_editor_req,
        (U16) MSG_ID_MMIAPI_UI_UPDATE_COMMANDS_TEXTBOX_EDITOR_REQ);

    SetProtocolEventHandler(
        (PsFuncPtr) mmiapi_ui_show_mmi_textbox_editor_req,
        (U16) MSG_ID_MMIAPI_UI_ENTRY_TEXTBOX_EDITOR_REQ);

    SetProtocolEventHandler(
        (PsFuncPtr) mmiapi_ui_exit_mmi_textbox_editor_req,
        (U16) MSG_ID_MMIAPI_UI_EXIT_TEXTBOX_EDITOR_REQ);

    SetProtocolEventHandler(
        (PsFuncPtr) mmiapi_ui_update_title_mmi_textbox_editor_req,
        (U16) MSG_ID_MMIAPI_UI_UPDATE_TITLE_TEXTBOX_EDITOR_REQ);
	...
	SetProtocolEventHandler(
        (PsFuncPtr) mmiapi_ui_show_mmi_menu_req,
        (U16) MSG_ID_MMIAPI_UI_ENTRY_MENU_REQ);

	SetProtocolEventHandler(
        (PsFuncPtr) mmiapi_ui_hide_mmi_menu_req,
        (U16) MSG_ID_MMIAPI_UI_EXIT_MENU_REQ);

    SetProtocolEventHandler(
        (PsFuncPtr) mmiapi_ui_show_mmi_datefield_date_req,
        (U16) MSG_ID_MMIAPI_UI_SHOW_DATEFIELD_DATE_REQ);

  SetProtocolEventHandler(
        (PsFuncPtr) mmiapi_ui_hide_mmi_datafield_date_req,
        (U16) MSG_ID_MMIAPI_UI_EXIT_DATEFIELD_DATE_REQ);
