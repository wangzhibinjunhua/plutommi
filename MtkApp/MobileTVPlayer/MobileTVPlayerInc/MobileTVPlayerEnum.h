...
{
    MTV_KERNEL_CLOSED,      /* 0 */
    MTV_KERNEL_CLOSING,     /* 1 */
    MTV_KERNEL_SAVE_CONFIRM,/* 2 */
    MTV_KERNEL_SAVING,      /* 3 */
    MTV_KERNEL_DELETING,    /* 4 */
    MTV_KERNEL_SCANNING,    /* 5 */
    MTV_KERNEL_OPENED,      /* 6 */
    MTV_KERNEL_INIT,        /* 7 */
    MTV_KERNEL_READY,       /* 8 */
    MTV_KERNEL_NULL,        /* 9 */
...
typedef enum
{
    ...
    MTV_RECORDER_PAUSE,         /* 2 */
    MTV_RECORDER_SAVE_CONFIRM,  /* 3 */
    MTV_RECORDER_SAVING,        /* 4 */
    MTV_RECORDER_DELETING,      /* 5 */
    MTV_RECORDER_NULL,          /* 6 */
