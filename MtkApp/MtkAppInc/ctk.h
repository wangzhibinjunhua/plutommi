 ...
 * Miscellaneous
 *************************************************************************/
#define CTK_LOG_GROUP               (TRACE_GROUP_2)

#ifdef __MTK_TARGET__

  
    #define CTK_LOG                     kal_trace
...
typedef enum
{
    ...
    CTK_INPUT_TYPE_URL,             /* For Url [doesn't show newline & euro symbol] */
...
extern void ctk_pcategory_general_highlight_handler(S32 index);
