...
#if defined(_MACINTOSH_) && TARGET_API_MAC_CARBON
#if TARGET_RT_MAC_MACHO && TARGET_CPU_PPC
#include "platforms/mac/MachOGlue/MachOCFMGlue.h"
#define MAKE_NATIVE_FUNC(a) MachOFunctionPointerForCFMFunctionPointer((void*)a)
#define MAKE_EXPORT_FUNC(a) CFMFunctionPointerForMachOFunctionPointer((void*)a)
#else
#define MAKE_NATIVE_FUNC(a) (a)
#endif
#undef GENERATINGCFM
#define GENERATINGCFM 0
#endif

#ifndef MAKE_EXPORT_FUNC
#define MAKE_EXPORT_FUNC(a) (a)
#endif
...
#define NewNPN_GetValueProc(FUNC)       \
        ((NPN_GetValueUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_GetValueProc(FUNC, ARG1, ARG2, ARG3)        \
        (*(FUNC))((ARG1), (ARG2), (ARG3))
#endif
...
#define NewNPN_SetValueProc(FUNC)       \
        ((NPN_SetValueUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_SetValueProc(FUNC, ARG1, ARG2, ARG3)        \
        (*(FUNC))((ARG1), (ARG2), (ARG3))
#endif
...
#define NewNPN_GetURLNotifyProc(FUNC)       \
        ((NPN_GetURLNotifyUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_GetURLNotifyProc(FUNC, ARG1, ARG2, ARG3, ARG4)      \
        (*(FUNC))((ARG1), (ARG2), (ARG3), (ARG4))
#endif
...
#define NewNPN_PostURLNotifyProc(FUNC)      \
        ((NPN_PostURLNotifyUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_PostURLNotifyProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7) \
        (*(FUNC))((ARG1), (ARG2), (ARG3), (ARG4), (ARG5), (ARG6), (ARG7))
#endif
...
#define NewNPN_GetURLProc(FUNC)     \
        ((NPN_GetURLUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_GetURLProc(FUNC, ARG1, ARG2, ARG3)      \
        (*(FUNC))((ARG1), (ARG2), (ARG3))
#endif
...
#define NewNPN_PostURLProc(FUNC)        \
        ((NPN_PostURLUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_PostURLProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6) \
...
#define NewNPN_RequestReadProc(FUNC)        \
        ((NPN_RequestReadUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_RequestReadProc(FUNC, stream, range)        \
        (*(FUNC))((stream), (range))
...
#define NewNPN_NewStreamProc(FUNC)      \
        ((NPN_NewStreamUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_NewStreamProc(FUNC, npp, type, window, stream)      \
...
#define NewNPN_WriteProc(FUNC)      \
        ((NPN_WriteUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_WriteProc(FUNC, npp, stream, len, buffer)       \
...
#define NewNPN_DestroyStreamProc(FUNC)      \
        ((NPN_DestroyStreamUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_DestroyStreamProc(FUNC, npp, stream, reason)        \
...
#define NewNPN_StatusProc(FUNC)     \
        ((NPN_StatusUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_StatusProc(FUNC, npp, msg)      \
        (*(FUNC))((npp), (msg)) 
...
#define NewNPN_UserAgentProc(FUNC)              \
                ((NPN_UserAgentUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_UserAgentProc(FUNC, ARG1)               \
                (*(FUNC))((ARG1))
...
#define NewNPN_MemAllocProc(FUNC)       \
        ((NPN_MemAllocUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_MemAllocProc(FUNC, ARG1)        \
        (*(FUNC))((ARG1))   
...
#define NewNPN_MemFreeProc(FUNC)        \
        ((NPN_MemFreeUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_MemFreeProc(FUNC, ARG1)     \
        (*(FUNC))((ARG1))   
...
#define NewNPN_MemFlushProc(FUNC)       \
        ((NPN_MemFlushUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_MemFlushProc(FUNC, ARG1)        \
        (*(FUNC))((ARG1))   
...
#define NewNPN_ReloadPluginsProc(FUNC)      \
        ((NPN_ReloadPluginsUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_ReloadPluginsProc(FUNC, ARG1)       \
        (*(FUNC))((ARG1))   
...
#define NewNPN_GetJavaEnvProc(FUNC)     \
        ((NPN_GetJavaEnvUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_GetJavaEnvProc(FUNC)        \
        (*(FUNC))() 
...
#define NewNPN_GetJavaPeerProc(FUNC)        \
        ((NPN_GetJavaPeerUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_GetJavaPeerProc(FUNC, ARG1)     \
        (*(FUNC))((ARG1))   
...
#define NewNPN_InvalidateRectProc(FUNC)     \
        ((NPN_InvalidateRectUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_InvalidateRectProc(FUNC, ARG1, ARG2)        \
        (*(FUNC))((ARG1), (ARG2))   
...
#define NewNPN_InvalidateRegionProc(FUNC)       \
        ((NPN_InvalidateRegionUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_InvalidateRegionProc(FUNC, ARG1, ARG2)      \
        (*(FUNC))((ARG1), (ARG2))   
...
#define NewNPN_ForceRedrawProc(FUNC)        \
        ((NPN_ForceRedrawUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_ForceRedrawProc(FUNC, ARG1)     \
        (*(FUNC))((ARG1))   
...
#define NewNPN_GetStringIdentifierProc(FUNC)        \
        ((NPN_GetStringIdentifierUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_GetStringIdentifierProc(FUNC, ARG1)     \
        (*(FUNC))((ARG1))
...
#define NewNPN_GetStringIdentifiersProc(FUNC)       \
        ((NPN_GetStringIdentifiersUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_GetStringIdentifiersProc(FUNC, ARG1, ARG2, ARG3)        \
        (*(FUNC))((ARG1), (ARG2), (ARG3))
...
#define NewNPN_GetIntIdentifierProc(FUNC)       \
        ((NPN_GetIntIdentifierUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_GetIntIdentifierProc(FUNC, ARG1)        \
        (*(FUNC))((ARG1))
...
enum {
    uppNPN_IdentifierIsStringProcInfo = kThinkCStackBased
        ...
        | RESULT_SIZE(SIZE_CODE(sizeof(OPBool)))
};
...
typedef OPBool (* NP_LOADDS NPN_IdentifierIsStringUPP)(NPIdentifier identifier);
#define NewNPN_IdentifierIsStringProc(FUNC)     \
        ((NPN_IdentifierIsStringUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_IdentifierIsStringProc(FUNC, ARG1)      \
        (*(FUNC))((ARG1))
...
#define NewNPN_UTF8FromIdentifierProc(FUNC)     \
        ((NPN_UTF8FromIdentifierUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_UTF8FromIdentifierProc(FUNC, ARG1)      \
        (*(FUNC))((ARG1))
...
#define NewNPN_IntFromIdentifierProc(FUNC)      \
        ((NPN_IntFromIdentifierUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_IntFromIdentifierProc(FUNC, ARG1)       \
        (*(FUNC))((ARG1))
...
#define NewNPN_CreateObjectProc(FUNC)       \
        ((NPN_CreateObjectUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_CreateObjectProc(FUNC, ARG1, ARG2)      \
        (*(FUNC))((ARG1), (ARG2))
...
#define NewNPN_RetainObjectProc(FUNC)       \
        ((NPN_RetainObjectUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_RetainObjectProc(FUNC, ARG1)        \
        (*(FUNC))((ARG1))
...
#define NewNPN_ReleaseObjectProc(FUNC)      \
        ((NPN_ReleaseObjectUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_ReleaseObjectProc(FUNC, ARG1)       \
        (*(FUNC))((ARG1))
...
typedef OPBool (* NP_LOADDS NPN_InvokeUPP)(NPP npp, NPObject* obj, NPIdentifier methodName, const NPVariant *args, uint32_t argCount, NPVariant *result);
#define NewNPN_InvokeProc(FUNC)     \
        ((NPN_InvokeUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_InvokeProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6)        \
        (*(FUNC))((ARG1), (ARG2), (ARG3), (ARG4), (ARG5), (ARG6))
...
typedef OPBool (* NP_LOADDS NPN_InvokeDefaultUPP)(NPP npp, NPObject* obj, const NPVariant *args, uint32_t argCount, NPVariant *result);
#define NewNPN_InvokeDefaultProc(FUNC)      \
        ((NPN_InvokeDefaultUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_InvokeDefaultProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5)       \
        (*(FUNC))((ARG1), (ARG2), (ARG3), (ARG4), (ARG5))
...
typedef OPBool (* NP_LOADDS NPN_EvaluateUPP)(NPP npp, NPObject *obj, NPString *script, NPVariant *result);
#define NewNPN_EvaluateProc(FUNC)       \
        ((NPN_EvaluateUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_EvaluateProc(FUNC, ARG1, ARG2, ARG3, ARG4)      \
        (*(FUNC))((ARG1), (ARG2), (ARG3), (ARG4))
...
typedef OPBool (* NP_LOADDS NPN_GetPropertyUPP)(NPP npp, NPObject *obj, NPIdentifier propertyName, NPVariant *result);
#define NewNPN_GetPropertyProc(FUNC)        \
        ((NPN_GetPropertyUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_GetPropertyProc(FUNC, ARG1, ARG2, ARG3, ARG4)       \
        (*(FUNC))((ARG1), (ARG2), (ARG3), (ARG4))
...
typedef OPBool (* NP_LOADDS NPN_SetPropertyUPP)(NPP npp, NPObject *obj, NPIdentifier propertyName, const NPVariant *value);
#define NewNPN_SetPropertyProc(FUNC)        \
        ((NPN_SetPropertyUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_SetPropertyProc(FUNC, ARG1, ARG2, ARG3, ARG4)       \
        (*(FUNC))((ARG1), (ARG2), (ARG3), (ARG4))
...
typedef OPBool (* NP_LOADDS NPN_RemovePropertyUPP)(NPP npp, NPObject *obj, NPIdentifier propertyName);
#define NewNPN_RemovePropertyProc(FUNC)     \
        ((NPN_RemovePropertyUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_RemovePropertyProc(FUNC, ARG1, ARG2, ARG3)      \
        (*(FUNC))((ARG1), (ARG2), (ARG3))
...
typedef OPBool (* NP_LOADDS NPN_HasPropertyUPP)(NPP npp, NPObject *obj, NPIdentifier propertyName);
#define NewNPN_HasPropertyProc(FUNC)        \
        ((NPN_HasPropertyUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_HasPropertyProc(FUNC, ARG1, ARG2, ARG3)     \
        (*(FUNC))((ARG1), (ARG2), (ARG3))
...
typedef OPBool (* NP_LOADDS NPN_HasMethodUPP)(NPP npp, NPObject *obj, NPIdentifier propertyName);
#define NewNPN_HasMethodProc(FUNC)      \
        ((NPN_HasMethodUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_HasMethodProc(FUNC, ARG1, ARG2, ARG3)       \
        (*(FUNC))((ARG1), (ARG2), (ARG3))
...
#define NewNPN_ReleaseVariantValueProc(FUNC)        \
        ((NPN_ReleaseVariantValueUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_ReleaseVariantValueProc(FUNC, ARG1)     \
        (*(FUNC))((ARG1))
...
#define NewNPN_SetExceptionProc(FUNC)       \
        ((NPN_SetExceptionUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_SetExceptionProc(FUNC, ARG1, ARG2)      \
        (*(FUNC))((ARG1), (ARG2))   
...
typedef OPBool (* NP_LOADDS NPN_PushPopupsEnabledStateUPP)(NPP npp, NPBool enabled);
#define NewNPN_PushPopupsEnabledStateProc(FUNC)     \
        ((NPN_PushPopupsEnabledStateUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_PushPopupsEnabledStateProc(FUNC, ARG1, ARG2)        \
        (*(FUNC))((ARG1), (ARG2))
...
typedef OPBool (* NP_LOADDS NPN_PopPopupsEnabledStateUPP)(NPP npp);
#define NewNPN_PopPopupsEnabledStateProc(FUNC)      \
        ((NPN_PopPopupsEnabledStateUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_PopPopupsEnabledStateProc(FUNC, ARG1)       \
        (*(FUNC))((ARG1))
...
typedef OPBool (* NP_LOADDS NPN_EnumerateUPP)(NPP npp, NPObject *obj, NPIdentifier **identifier, uint32_t *count);
#define NewNPN_EnumerateProc(FUNC)      \
        ((NPN_EnumerateUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_EnumerateProc(FUNC, ARG1, ARG2, ARG3, ARG4)       \
        (*(FUNC))((ARG1), (ARG2), (ARG3), (ARG4))
...
typedef UniversalProcPtr NPN_PluginThreadAsyncCallUPP;
enum {
    uppNPN_PluginThreadAsyncCallProcInfo = kThinkCStackBased
        | STACK_ROUTINE_PARAMETER(1, SIZE_CODE(sizeof(NPP)))
        | STACK_ROUTINE_PARAMETER(2, SIZE_CODE(sizeof(void (*func)(void *))))
        | STACK_ROUTINE_PARAMETER(3, SIZE_CODE(sizeof(void *)))
        | RESULT_SIZE(SIZE_CODE(0))
};

#define NewNPN_PluginThreadAsyncCallProc(FUNC)      \
        (NPN_PluginThreadAsyncCallUPP) NewRoutineDescriptor((ProcPtr)(FUNC), uppNPN_PluginThreadAsyncCallProcInfo, GetCurrentArchitecture())
#define CallNPN_PluginThreadAsyncCallProc(FUNC, ARG1, ARG2, ARG3)       \
        (jref)CallUniversalProc((UniversalProcPtr)(FUNC), uppNPN_PluginThreadAsyncCallProcInfo, (ARG1), (ARG2), (ARG3))

#else

typedef void (* NP_LOADDS NPN_PluginThreadAsyncCallUPP)(NPP instance, void (*func)(void *), void *userData);
#define NewNPN_PluginThreadAsyncCallProc(FUNC) \
		((NPN_PluginThreadAsyncCallUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_PluginThreadAsyncCallProc(FUNC, ARG1, ARG2, ARG3) \
		(*(FUNC))((ARG1), (ARG2), (ARG3))
...
typedef UniversalProcPtr NPN_ConstructUPP;
enum {
    uppNPN_ConstructProcInfo = kThinkCStackBased
        | STACK_ROUTINE_PARAMETER(1, SIZE_CODE(sizeof(NPP)))
        | STACK_ROUTINE_PARAMETER(2, SIZE_CODE(sizeof(NPObject*)))
...
#define NewNPN_ConstructProc(FUNC)      \
        (NPN_ConstructUPP) NewRoutineDescriptor((ProcPtr)(FUNC), uppNPN_ConstructProcInfo, GetCurrentArchitecture())
#define CallNPN_ConstructProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5)       \
        (jref)CallUniversalProc((UniversalProcPtr)(FUNC), uppNPN_ConstructProcInfo, (ARG1), (ARG2), (ARG3), (ARG4), (ARG5))

#else

typedef OPBool (* NP_LOADDS NPN_ConstructUPP)(NPP npp, NPObject *obj, const NPVariant* args, uint32_t argCount, NPVariant *result);
#define NewNPN_ConstructProc(FUNC)      \
        ((NPN_ConstructUPP) MAKE_EXPORT_FUNC(FUNC))
#define CallNPN_ConstructProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5)       \
        (*(FUNC))((ARG1), (ARG2), (ARG3), (ARG4), (ARG5))
...
#if _NPUPP_USE_UPP_
typedef UniversalProcPtr NPN_GetValueForURLUPP;

enum {
    uppNPN_GetValueForURLProcInfo = kThinkCStackBased
        | STACK_ROUTINE_PARAMETER(1, SIZE_CODE(sizeof(NPP)))
        | STACK_ROUTINE_PARAMETER(2, SIZE_CODE(sizeof(NPNURLVariable)))
        | STACK_ROUTINE_PARAMETER(3, SIZE_CODE(sizeof(const char *)))
...
#define NewNPN_GetValueForURLProc(FUNC)        \
        (NPN_GetValueForURLUPP) NewRoutineDescriptor((ProcPtr)(FUNC), uppNPN_GetValueForURLProcInfo, GetCurrentArchitecture())
#define CallNPN_GetValueForURLProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5) \
        (NPError)CallUniversalProc((UniversalProcPtr)(FUNC), uppNPN_GetValueForURLProcInfo, \
                                   (ARG1), (ARG2), (ARG3), (ARG4), (ARG5))
#else

typedef NPError (* NP_LOADDS NPN_GetValueForURLUPP)(NPP instance, NPNURLVariable variable, const char *url, char **value, uint32_t *len);
#define NewNPN_GetValueForURLProc(FUNC)        \
        ((NPN_GetValueForURLUPP) (FUNC))
#define CallNPN_GetValueForURLProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5)     \
        (*(FUNC))((ARG1), (ARG2), (ARG3), (ARG4), (ARG5))
...
#if _NPUPP_USE_UPP_
typedef UniversalProcPtr NPN_SetValueForURLUPP;

enum {
    uppNPN_SetValueForURLProcInfo = kThinkCStackBased
        | STACK_ROUTINE_PARAMETER(1, SIZE_CODE(sizeof(NPP)))
        | STACK_ROUTINE_PARAMETER(2, SIZE_CODE(sizeof(NPNURLVariable)))
        | STACK_ROUTINE_PARAMETER(3, SIZE_CODE(sizeof(const char *)))
        | STACK_ROUTINE_PARAMETER(4, SIZE_CODE(sizeof(char **)))
...
#define NewNPN_SetValueForURLProc(FUNC)        \
        (NPN_SetValueForURLUPP) NewRoutineDescriptor((ProcPtr)(FUNC), uppNPN_SetValueForURLProcInfo, GetCurrentArchitecture())
#define CallNPN_SetValueForURLProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5) \
        (NPError)CallUniversalProc((UniversalProcPtr)(FUNC), uppNPN_SetValueForURLProcInfo, \
                                   (ARG1), (ARG2), (ARG3), (ARG4), (ARG5))
#else

typedef NPError (* NP_LOADDS NPN_SetValueForURLUPP)(NPP instance, NPNURLVariable variable, const char *url, const char *value, uint32_t *len);
#define NewNPN_SetValueForURLProc(FUNC)        \
        ((NPN_SetValueForURLUPP) (FUNC))
#define CallNPN_SetValueForURLProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5)     \
        (*(FUNC))((ARG1), (ARG2), (ARG3), (ARG4), (ARG5))
...
#if _NPUPP_USE_UPP_
typedef UniversalProcPtr NPN_GetAuthenticationInfoUPP;

enum {
    uppNPN_GetAuthenticationInfoProcInfo = kThinkCStackBased
        | STACK_ROUTINE_PARAMETER(1, SIZE_CODE(sizeof(NPP)))
        | STACK_ROUTINE_PARAMETER(2, SIZE_CODE(sizeof(const char *)))
        | STACK_ROUTINE_PARAMETER(3, SIZE_CODE(sizeof(const char *)))
        | STACK_ROUTINE_PARAMETER(4, SIZE_CODE(sizeof(int32_t)))
        | STACK_ROUTINE_PARAMETER(5, SIZE_CODE(sizeof(const char *)))
        | STACK_ROUTINE_PARAMETER(6, SIZE_CODE(sizeof(const char *)))
        | STACK_ROUTINE_PARAMETER(7, SIZE_CODE(sizeof(char **)))
        | STACK_ROUTINE_PARAMETER(8, SIZE_CODE(sizeof(uint32_t *)))
        | STACK_ROUTINE_PARAMETER(9, SIZE_CODE(sizeof(char **)))
        | STACK_ROUTINE_PARAMETER(10, SIZE_CODE(sizeof(uint32_t)))
        | RESULT_SIZE(SIZE_CODE(sizeof(NPError)))
};

#define NewNPN_GetAuthenticationInfoProc(FUNC)        \
        (NPN_GetAuthenticationInfoUPP) NewRoutineDescriptor((ProcPtr)(FUNC), uppNPN_GetAuthenticationInfoProcInfo, GetCurrentArchitecture())
#define CallNPN_GetAuthenticationInfoProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, ARG9, ARG10) \
        (NPError)CallUniversalProc((UniversalProcPtr)(FUNC), uppNPN_GetAuthenticationInfoProcInfo, \
                                   (ARG1), (ARG2), (ARG3), (ARG4), (ARG5), (ARG6), (ARG7), (ARG8), (ARG9), (ARG10))
#else

typedef NPError (* NP_LOADDS NPN_GetAuthenticationInfoUPP)(NPP instance, const char *protocol, const char *host, int32_t port, const char *scheme, const char *realm, char **username, uint32_t *ulen, char **password, uint32_t *plen);
#define NewNPN_GetAuthenticationInfoProc(FUNC)        \
        ((NPN_GetAuthenticationInfoUPP) (FUNC))
#define CallNPN_GetAuthenticationInfoProc(FUNC, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, ARG9, ARG10)     \
...
typedef struct _NPNetscapeFuncs {
    ...
    NPN_GetValueForURLUPP getvalueforurl;
    NPN_SetValueForURLUPP setvalueforurl;
    NPN_GetAuthenticationInfoUPP getauthenticationinfo;
} NPNetscapeFuncs;
...
typedef NPError (*NP_ShutdownP)(void);
