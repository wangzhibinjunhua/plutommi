...
#if defined(__PSISOFT32__) || defined(__SYMBIAN32__) || defined(EPOC)
# ifdef WIN32
#  undef WIN32
# endif
# ifdef _WIN32
...
/* PC */
#if (defined(XP_PC) || defined(_WINDOWS) || defined(WIN32) || defined(_WIN32)) && !defined(BREW) && !defined (__MTK__)
...
#		if !defined(__POWERPC__) && !GENERATINGCFM
...
#if !(defined(_MACINTOSH_) && TARGET_RT_MAC_MACHO)
typedef char			jbyte;
#endif
