...
void mmi_aduply_get_image_for_time(U16* img_idx, U32 time,U32 hour_flag, U16 x, U16 y)
{
	...
	time_width += (num_w+1)*2;
    
	if(x == audply_main_time.x2)
	{
		x = audply_main_time.x2 - time_width;
	}
    x_temp = x;
    gdi_layer_push_and_set_clip(  x, 
        y, 
        x + time_width , 
        y + offset_y);
	#ifdef __GDI_MEMORY_PROFILE_2__
    gdi_draw_solid_rect(x, 
        y, 
        x + time_width , 
        y + offset_y, GDI_COLOR_TRANSPARENT);
...
void mmi_audply_redraw_main_time(void)
{
    ...
    mmi_aduply_get_image_for_time(&img_idx[0],time,h,audply_main_time.x1,audply_main_time.y1);
    #if 0 
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
    ...
    mmi_aduply_get_image_for_time(&img_idx[8],time,h,audply_main_time.x2,audply_main_time.y1);
#if 0
/* under construction !*/
/* under construction !*/
/* under construction !*/
