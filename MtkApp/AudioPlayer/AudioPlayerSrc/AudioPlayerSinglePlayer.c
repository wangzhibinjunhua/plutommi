...
#endif
static U16 file_name_single[(SRV_FMGR_PATH_MAX_LEN+1) + 1];
/*
...
void mmi_audply_single_play(UI_string_type filefullname, void (*exit_callback_func)(void), U16 title_icon)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	//mmi_wprintf(MOD_MMI_MEDIA_APP, MMI_MEDIA_TRC_G10_MMI_PRINT, filefullname);
	mmi_ucs2ncpy((CHAR*)file_name_single, (CHAR*)filefullname, (SRV_FMGR_PATH_MAX_LEN+1));
	//mmi_wprintf(MOD_MMI_MEDIA_APP, MMI_MEDIA_TRC_G10_MMI_PRINT, file_name_single);
	filefullname = (UI_string_type)file_name_single;
