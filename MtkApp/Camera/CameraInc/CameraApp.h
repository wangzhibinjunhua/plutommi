...
#define STR_ID_CAMERA_EFFECT_START              STR_ID_CAMERA_EFFECT_SETTING
#endif

#ifdef __CAMERA_FEATURE_WB__
#define STR_ID_CAMERA_WB_START                  STR_ID_CAMERA_WB
#endif

#ifdef __CAMERA_AUTOFOCUS_METERING__
#define STR_ID_CAMERA_AUTOFOCUS_START           STR_ID_CAMERA_AUTOFOCUS_METERING
#endif

#ifdef __CAMERA_AUTOFOCUS_MODE__
#define STR_ID_CAMERA_AUTOFOCUS_MODE_START      STR_ID_CAMERA_AUTOFOCUS_MODE
#endif

#ifdef __CAMERA_DSC_MODE__
#define STR_ID_CAMERA_DSC_MODE_START            STR_ID_CAMERA_DSC_MODE
#endif

#ifdef __CAMERA_FEATURE_ISO_SUPPORT__
#define STR_ID_CAMERA_ISO_START                 STR_ID_CAMERA_ISO
#endif

#ifdef __CAMERA_FEATURE_AE_METER__	
#define STR_ID_CAMERA_AE_METER_START            STR_ID_CAMERA_AE_METER
#endif

#ifdef __CAMERA_FEATURE_LED_HIGHLIGHT__
#define STR_ID_CAMERA_LED_HIGHLIGHT_START       STR_ID_CAMERA_LED_HIGHLIGHT
#endif

#ifdef __CAMERA_FEATURE_SHUTTER_SOUND__
#define STR_ID_CAMERA_SHUTTER_SOUND_START       STR_ID_CAMERA_SHUTTER_SOUND
#endif

#ifdef __CAMERA_FEATURE_EV__
#define STR_ID_CAMERA_EV_START                  STR_ID_CAMERA_EV
#endif

#define STR_ID_CAMERA_IMAGE_QTY_START           STR_ID_CAMERA_IMAGE_QTY

#if defined(__CAMERA_FEATURE_CONT_SHOT__)
#define STR_ID_CAMERA_CONT_SHOT_START           STR_ID_CAMERA_CONT_SHOT
#endif

#if defined(__CAMERA_FEATURE_DELAY_TIMER__)
#define STR_ID_CAMERA_DELAY_TIMER_START         STR_ID_CAMERA_DELAY_TIMER
#endif

#define STR_ID_CAMERA_FLASH_START               STR_ID_CAMERA_FLASH

#ifdef __CAMERA_FEATURE_CONTRAST__
#define STR_ID_CAMERA_CONTRAST_START            STR_ID_CAMERA_CONTRAST
#endif

#ifdef __CAMERA_FEATURE_NIGHT__
#define STR_ID_CAMERA_NIGHT_START               STR_ID_CAMERA_NIGHT
#endif

#ifdef __CAMERA_FEATURE_BANDING__
#define STR_ID_CAMERA_BANDING_START             STR_ID_CAMERA_BANDING
#endif

#define STR_ID_CAMERA_IMAGE_SIZE_START          STR_ID_CAMERA_IMAGE_SIZE
...
#define MMI_CAMERA_DELETE_CONFIRM_WATCHDOG_DURATION (5000*2)
...
typedef enum
{
    STR_ID_CAMERA_IMAGE_SIZE_START_TTT = STR_ID_CAMERA_IMAGE_SIZE_START,
#ifdef __CAMERA_FEATURE_IMAGE_SIZE_SS__
    STR_ID_CAMERA_IMAGE_SIZE_SS_TTT,
#endif 

#ifdef __CAMERA_FEATURE_IMAGE_SIZE_S__
    STR_ID_CAMERA_IMAGE_SIZE_S_TTT,
#endif 

#ifdef __CAMERA_FEATURE_IMAGE_SIZE_M__
    STR_ID_CAMERA_IMAGE_SIZE_M_TTT,
#endif 

#ifdef __CAMERA_FEATURE_IMAGE_SIZE_L__
    STR_ID_CAMERA_IMAGE_SIZE_L_TTT,
#endif 

#ifdef __CAMERA_FEATURE_IMAGE_SIZE_LL__
    STR_ID_CAMERA_IMAGE_SIZE_LL_TTT,
#endif 
...
#define CAMERA_OSD_IDP_ROTATE_BUFFER (((GDI_LCD_WIDTH*GDI_LCD_HEIGHT*GDI_MAINLCD_BIT_PER_PIXEL)>>3))
#else
#define CAMERA_OSD_IDP_ROTATE_BUFFER (0)
#endif
...
#ifdef __CAMERA_FEATURE_CONTRAST__
    CAMERA_CAMERA_SETTING_CONTRAST,
...
typedef enum
{
    MMI_CAMERA_FORWARD_TO_EMAIL,
    MMI_CAMERA_FORWARD_TO_BT,
    MMI_CAMERA_FORWARD_TO_MMS,
    MMI_CAMERA_FORWARD_TO_POSTCARD,

    NUM_OF_MMI_CAMERA_FORWARD_TO
} mmi_camera_forward_to_enum;
...
typedef enum
{
    CAMERA_SETTING_CONTRAST_HIGH,
    CAMERA_SETTING_CONTRAST_MEDIUM,
    CAMERA_SETTING_CONTRAST_LOW,

    CAMERA_SETTING_CONTRAST_COUNT
} camera_setting_contrast_enum;

/* vdorec pop up result type*/
typedef enum
{
    MMI_CAMERA_POPUP_RESULT_PROCESS_NONE = 0,
        MMI_CAMERA_POPUP_RESULT_PROCESS_DELETE_GROUP,
        MMI_CAMERA_POPUP_RESULT_PROCESS_DELETE_SCREEN,
        
        MMI_CAMERA_POPUP_RESULT_PROCESS_ALL
} mmi_camera_popup_result_process_enum;

typedef enum
{
	MMI_CAMERA_LAYER_COUNT_ONE = 1,
	MMI_CAMERA_LAYER_COUNT_TWO,	
	MMI_CAMERA_LAYER_COUNT_THREE,
	MMI_CAMERA_LAYER_COUNT_FOUR,
	MMI_CAMERA_LAYER_COUNT_FIVE,

	MMI_CAMERA_LAYER_COUNT_ALL
} mmi_camera_layer_count_enum;

/*********** Image Size ***********/
typedef enum
{
    CAMERA_IMAGE_SIZE_WALLPAPER,
    CAMERA_IMAGE_SIZE_VGA,
    CAMERA_IMAGE_SIZE_1M,    
    CAMERA_IMAGE_SIZE_2M,
    CAMERA_IMAGE_SIZE_3M,
    CAMERA_IMAGE_SIZE_4M,
    CAMERA_IMAGE_SIZE_5M,
    
    CAMERA_IMAGE_SIZE_COUNT
} camera_query_image_size_enum;
...
typedef struct
{
	...
	//chenchao add 2013.06.19  注意同时修改NVRAM_EF_CAMERA_SETTING_SIZE 
...
typedef struct {
    ...
    const camera_skin_icon_struct *ppos_270;
...
typedef struct
{
    ...
    S32 height;
    S32 is_hide;
    const camera_icon_struct *picon;
...
typedef struct
{
    ...
    S32 height;
    U16 key;
}camera_ui_button_struct;

typedef struct
{
	U8 layer_count;

    MMI_BOOL is_portrait_landscape_support;
	MMI_BOOL is_capture_small_image_from_layer;
	MMI_BOOL is_direct_sensor_support;
	MMI_BOOL is_horizontal_osd_support;
	MMI_BOOL is_hw_rotate_support;
	MMI_BOOL is_camera_profiling_support;
	MMI_BOOL is_watchdog_support;
    MMI_BOOL is_update_regions;    /* used for direct sensor v2. for when blt its OSD can not cover with preview area*/
} camera_support_struct;

#if defined(__MMI_CAMERA_FEATURE_WATCHDOG_TIMEOUT__)

typedef enum
{
    MMI_CAMERA_WG_STAT_INVALID = 0,
    MMI_CAMERA_WG_STAT_RUN,
    MMI_CAMERA_WG_STAT_STOP
}camera_watchdog_stat_enum;

typedef struct
{
    camera_watchdog_stat_enum stat;
    S32 delay;
    void (*timeout)(void);
}camera_watchdog_struct;

/*
 * index of watchdog of camera
 */
enum
{
    MMI_CAMERA_WG_APP = 0,  /* App watchdog */
    MMI_CAMERA_WG_DELETE_CONFIRM, /* Delete confirm watchdog */
    MMI_CAMERA_WG_COUNT
};
...
#define CAMERA_TOUCH_NONE CAMERA_TOUCH_ICON_MAX
...
typedef struct
{
    ...
    camera_ui_button_struct buttons[CAMERA_BUTTON_MAX];
}camera_osd_struct;

typedef struct
{
    /*for cui pat*/
    mmi_camera_external_mode_enum external_request_mode;
    mmi_id cur_gid;
    ...
    const camera_skin_layout_struct *active_camera_osd_ptr;
    mmi_id setting_img_inline_gid;
    mmi_id setting_menu_gid;


    /* layer and memory */
    gdi_handle base_layer_handle;
    gdi_handle osd_layer_handle;   /* osd layer. double buffer*/
#ifdef __MMI_CAMERA_MULTI_OSD_LAYER__
	PU8 osd_layer_region_handle_ptr[CAMERA_OSD_REGION_MAX];
#ifdef __CAMERA_FEATURE_DRAW_BUTTONS__
    PU8 osd_layer_region_handle_ptr2; //for double nuffer layer, button region
#endif
	gdi_handle osd_layer_region_handle[CAMERA_OSD_REGION_MAX];
	gdi_handle osd_idp_layer_region_handle[CAMERA_OSD_REGION_MAX];
	PU8 osd_idp_layer_region_handle_ptr[CAMERA_OSD_REGION_MAX];
#endif
    PU8 osd_layer_buf_ptr0;         /* buffer0 of osd layer. screen memory */
    PU8 osd_buf_p;                  /* buffer1 of osd layer. use GDI layer buffer */
    gdi_handle preview_layer_handle;
    PU8 preview_buf_p;              /* base layer memory */
    gdi_handle gdi_layer_handle;

    gdi_handle sublcd_base_layer_handle;
#if defined(__CAMERA_FEATURE_ROTATE_OSD_SELF__)
    void *app_mem_pool;
    gdi_handle osd_idp_rotate_layer_handle; /* Use App memory */
#endif
   
    PU8 capture_buf_ptr;    /* Get from MDI */
    U32 capture_size;

    /* File path */
    U16 filename_seq_no;
    CHAR *storage_filepath; //image folder path
    CHAR *captured_filepath;// image file path
    BOOL is_filename_committed;

    /* flags */
    U32  pressed_key;
    BOOL is_long_key;   /* if need wait long for repeated key */
    ...
    MMI_BOOL is_preview_started; /* currently used for direct sensor v2 */
	MMI_BOOL is_autofocus_pressed;
    MMI_BOOL ori_te_ctrl;
    pBOOL is_in_fast_forward;
	BOOL is_enable_PQ;
    ...
    U16 preview_offset_x;
    U16 preview_offset_y;
    U16 preview_width;
    U16 preview_height;
    U16 image_width;
    U16 image_height;
    ...
    WCHAR hint1_buf[CAMERA_HINT_BUF_SIZE];
    WCHAR hint2_buf[CAMERA_HINT_BUF_SIZE];
    U16 fade_time;
    ...
    mmi_camera_forward_to_enum forward_to;

    U8  cbm_app_id;

    camera_osd_struct   osd_data;


#if defined(__MMI_CAMERA_FEATURE_WATCHDOG_TIMEOUT__)
    camera_watchdog_struct watchdog[MMI_CAMERA_WG_COUNT]; /*There're two watchdogs in App*/
#endif
...
extern void mmi_camera_restore_factory(void);
#endif 
...
extern void mmi_camera_draw_style_text(PS8 str, S32 offset_x, S32 offset_y, S32 truncated_width, const camera_style_text_struct *style_txt);
#if defined(__CAMERA_FEATURE_STORAGE__)
extern void mmi_camera_set_storage_to(U16 storage);
#endif 

extern void mmi_camera_entry_image_setting_screen(void);
extern void mmi_camera_entry_wb_screen(void);
extern void mmi_camera_entry_camera_setting_screen(void);
extern void mmi_camera_entry_dsc_mode_screen(void);
extern void mmi_camera_entry_restore_default_confirm_screen(void);
extern void mmi_camera_camera_setting_set_value(void);
extern void mmi_camera_image_setting_set_value(void);
