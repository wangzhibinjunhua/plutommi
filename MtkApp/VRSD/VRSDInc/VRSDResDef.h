...
typedef enum
{
    ...
    STR_ID_VRSD_DELETE_ALL,
    STR_ID_VRSD_REQUESTION,
    STR_ID_VRSD_PROFILE_SILENT_ACTIVED,
    STR_ID_VRSD_DELETE_TAG_QUESTION,
    STR_ID_VRSD_TAG_QUESTION
} vrsd_str_id_enum;

typedef enum
{
    IMG_ID_VRSD_APP = VRSD_BASE + 1,
    IMG_ID_VRSD_SHORTCUT,
