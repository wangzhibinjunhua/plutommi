...
extern mmi_ret mmi_vrsd_delete_contact_callback(mmi_event_struct* para);

extern void mmi_vrsddial_set_cur_store_index(U16 index);
...
extern void mmi_vrsd_train_delete_option_scr(U16 scrID);
