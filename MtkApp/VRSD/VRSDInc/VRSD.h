...
//guoming add
#define STR_GLOBAL_FAILURE STR_GLOBAL_ERROR
/* 
 * Typedef 
 */
typedef enum
...
extern void mmi_vrsd_train_result_ind(mdi_result result, void *user_data);
extern void mmi_vrsd_train_success(void);

#define MMI_VRSD_RCG
extern void mmi_vrsd_rcg_pre_entry(void);
extern void mmi_vrsd_rcg_init(void);
extern void mmi_vrsd_rcg_result_ind(mdi_result result, void *user_data);
...
extern void mmi_vrsd_recv_voice_req(mdi_result event, void *user_data);
...
extern void mmi_vrsd_playback_finish(mdi_result result, void *user_data);
...
extern BOOL mmi_vrsd_del_tag_req(U16 vrtag_id);
...
extern BOOL mmi_vrsddial_check_sim_change_not_at_idle(void);
#if defined(__MMI_BT_SUPPORT__)
extern void mmi_vrsd_bt_set_ind_hdlr(void *msg);
extern void mmi_vrsd_bt_set_ind_cnf(BOOL success);
extern void mmi_vrsd_bt_set_req(BOOL is_activate);
extern void mmi_vrsd_bt_set_rsp_hdlr(void *msg);
extern void mmi_vrsd_bt_connect_sco_hdlr(void);
