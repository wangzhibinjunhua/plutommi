...
extern void mmi_mexe_read_rpk_file_info_rsp(srv_sim_cb_struct *param);

extern void mmi_mexe_read_rpk_file_req(U8 file_id);
extern void mmi_mexe_read_rpk_file_rsp(srv_sim_cb_struct *param);

extern void mmi_mexe_read_rpk_instance_req(void);
extern void mmi_mexe_read_rpk_instance_rsp(srv_sim_cb_struct *param);

extern void mmi_mexe_read_service_table_req(void);
extern void mmi_mexe_read_service_table_rsp(srv_sim_cb_struct *param);
