...
#define MMI_VOIP_TRC_GRP MMI_COMMON_TRC_G5_CALL
...
extern U8 mmi_voip_ucm_get_act_opcode(void);
...
extern void mmi_voip_ucm_force_release_req(void *actStruct);
...
extern void mmi_voip_ucm_alert_ind(S32 groupId, S32 callId, MMI_BOOL localGen);
...
extern void mmi_voip_ucm_replace_ind(S32 groupId, S32 callId, S32 old_groupIdx, S32 new_groupIdx, S32 old_callIdx, S32 new_callIdx);
