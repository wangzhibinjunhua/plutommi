...
/* To represent which vertical bar must be shown */
typedef enum
{
    VERTICAL_BAR_UP,
    VERTICAL_BAR_DOWN,
    VERTICAL_BAR_MAX,
    VERTICAL_BAR_MIN
}mmi_volume_hdlr_vertical_bar_type;
...
extern void KeyToneVolumeFunction(void);

extern U8 mmi_vol_get_speech_vol(void);
extern void mmi_vol_set_speech_vol(U8 volume);
extern void mmi_vol_set_ring_vol(U8 volume);
