...
#else /*!defined( __MMI_WEARABLE_DEVICE__) || (defined( __MMI_WEARABLE_DEVICE__)&&defined(__MMI_WEARABLE_DEVICE_DIALER__))*/
...
mmi_id mmi_dialer_launch_by_key_ex(
    cui_dialer_type_enum type,
    U16 key_code)
{
	return GRP_ID_INVALID;
...
#endif /*!defined( __MMI_WEARABLE_DEVICE__) || (defined( __MMI_WEARABLE_DEVICE__)&&defined(__MMI_WEARABLE_DEVICE_DIALER__))*/
