...
#if defined (__MMI_APP_MANAGER_SUPPORT__) && (defined(__MMI_TELEPHONY_SUPPORT__) || (defined(__MMI_WEARABLE_DEVICE__)&& defined(__MMI_WEARABLE_DEVICE_DIALER__)))
...
>
    ...
    <!--String Resource Area-->
#if defined(__MMI_APP_MANAGER_SUPPORT__) || (defined(__MMI_WEARABLE_DEVICE__)&& defined(__MMI_WEARABLE_DEVICE_DIALER__))
