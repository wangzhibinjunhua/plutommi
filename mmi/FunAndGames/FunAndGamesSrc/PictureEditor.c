...
void EntryScr4PicEditSelectMenu(void)
{
    ...
    if (guiBuffer == NULL)
    {
        ...
        sprintf(imagePath, "%c:\\", SRV_FMGR_PUBLIC_DRV);
...
void FillPicEditResizeInLine(InlineItem *ResizeInline)
{
    ...
    SetInlineItemTextEdit(&ResizeInline[3], (PU8) nInlinePEScrWidth, PE_RESIZE_BUF_SIZE, IMM_INPUT_TYPE_NUMERIC);   /* 100405 image editor Calvin */
    ...
    SetInlineItemTextEdit(&ResizeInline[5], (PU8) nInlinePEScrHeight, PE_RESIZE_BUF_SIZE, IMM_INPUT_TYPE_NUMERIC);  /* 100405 image editor Calvin */
...
static void SavePicEditImageAndShowResult(void)
{
    ...
    {
        DisplayPopup(
            (U8*) get_string(srv_fmgr_fs_error_get_string(result)),
            IMG_GLOBAL_ERROR,
            1,
            PE_NOTIFYDURATION,
            ERROR_TONE);
...
static S32 SavePicEditImageDataBuff(void)
{
    ...
    sprintf(fileBuf, "%c:\\", SRV_FMGR_PUBLIC_DRV);
