...
#define MMI_GX_PUZZLE_TIME_POSITION_X  (88)
...
#define MMI_GX_PUZZLE_TIME_POSITION_X  (91)
#define MMI_GX_PUZZLE_TIME_POSITION_Y  (22)
#define MMI_GX_PUZZLE_STEP_POSITION_X  (167)
#define MMI_GX_PUZZLE_STEP_POSITION_Y  (22)
#define MMI_GX_PUZZLE_BAR_COLOR        (MMI_GX_PUZZLE_LINE_COLOR)
#define MMI_GX_PUZZLE_LCD_HEIGHT       (400)
#define MMI_GX_PUZZLE_LCD_WIDTH        (240)
#elif defined(__MMI_MAINLCD_320X480__)
#define MMI_GX_PUZZLE_TIME_POSITION_X  (55)
#define MMI_GX_PUZZLE_TIME_POSITION_Y  (288)
#define MMI_GX_PUZZLE_STEP_POSITION_X  (206)
#define MMI_GX_PUZZLE_STEP_POSITION_Y  (288)
#define MMI_GX_PUZZLE_BAR_COLOR        (MMI_GX_PUZZLE_LINE_COLOR)
#define MMI_GX_PUZZLE_LCD_HEIGHT       (480)
#define MMI_GX_PUZZLE_LCD_WIDTH        (320)
#endif 
...
#elif defined(__MMI_MAINLCD_240X320__)
#define MMI_GX_PUZZLE_ORIGIN_X         (8)
#define MMI_GX_PUZZLE_ORIGIN_Y         (58)
...
#define MMI_GX_PUZZLE_SOFTKEY_X (166)
#define MMI_GX_PUZZLE_SOFTKEY_Y (293)
#define MMI_GX_PUZZLE_SOFTKEY_WIDTH (60)
#define MMI_GX_PUZZLE_SOFTKEY_HEIGHT (24)
#elif defined(__MMI_MAINLCD_320X240__)
...
#elif defined(__MMI_MAINLCD_240X400__)
#define MMI_GX_PUZZLE_ORIGIN_X         (7)
#define MMI_GX_PUZZLE_ORIGIN_Y         (102)
#define MMI_GX_PUZZLE_SIZE             (225)
#define MMI_GX_PUZZLE_LEFT_BAR_WIDTH   (8)
#define MMI_GX_PUZZLE_RIGHT_BAR_WIDTH  (7)
#define MMI_GX_PUZZLE_TOP_BAR_WIDTH    (8)
...
#define MMI_GX_PUZZLE_SOFTKEY_X (158)
#define MMI_GX_PUZZLE_SOFTKEY_Y (355)
#define MMI_GX_PUZZLE_SOFTKEY_WIDTH (74)
#define MMI_GX_PUZZLE_SOFTKEY_HEIGHT (37)
#elif defined(__MMI_MAINLCD_320X480__)
#define MMI_GX_PUZZLE_ORIGIN_X         (10)
#define MMI_GX_PUZZLE_ORIGIN_Y         (105)
#define MMI_GX_PUZZLE_SIZE             (300)
#define MMI_GX_PUZZLE_LEFT_BAR_WIDTH   (9)
#define MMI_GX_PUZZLE_RIGHT_BAR_WIDTH  (9)
#define MMI_GX_PUZZLE_TOP_BAR_WIDTH    (9)
#define MMI_GX_PUZZLE_BOTTOM_BAR_WIDTH (9)
#define MMI_GX_PUZZLE_DIGIT_WIDTH      (13)

#define MMI_GX_PUZZLE_SOFTKEY_X (213)
#define MMI_GX_PUZZLE_SOFTKEY_Y (428)
#define MMI_GX_PUZZLE_SOFTKEY_WIDTH (96)
#define MMI_GX_PUZZLE_SOFTKEY_HEIGHT (40)
#endif 
...
typedef enum
{
    ...
    MMI_PUZZLE_STRING_TIME,
    MMI_PUZZLE_STRING_STEP,
...
MMI_BOOL g_puzzle_is_right_key_pressed;
...
void mmi_gx_puzzle_key_6_pressed(void);
...
static void mmi_puzzle_pen_move_hdlr(mmi_pen_point_struct pos);
static void mmi_puzzle_rsk_down_hdlr(void);
static void mmi_puzzle_rsk_up_hdlr(void);
...
#elif defined(__MMI_MAINLCD_128X160__) || defined(__MMI_MAINLCD_176X220__) || \
      defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_320X240__) || \
      defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__) 
...
void mmi_gx_puzzle_enter_game(void)
{
    ...
    SetKeyHandler(mmi_gx_puzzle_key_6_pressed, KEY_6, KEY_EVENT_DOWN);
    SetKeyHandler(mmi_gx_puzzle_key_6_release, KEY_6, KEY_EVENT_UP);
    SetKeyHandler(mmi_gx_puzzle_key_6_pressed, KEY_RIGHT_ARROW, KEY_EVENT_DOWN);
    ...
    wgui_register_pen_move_handler(mmi_puzzle_pen_move_hdlr);
    SetKeyHandler(mmi_puzzle_rsk_down_hdlr, KEY_RSK, KEY_EVENT_DOWN);
    SetKeyHandler(mmi_puzzle_rsk_up_hdlr, KEY_RSK, KEY_EVENT_UP);
#endif /* __MMI_TOUCH_SCREEN__ */ 
...
void mmi_gx_puzzle_draw_static_background(void)
{
    ...
    gui_show_image(0, 0, (PU8) GetImage(IMG_ID_GX_PUZZLE_BG));
#else
...
#elif defined(__MMI_MAINLCD_240X320__)
    gui_show_image(27, 6, (PU8) GetImage(g_gx_puzzle_context.small_image));
    if (g_gx_puzzle_context.game_level == MMI_GX_PUZZLE_NORMAL)
    {
        gui_draw_vertical_line(
            MMI_GX_PUZZLE_ORIGIN_Y,
...
#elif defined(__MMI_MAINLCD_320X240__)
    gui_show_image(255, 88, (PU8) GetImage(g_gx_puzzle_context.small_image));
	#if 0    
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
	#endif
#elif defined(__MMI_MAINLCD_240X400__)
    gui_show_image(21, 23, (PU8) GetImage(g_gx_puzzle_context.small_image));
#elif defined(__MMI_MAINLCD_320X480__)
    gui_show_image(30, 21, (PU8) GetImage(g_gx_puzzle_context.small_image));
#endif 

#if defined(__MMI_TOUCH_SCREEN__) && \
    (defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_320X240__) || \
     defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__))      /* || defined(__MMI_MAINLCD_176X220__)) */
    /* draw softkay image */
    gdi_image_draw_id(MMI_GX_PUZZLE_SOFTKEY_X, MMI_GX_PUZZLE_SOFTKEY_Y, IMG_ID_GX_PUZZLE_UP);
    gui_BLT_double_buffer(0, 0, UI_device_width - 1, UI_device_height - 1);

#endif /* defined(__MMI_TOUCH_SCREEN__) && defined(__MMI_MAINLCD_240X320__) */ 
    gui_show_image(
...
/* under construction !*/
...
#else
    {
        ...
        image_id = mmi_gfx_get_multilanguage_image_ID(
         mmi_puzzle_language_index, 
         IMG_ID_GX_PUZZLE_GOTEXT_LANGUAGE0, 
         MMI_PUZZLE_STRING_COUNT, 
         MMI_PUZZLE_STRING_TIME);
    ...
    gui_show_image(91, 20, (PU8) GetImage(image_id));
#elif defined(__MMI_MAINLCD_240X320__)
    gui_show_image(91, 3, (PU8) GetImage(image_id));
#elif defined(__MMI_MAINLCD_320X240__)
    gui_show_image(250, 20, (PU8) GetImage(image_id));
#elif defined(__MMI_MAINLCD_320X480__)
    gui_show_image(124, 22, (PU8) GetImage(image_id));
#endif
    }
#endif  /* __MMI_GAME_MULTI_LANGUAGE_SUPPORT__ */

/* draw step background box */
#if defined(__MMI_MAINLCD_240X320__)
    gui_show_image(
        167,
        22,
...
#if defined(__MMI_MAINLCD_240X400__)
        gui_show_image(167, 20, (PU8) GetImage(image_id));
#elif defined(__MMI_MAINLCD_240X320__)
        gui_show_image(167, 3, (PU8) GetImage(image_id));
#elif defined(__MMI_MAINLCD_320X240__)
    gui_show_image(250, 160, (PU8) GetImage(image_id));
#elif defined(__MMI_MAINLCD_320X480__)
        gui_show_image(225, 22, (PU8) GetImage(image_id));
#endif
    }
#endif  /* __MMI_GAME_MULTI_LANGUAGE_SUPPORT__ */

    mmi_gx_puzzle_draw_step();
#endif /* defined(__MMI_MAINLCD_128X160__) || defined(__MMI_MAINLCD_176X220__) || defined(__MMI_MAINLCD_240X320__) */ 
}
...
void mmi_gx_puzzle_init_game(void)
{
    ...
    /*----------------------------------------------------------------*/
    /* initialize */
    g_puzzle_is_right_key_pressed = MMI_FALSE;
...
/* under construction !*/
    ...
    if (g_gx_puzzle_context.long_tick % 10 == 0)
    {
        ...
        #elif defined(__MMI_MAINLCD_320X480__)
                           MMI_GX_PUZZLE_TIME_POSITION_Y + 7 + 128,
        #endif 
                           (PU8) GetImage(image_id));
...
void mmi_gx_puzzle_cyclic_timer(void)
{
    ...
    if (g_gx_puzzle_context.long_tick > 99990)
    {
        g_gx_puzzle_context.long_tick = 99990;
    }
...
void mmi_gx_puzzle_key_6_pressed(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    g_puzzle_is_right_key_pressed = MMI_TRUE;
}
...
void mmi_gx_puzzle_key_6_release(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if (g_puzzle_is_right_key_pressed)
    {
        g_gx_puzzle_context.destination_x = -1;
        g_gx_puzzle_context.destination_y = 0;
...
#elif defined(__MMI_MAINLCD_240X320__)
    position_shift = MMI_GX_PUZZLE_STEP_POSITION_X + 22 - 64;
#elif defined(__MMI_MAINLCD_240X400__)
    position_shift = MMI_GX_PUZZLE_STEP_POSITION_X + 22 - 68;
#elif defined(__MMI_MAINLCD_320X480__)
    position_shift = 195 + 28;
#endif 
...
#endif /* defined(__MMI_TOUCH_SCREEN__) && defined(__MMI_MAINLCD_240X320__) */ /* __MMI_TOUCH_SCREEN__ && ( __MMI_MAINLCD_240X320__ || __MMI_MAINLCD_176X220__ ) */
}
#endif /* __MMI_TOUCH_SCREEN__ */ 
...
/* under construction !*/
    ...
    if (pos_x >= MMI_GX_PUZZLE_ORIGIN_X && pos_y >= MMI_GX_PUZZLE_ORIGIN_Y)
    {
 ...
 *  void
 *****************************************************************************/
void mmi_puzzle_pen_move_hdlr(mmi_pen_point_struct pos)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
