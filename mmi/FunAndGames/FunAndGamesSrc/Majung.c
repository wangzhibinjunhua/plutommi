...
#define __MAJUNG_DRAW_SCORE__
#define __MAJUNG_DRAW_EXIT__
#define LEVEL_ROW_COUNT_EASY        (10)
#define LEVEL_COLUMN_COUNT_EASY (8)
#define LEVEL_ROW_COUNT_NORMAL      (10)
#define LEVEL_COLUMN_COUNT_NORMAL (10)
#define LEVEL_ROW_COUNT_HARD        (10)
#define LEVEL_COLUMN_COUNT_HARD     (12)
#define MAJUNG_LEVEL_COUNT (50)
...
#define MAJUNG_BLOCK_ROW_COUNT      (12)
#define MAJUNG_BLOCK_COLUMN_COUNT   (14)
#define MAJUNG_THICK_BRICK_Y_MARGIN (3) /* the y difference btw thick img top and brick img buttom */                          
#define UNIT_ENERGY_INCREASE_PER_SCORE (8)
#define MAJUNG_ENERGY_LIMIT         (20)
#define MAJUNG_ENERGY_INIT    (20)
#define MAJUNG_SCORE_X        (10)
#define MAJUNG_SCORE_Y        (350)
#define MAJUNG_EXIT_X         (199)
#define MAJUNG_EXIT_Y         (335)
#define MAJUNG_EXIT_WIDTH     (40)
#define MAJUNG_EXIT_HEIGHT    (20)
#define MAJUNG_DIGIT_WIDTH    (9)
...
#define LEVEL_COLUMN_COUNT_HARD     (12)
#define MAJUNG_LEVEL_COUNT (50)
#define ENERGYBAR_POS_X (281)
#define ENERGYBAR_POS_Y (30)
#define MAJUNG_BRICK_WIDTH       (19)
#define MAJUNG_BRICK_HEIGHT         (25)
#define MAJUNG_BLOCK_ROW_COUNT      (12)
#define MAJUNG_BLOCK_COLUMN_COUNT   (14)
#define MAJUNG_THICK_BRICK_Y_MARGIN (3) /* the y difference btw thick img top and brick img buttom */                          
...
#define MAJUNG_ENERGY_LIMIT         (20)
#define MAJUNG_ENERGY_INIT    (20)
#define MAJUNG_SCORE_X        (28)
#define MAJUNG_SCORE_Y        (380)
#define MAJUNG_EXIT_X         (199)
#define MAJUNG_EXIT_Y         (335)
#define MAJUNG_EXIT_WIDTH     (45)
#define MAJUNG_EXIT_HEIGHT    (33)
#define MAJUNG_DIGIT_WIDTH    (9)

 #endif 

#define MAJUNG_KEY_REPEAT_DUR   (100)
...
#elif defined(__MMI_MAINLCD_240X400__)
U16 majung_lcd_width = 240;
U16 majung_lcd_height = 400;
#elif defined(__MMI_MAINLCD_320X480__)
U16 majung_lcd_width = 320;
U16 majung_lcd_height = 480;
#endif 
...
#ifdef __MMI_TOUCH_SCREEN__
static MMI_BOOL is_majung_rsk_pressed;
#endif
/************************************************************************/
/* Function Declare                                                     */
/************************************************************************/
...
/* User Input */
void Majung_up_arrow_press_hdlr(void);
void Majung_up_arrow_release_hdlr(void);
void Majung_down_arrow_press_hdlr(void);
void Majung_down_arrow_release_hdlr(void);
void Majung_left_arrow_press_hdlr(void);
void Majung_left_arrow_release_hdlr(void);
void Majung_right_arrow_press_hdlr(void);
void Majung_right_arrow_release_hdlr(void);
...
static void Majung_rsk_down(void);
static void Majung_rsk_up(void);
...
void mmi_majung_pen_move_hdlr(mmi_pen_point_struct);
...
void Majung_Draw_Exit(void)
{
    ...
    S32 exit_width = 0, exit_height = 0, energey_width = 0, energy_height = 0, grade_width = 0, grade_height = 0;

    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    gdi_image_get_dimension_id(IMG_GX_MAJUNG_EXIT_UP, &exit_width, &exit_height);
    gdi_image_get_dimension_id(IMG_GX_MAJUNG_BAR_FILL_1, &energey_width, &energy_height);
    gdi_image_get_dimension_id(IMG_GX_MAJUNG_BOX, &grade_width, &grade_height);

    position_x = ENERGYBAR_POS_X + energey_width - exit_width;
    position_y = MAJUNG_SCORE_Y + grade_height/2 - exit_height/2;
    ...
    {
        gdi_image_draw_id(position_x, position_y, IMG_GX_MAJUNG_EXIT_UP);
    }
    else
    {
        gdi_image_draw_id(position_x, position_y, IMG_GX_MAJUNG_EXIT_DOWN);
    }
...
void Majung_Draw_Score(void)
{
    ...
    /*calc the loaction to draw score*/
    if (majung_game_level == LEVEL_EASY)
    {
    ...
    else if(majung_game_level == LEVEL_NORMAL)
    {
        ...
        level_idx_shift_x = 1;  
#else
        level_idx_shift_x = 1;  /* this two shifts bricks to screen center */
#endif
    }
    else
    {
    ...
    score_position_x = level_idx_shift_x * MAJUNG_BRICK_WIDTH + majung_brick_start_offset_x; 
#ifdef __MMI_MAINLCD_320X240__
    gdi_image_draw_id(MAJUNG_SCORE_X, MAJUNG_SCORE_Y, IMG_GX_MAJUNG_BOX);
#else
    gdi_image_draw_id(score_position_x, MAJUNG_SCORE_Y, IMG_GX_MAJUNG_BOX);
#endif
    ...
    do
    {
        ...
        gdi_image_draw_id(score_position_x + position_shift - 3, MAJUNG_SCORE_Y + 2, image_id);
    #elif defined(__MMI_MAINLCD_240X320__)
        gdi_image_draw_id(score_position_x + position_shift - 5, MAJUNG_SCORE_Y + 5, image_id);
    #elif defined(__MMI_MAINLCD_320X240__)
        gdi_image_draw_id(MAJUNG_SCORE_X + position_shift - 7, MAJUNG_SCORE_Y + 2, image_id);
    #elif defined(__MMI_MAINLCD_240X400__)
        gdi_image_draw_id(score_position_x + position_shift - 7, MAJUNG_SCORE_Y + 6, image_id);
    #elif defined(__MMI_MAINLCD_320X480__)
        gdi_image_draw_id(MAJUNG_SCORE_X + position_shift - 7, MAJUNG_SCORE_Y + 7, image_id);
    #endif 
...
void Majung_Enter_Game(void)
{
...
#ifdef __MMI_TOUCH_SCREEN__
    is_majung_rsk_pressed = MMI_FALSE;
#endif
    majung_is_new_game = FALSE;
    majung_is_gameover = FALSE;
    majung_draw_background = TRUE;

    SetKeyHandler(Majung_right_arrow_press_hdlr, KEY_RIGHT_ARROW, KEY_EVENT_DOWN);
    SetKeyHandler(Majung_left_arrow_press_hdlr, KEY_LEFT_ARROW, KEY_EVENT_DOWN);
    SetKeyHandler(Majung_down_arrow_press_hdlr, KEY_DOWN_ARROW, KEY_EVENT_DOWN);
    SetKeyHandler(Majung_up_arrow_press_hdlr, KEY_UP_ARROW, KEY_EVENT_DOWN);

    SetKeyHandler(Majung_right_arrow_release_hdlr, KEY_RIGHT_ARROW, KEY_EVENT_UP);
    SetKeyHandler(Majung_left_arrow_release_hdlr, KEY_LEFT_ARROW, KEY_EVENT_UP);
    SetKeyHandler(Majung_down_arrow_release_hdlr, KEY_DOWN_ARROW, KEY_EVENT_UP);
    SetKeyHandler(Majung_up_arrow_release_hdlr, KEY_UP_ARROW, KEY_EVENT_UP);
    
    SetKeyHandler(Majung_right_arrow_press_hdlr, KEY_6, KEY_EVENT_DOWN);
    SetKeyHandler(Majung_left_arrow_press_hdlr, KEY_4, KEY_EVENT_DOWN);
    SetKeyHandler(Majung_down_arrow_press_hdlr, KEY_8, KEY_EVENT_DOWN);
    SetKeyHandler(Majung_up_arrow_press_hdlr, KEY_2, KEY_EVENT_DOWN);

    SetKeyHandler(Majung_right_arrow_release_hdlr, KEY_6, KEY_EVENT_UP);
    SetKeyHandler(Majung_left_arrow_release_hdlr, KEY_4, KEY_EVENT_UP);
    SetKeyHandler(Majung_down_arrow_release_hdlr, KEY_8, KEY_EVENT_UP);
    SetKeyHandler(Majung_up_arrow_release_hdlr, KEY_2, KEY_EVENT_UP);

    SetKeyHandler(Majung_rsk_down, KEY_RSK, KEY_EVENT_DOWN);
    SetKeyHandler(Majung_rsk_up, KEY_RSK, KEY_EVENT_UP);
    ...
    wgui_register_pen_move_handler(mmi_majung_pen_move_hdlr);
#endif /* __MMI_TOUCH_SCREEN__ */ 
...
void Majung_Load_New_Stage(void)
{
    ...
    #elif  defined(__MMI_MAINLCD_240X400__)
        majung_brick_start_offset_x = 18;
        majung_brick_start_offset_y = 20;
    #elif defined(__MMI_MAINLCD_320X480__)
        majung_brick_start_offset_x = 9;
        majung_brick_start_offset_y = 35;
    #else
...
void Majung_Render_Energy(void)
{
    ...
    /*----------------------------------------------------------------*/
    S16 i;
    S16 energy_postion_y, energy_postion_x, level_idx_shift_y;
    S32 energey_width = 0, energy_height = 0;

    /*----------------------------------------------------------------*/
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    
    /*calc the position to draw energy*/
    if (majung_game_level == LEVEL_EASY)
    {
#if defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__)
        level_idx_shift_y = 1;  
#else
        level_idx_shift_y = 2;  /* this two shifts bricks to screen center */
#endif
    ...
    else if(majung_game_level == LEVEL_NORMAL)
    {
        ...
        level_idx_shift_y = 1;  
#else
        level_idx_shift_y = 1;  /* this one shifts bricks to screen center */
#endif
    }
    else
    {
    ...
    energy_postion_y = level_idx_shift_y * MAJUNG_BRICK_HEIGHT + majung_brick_start_offset_y;
    energy_postion_x = ENERGYBAR_POS_X;
    #if defined(__MMI_MAINLCD_240X400__)
    if (majung_game_level == LEVEL_EASY)
    {
        energy_postion_x -= 20;
    ...
    else if (majung_game_level == LEVEL_NORMAL)
    {
        ...
        energy_postion_y += 7; /*for image height can not devid by 20, so adjust the energy position */
    #endif
    ...
    for (i = 0; i < MAJUNG_ENERGY_LIMIT; i++)
    {
        ...
        {
            gdi_image_draw_id(energy_postion_x, energy_postion_y + i * energy_height, (U16) (IMG_GX_MAJUNG_BAR_FILL_1 + i));
        }
        else
        {
            gdi_image_draw_id(energy_postion_x, energy_postion_y + i * energy_height, (U16) (IMG_GX_MAJUNG_BAR_EMPTY_1 + i));
        }
    }
}
...
void Majung_up_arrow_release_hdlr(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    gui_cancel_timer(Majung_Move_Up);
}

/*****************************************************************************
 * FUNCTION
 *  Majung_down_arrow_press_hdlr
 * DESCRIPTION
 *  Majung_down_arrow_press_hdlr
 * PARAMETERS
 *  void
...
/*****************************************************************************
 * FUNCTION
 *  Majung_down_arrow_release_hdlr
 * DESCRIPTION
 *  Majung_down_arrow_release_hdlr
 * PARAMETERS
 *  void
...
void Majung_down_arrow_release_hdlr(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    gui_cancel_timer(Majung_Move_Down);
}

/*****************************************************************************
 * FUNCTION
 *  Majung_left_arrow_press_hdlr
 * DESCRIPTION
 *  Majung_left_arrow_press_hdlr
 * PARAMETERS
 *  void
...
/*****************************************************************************
 * FUNCTION
 *  Majung_left_arrow_release_hdlr
 * DESCRIPTION
 *  Majung_left_arrow_release_hdlr
 * PARAMETERS
 *  void
...
void Majung_left_arrow_release_hdlr(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    gui_cancel_timer(Majung_Move_Left);
}

/*****************************************************************************
 * FUNCTION
 *  Majung_right_arrow_press_hdlr
 * DESCRIPTION
 *  Majung_right_arrow_press_hdlr
 * PARAMETERS
 *  void
...
/*****************************************************************************
 * FUNCTION
 *  Majung_right_arrow_release_hdlr
 * DESCRIPTION
 *  Majung_right_arrow_release_hdlr
 * PARAMETERS
 *  void
...
void Majung_right_arrow_release_hdlr(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    gui_cancel_timer(Majung_Move_Right);
}
...
void Majung_Move_Right(void)
{
    ...
    if (majung_state == PLAY_STATE)
    {
        ...
        gui_start_timer(MAJUNG_KEY_REPEAT_DUR, Majung_Move_Right);
    }
}
...
void Majung_Move_Left(void)
{
    ...
    if (majung_state == PLAY_STATE)
    {
        ...
        gui_start_timer(MAJUNG_KEY_REPEAT_DUR, Majung_Move_Left);
    }
}
...
void Majung_Move_Up(void)
{
    ...
    if (majung_state == PLAY_STATE)
    {
        ...
        gui_start_timer(MAJUNG_KEY_REPEAT_DUR, Majung_Move_Up);
    }
}
...
void Majung_Move_Down(void)
{
    ...
    if (majung_state == PLAY_STATE)
    {
        ...
        gui_start_timer(MAJUNG_KEY_REPEAT_DUR, Majung_Move_Down);
    }
...
void Majung_Keyboard_Key_Handler(S32 vkey_code, S32 key_state)
{
    ...
    if (key_state)
    {
        ...
        {
            case 37:
                Majung_left_arrow_press_hdlr();     /* left */
                break;
            case 38:
                Majung_up_arrow_press_hdlr();       /* up */
                break;
            case 39:
                Majung_right_arrow_press_hdlr();    /* right */
                break;
            case 40:
                Majung_down_arrow_press_hdlr();     /* down */
                break;
        }
    }
    else
    {
        switch (vkey_code)  /* key up */
        {
            case 37:
                Majung_left_arrow_release_hdlr();     /* left */
                break;
            case 38:
                Majung_up_arrow_release_hdlr();       /* up */
                break;
            case 39:
                Majung_right_arrow_release_hdlr();    /* right */
                break;
            case 40:
                Majung_down_arrow_release_hdlr();     /* down */
                break;
        }
    }
...
void mmi_majung_pen_down_hdlr(mmi_pen_point_struct pos)
{
	...
	case  LEVEL_EASY:
#if defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__)
        level_shift_x = 1;  /* this two shifts bricks to screen center */
        level_shift_y = 1;
#else
		level_shift_x = 2;
		level_shift_y = 2;
    ...
    /*get the back image coordinate*/
    gdi_image_get_dimension_id(IMG_GX_MAJUNG_EXIT_UP, &exit_width, &exit_height);
    gdi_image_get_dimension_id(IMG_GX_MAJUNG_BAR_FILL_1, &energey_width, &energy_height);
    gdi_image_get_dimension_id(IMG_GX_MAJUNG_BOX, &grade_width, &grade_height);
    
    position_x = ENERGYBAR_POS_X + energey_width - exit_width;
    position_y = MAJUNG_SCORE_Y + grade_height - exit_height;
#if defined(__MMI_MAINLCD_240X400__)
    if (majung_game_level == LEVEL_EASY)
    {
        position_x -= 20;
    ...
    if (pos.x > position_x && pos.x < position_x + MAJUNG_EXIT_WIDTH
        && pos.y > position_y && pos.y < position_y + MAJUNG_EXIT_HEIGHT)
    {
        is_majung_exit_pressed = TRUE;
        is_majung_rsk_pressed = MMI_TRUE;
        Majung_Render();
    }
    else if (pos.x < majung_brick_start_offset_x + MAJUNG_BRICK_WIDTH * level_shift_x ||
             pos.x >= majung_brick_start_offset_x + (MAJUNG_BLOCK_COLUMN_COUNT) * MAJUNG_BRICK_WIDTH ||
             pos.y < majung_brick_start_offset_y + MAJUNG_BRICK_HEIGHT * level_shift_y ||
             pos.y >= majung_brick_start_offset_y + (MAJUNG_BLOCK_ROW_COUNT) * MAJUNG_BRICK_HEIGHT)
    {
        return;
    }
 ...
 *  void
 *****************************************************************************/
void mmi_majung_pen_move_hdlr(mmi_pen_point_struct pos)
{
    BOOL original_state = is_majung_exit_pressed, is_changed = TRUE;
    U16 position_x = 0, position_y = 0;
    S32 exit_width = 0, exit_height = 0, energey_width = 0, energy_height = 0, grade_width = 0, grade_height = 0;

    if (is_majung_rsk_pressed == MMI_FALSE)
    {
        return;
    }
    ...
    if (original_state != is_majung_exit_pressed)
    {
        is_changed = TRUE;
    }
