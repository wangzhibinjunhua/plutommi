...
static U8 richesBufferDataPtrs[(MAX_DROPPING_OBJECTS+1)*5][RICHES_IMAGEBITBUFFER];
...
void Riches_Init_Bit_Buffer_Pool(void)
{
    ...
    {
        riches_bit_buffer_pool.bitBuffer[i] = richesBufferDataPtrs[i * 5];
    ...
    {
        riches_basket_bitmap.data = richesBufferDataPtrs[i * 5];
    }
}
