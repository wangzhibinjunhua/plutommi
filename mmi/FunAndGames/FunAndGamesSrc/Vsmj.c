...
#define SCORE_FRAME (5)
#define SCORE_WIDTH (210)
#define SCORE_HEIGHT (370)
#elif defined(__MMI_MAINLCD_320X480__)
#define SCORE_POS_X (30)
#define SCORE_POS_Y (30)
#define SCORE_UNIT_HEIGHT (40)
#define SCORE_FRAME (5)
#define SCORE_WIDTH (290)
#define SCORE_HEIGHT (450)
#endif
...
#define BOTTOM_SOLID_HEIHT (8)
#elif defined(__MMI_MAINLCD_320X480__)
#define USER_TILE_WIDTH (22)
#define USER_TILE_HEIGHT (31)
#define GRAVE_POS_X (20)
#define GRAVE_POS_Y (87)
#define BOTTOM_SOLID_HEIHT (8)
#endif
...
#elif defined(__MMI_MAINLCD_240X400__)
const S16 USER_LOCK_POS_X[2] = {30, 349};
const S16 USER_LOCK_POS_Y[2] = {215, 1};
const S16 USER_HIGHLIGHT_POS_X[2] = {349, 30};
const S16 USER_HIGHLIGHT_POS_Y[2] = {215, 1};
const S16 USER_OWN_POS_X[2] = {30, 351};
const S16 USER_OWN_POS_Y[2] = {215, 1};
const S16 USER_FLOWER_POS_X[2] = {30, 225};
const S16 USER_FLOWER_POS_Y[2] = {179, 27};
const S16 HIGHLIGHT_FREE_POS_X[2] = {301, 1};
const S16 HIGHLIGHT_FREE_POS_Y[2] = {185, 27};
#elif defined(__MMI_MAINLCD_320X480__)
const S16 USER_LOCK_POS_X[2] = {40, 417};
const S16 USER_LOCK_POS_Y[2] = {288, 1};
const S16 USER_HIGHLIGHT_POS_X[2] = {417, 40};
const S16 USER_HIGHLIGHT_POS_Y[2] = {288, 1};
const S16 USER_OWN_POS_X[2] = {40, 351};
const S16 USER_OWN_POS_Y[2] = {288, 1};
const S16 USER_FLOWER_POS_X[2] = {40, 262};
const S16 USER_FLOWER_POS_Y[2] = {234, 53};
const S16 HIGHLIGHT_FREE_POS_X[2] = {417, 40};
const S16 HIGHLIGHT_FREE_POS_Y[2] = {234, 33};
#endif
...
#elif defined(__MMI_MAINLCD_240X400__)
#define MMI_GX_VSMJ_RECT_POS_X1 (172)
#define MMI_GX_VSMJ_RECT_POS_Y1 (206)
#elif defined(__MMI_MAINLCD_320X480__)
#define MMI_GX_VSMJ_RECT_POS_X1 (216)
#define MMI_GX_VSMJ_RECT_POS_Y1 (258)
#endif
...
#elif defined(__MMI_MAINLCD_240X400__)
#define PLAYER_SPECIAL_POS_X  (80)
#define PLAYER_SPECIAL_POS_Y  (40)
#elif defined(__MMI_MAINLCD_320X480__)
#define PLAYER_SPECIAL_POS_X  (100)
#define PLAYER_SPECIAL_POS_Y  (50)
#endif
...
#define MMI_GX_VSMJ_EATCASE_BG_WIDTH (64)
#define MMI_GX_VSMJ_GUNCASE_BG_WIDTH (82)
#define MMI_GX_VSMJ_EATCASE_HIGHLIGHT_HEIGHT (29)
#define MMI_GX_VSMJ_GUNCASE_HIGHLIGHT_HEIGHT (29)
#define MMI_GX_VSMJ_EATCASE_HIGHLIGHT_WIDTH (58)
#define MMI_GX_VSMJ_GUNCASE_HIGHLIGHT_WIDTH (76)
#define SIGN_POS_X (10)
#define SIGN_POS_Y (110)
#elif defined(__MMI_MAINLCD_320X480__)
#define PLAYER_SPECIAL_UNIT_WIDTH   (40)
#define PLAYER_SPECIAL_UNIT_HEIGHT (40)
#define MMI_GX_VSMJ_EATCASE_BG_HEIGHT (6)
#define MMI_GX_VSMJ_GUNCASE_BG_HEIGHT (6)
#define MMI_GX_VSMJ_EATCASE_BG_WIDTH (82)
#define MMI_GX_VSMJ_GUNCASE_BG_WIDTH (104)
#define MMI_GX_VSMJ_EATCASE_HIGHLIGHT_HEIGHT (37)
#define MMI_GX_VSMJ_GUNCASE_HIGHLIGHT_HEIGHT (37)
#define MMI_GX_VSMJ_EATCASE_HIGHLIGHT_WIDTH (72)
#define MMI_GX_VSMJ_GUNCASE_HIGHLIGHT_WIDTH (94)
#define SIGN_POS_X (10)
#define SIGN_POS_Y (140)
#endif
...
#define MMI_GX_VSMJ_BACK_ICON_WIDTH   (30)
#define MMI_GX_VSMJ_BACK_ICON_HEIGHT  (30)
#endif
#endif
...
void mmi_gx_vsmj_key_4_release(void);
S32 debug_case = 0;
#endif
...
#if defined(__MMI_TOUCH_SCREEN__)
#if defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__)
static void mmi_gx_vsmj_pen_move_hdlr(mmi_pen_point_struct pos);
static void mmi_gx_vsmj_rsk_down_hdlr(void);
static void mmi_gx_vsmj_rsk_up_hdlr(void);
#endif
#endif
/* key functions */
...
MMI_BOOL g_vsmj_is_up_key_pressed;
MMI_BOOL g_vsmj_is_right_key_pressed;
...
#if defined(__MMI_TOUCH_SCREEN__)
#if defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__)
static MMI_BOOL g_gx_vsmj_is_pen_down;
#endif
#endif
...
void mmi_gx_vsmj_draw_gameover(void)
{
    ...
    if (g_gx_vsmj_context.game_grade <= 0 ||
        g_gx_vsmj_context.game_grade <= PLAYER_ORIGINAL_SCORE + COM_ORIGINAL_SCORE - g_gx_vsmj_context.game_grade)
    {
...
void mmi_gx_vsmj_enter_game(void)
{
...
#if defined(__MMI_TOUCH_SCREEN__)
#if defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__)
    g_gx_vsmj_is_pen_down = MMI_FALSE;
#endif
#endif
    ...
    SetKeyHandler(mmi_gx_vsmj_key_right_pressed, KEY_DOWN_ARROW, KEY_EVENT_DOWN);
    SetKeyHandler(mmi_gx_vsmj_key_right_release, KEY_DOWN_ARROW, KEY_EVENT_UP);
    SetKeyHandler(mmi_gx_vsmj_key_up_pressed, KEY_RIGHT_ARROW, KEY_EVENT_DOWN);
...
#else
    SetKeyHandler(mmi_gx_vsmj_key_up_pressed, KEY_UP_ARROW, KEY_EVENT_DOWN);
    ...
    SetKeyHandler(mmi_gx_vsmj_key_right_pressed, KEY_RIGHT_ARROW, KEY_EVENT_DOWN);
    ...
    SetKeyHandler(mmi_gx_vsmj_key_4_release, KEY_4, KEY_EVENT_UP);
#endif
...
#if defined(__MMI_TOUCH_SCREEN__)
#if defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__)
    wgui_register_pen_move_handler(mmi_gx_vsmj_pen_move_hdlr);
    SetKeyHandler(mmi_gx_vsmj_rsk_down_hdlr, KEY_RSK, KEY_EVENT_DOWN);
    SetKeyHandler(mmi_gx_vsmj_rsk_up_hdlr, KEY_RSK, KEY_EVENT_UP);
#endif
#endif
    /* keyhandler */
...
void mmi_gx_vsmj_exit_game(void)
{
    ...
    gui_fill_rectangle(0, 0, LCD_WIDTH - 1, LCD_HEIGHT - 1, gui_color(0, 0, 0));
...
void mmi_gx_vsmj_init_game(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    g_vsmj_is_up_key_pressed = MMI_FALSE;
    g_vsmj_is_right_key_pressed = MMI_FALSE;    
...
void mmi_gx_vsmj_render(void)
{
    ...
    switch (game_move)
    {
        ...
        #else
            gdi_draw_solid_rect(0, 0, LCD_WIDTH - 1, LCD_HEIGHT - 1, GDI_COLOR_BLUE);
        #endif
        ...
        default:
        #ifndef __MMI_MAINLCD_320X240__
			gui_fill_rectangle(0, 0, LCD_HEIGHT - 1, LCD_WIDTH - 1, gui_color(153, 153, 204));
        #else
            gui_fill_rectangle(0, 0, LCD_WIDTH - 1, LCD_HEIGHT - 1, gui_color(153, 153, 204));
        #endif
        
        #if defined(__MMI_TOUCH_SCREEN__)
        #if defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__)
            if (g_gx_vsmj_is_pen_down == MMI_TRUE)
            {
                gdi_image_draw_id(LCD_HEIGHT - MMI_GX_VSMJ_BACK_ICON_HEIGHT, 0, (U16) IMG_ID_GX_VSMJ_BACK_DOWN);
            }
            else
            {
                gdi_image_draw_id(LCD_HEIGHT - MMI_GX_VSMJ_BACK_ICON_HEIGHT, 0, (U16) IMG_ID_GX_VSMJ_BACK_UP);
            }
        #endif
        #endif
...
void mmi_gx_vsmj_render_table(void)
{
    ...
    /*----------------------------------------------------------------*/
	/* draw games */
    gdi_image_draw_id(MMI_GX_VSMJ_RECT_POS_X1, MMI_GX_VSMJ_RECT_POS_Y1 - 24, (U16)IMG_ID_GX_VSMJ_GAMES);
...
#if defined(__MMI_MAINLCD_240X320__) || defined(__MMI_MAINLCD_320X240__) || defined(__MMI_MAINLCD_240X400__)
    gdi_image_draw_id(
        MMI_GX_VSMJ_RECT_POS_X1 + 4, 
        MMI_GX_VSMJ_RECT_POS_Y1 - 24 + 8, 
        (U16) IMG_ID_GX_VSMJ_NUMBER_0 + (num_buffer / 10));
    gdi_image_draw_id(
        MMI_GX_VSMJ_RECT_POS_X1 + 16, 
        MMI_GX_VSMJ_RECT_POS_Y1 - 24 + 8, 
        (U16) IMG_ID_GX_VSMJ_NUMBER_0 + (num_buffer % 10));
#elif defined(__MMI_MAINLCD_320X480__)
    gdi_image_draw_id(
        MMI_GX_VSMJ_RECT_POS_X1 + 5, 
        MMI_GX_VSMJ_RECT_POS_Y1 - 24 + 10, 
        (U16) IMG_ID_GX_VSMJ_NUMBER_0 + (num_buffer / 10));
    gdi_image_draw_id(
        MMI_GX_VSMJ_RECT_POS_X1 + 20, 
        MMI_GX_VSMJ_RECT_POS_Y1 - 24 + 10, 
        (U16) IMG_ID_GX_VSMJ_NUMBER_0 + (num_buffer % 10));
#endif
    ...
    #elif defined(__MMI_MAINLCD_320X480__)
        gdi_image_draw_id(position_shift, 250, (U16) image_id);
        position_shift = position_shift - 12;
    #endif
    } while (num_buffer != 0);
    ...
    do
    {
        ...
        position_shift = position_shift - 9;
    #elif defined(__MMI_MAINLCD_320X480__)
        gdi_image_draw_id(position_shift, 35, (U16) image_id);
        position_shift = position_shift - 12;
    #endif
    } while (num_buffer != 0);
...
void mmi_gx_vsmj_render_user(gx_vsmj_user_struct *user_ptr)
{
    ...
    while (user_ptr->lock[i]->id != WALL_END)
    {
        switch (user_ptr->lock[i]->id)
        {
            ...
            case WALL_GUNSHOW:
                ...
                {
                    gdi_image_draw_id(draw_x, draw_y - BOTTOM_SOLID_HEIHT + 4, (U16) (IMG_ID_GX_VSMJ_BRICK_EAST + user_ptr->lock[i + 1]->id));
                    gdi_image_draw_id(draw_x, draw_y + USER_TILE_HEIGHT - BOTTOM_SOLID_HEIHT, IMG_ID_GX_VSMJ_BOTTOM_SOLID);
                    draw_x += tile_width;
                    gdi_image_draw_id(draw_x, draw_y + USER_TILE_HEIGHT - BOTTOM_SOLID_HEIHT, IMG_ID_GX_VSMJ_BOTTOM_SOLID);
                    gdi_image_draw_id(
                        draw_x,
                        draw_y - 2 * BOTTOM_SOLID_HEIHT + 4,
                        (U16) (IMG_ID_GX_VSMJ_BRICK_EAST + user_ptr->lock[i + 1]->id));
                    gdi_image_draw_id(draw_x, draw_y + USER_TILE_HEIGHT - 2 * BOTTOM_SOLID_HEIHT, IMG_ID_GX_VSMJ_BOTTOM_SOLID);
                    draw_x += tile_width;
                    gdi_image_draw_id(draw_x, draw_y - BOTTOM_SOLID_HEIHT + 4, (U16) (IMG_ID_GX_VSMJ_BRICK_EAST + user_ptr->lock[i + 1]->id));
                    gdi_image_draw_id(draw_x, draw_y + USER_TILE_HEIGHT - BOTTOM_SOLID_HEIHT, IMG_ID_GX_VSMJ_BOTTOM_SOLID);
                    draw_x += tile_width;
            ...
            case WALL_GUNHIDE:  /* 2ppl: user id 0,1 up / down need one image */
                ...
                if (game_move != MOVE_DECLARE_HOU)
                {
                    if (user_ptr->id == COM_1)
                    {
                        ...
                        draw_x += tile_width;
                        gdi_image_draw_id(draw_x, draw_y, IMG_ID_GX_VSMJ_BRICK_USER_UD_HIDE_BACK);
                        gdi_image_draw_id(draw_x, draw_y + 5, IMG_ID_GX_VSMJ_BRICK_USER_UD_HIDE_BACK);
                        draw_x += tile_width;
                        gdi_image_draw_id(draw_x, draw_y, IMG_ID_GX_VSMJ_BRICK_USER_UD_HIDE_BACK);
                        draw_x += tile_width;
                    ...
                    else
                    {
                        ...
                        gdi_image_draw_id(
                            draw_x,
                            draw_y - BOTTOM_SOLID_HEIHT - 2,
                            (U16) (IMG_ID_GX_VSMJ_BRICK_EAST + user_ptr->lock[i + 1]->id));
                        gdi_image_draw_id(draw_x, draw_y + USER_TILE_HEIGHT - BOTTOM_SOLID_HEIHT - 6, IMG_ID_GX_VSMJ_BOTTOM_SOLID);
                        draw_x += tile_width;
                        gdi_image_draw_id(draw_x, draw_y, IMG_ID_GX_VSMJ_BRICK_USER_UD_HIDE_BACK);
                        draw_x += tile_width;
                        i = i + 5;  /* pass the gun tile ,to the next wall */
            ...
            default:
                ...
                {
                    gdi_image_draw_id(draw_x, draw_y - BOTTOM_SOLID_HEIHT + 4, (U16) (IMG_ID_GX_VSMJ_BRICK_EAST + user_ptr->lock[i]->id));
                    gdi_image_draw_id(draw_x, draw_y + USER_TILE_HEIGHT - BOTTOM_SOLID_HEIHT, IMG_ID_GX_VSMJ_BOTTOM_SOLID);
                }
                draw_x += tile_width;
                i++;
    ...
    {
#if defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__)
        draw_x = USER_LOCK_POS_X[user_ptr->id] + 15 * tile_width + shift_x_count * shift_x;
#else
    ...
    if (game_move == MOVE_PICK_SPECIAL || game_move == MOVE_DISCARD_SPECIAL)
    {
        if (current_user->id == PLAYER_1)
        {
            ...
            if (EatCase > 0)
            {
                ...
                gdi_image_draw_id(PLAYER_SPECIAL_POS_X - USER_TILE_WIDTH, 
                ...
                shift_x = USER_TILE_WIDTH - (MMI_GX_VSMJ_EATCASE_BG_WIDTH - USER_TILE_WIDTH * 3) / 2;
                shift_y = (MMI_GX_VSMJ_EATCASE_HIGHLIGHT_HEIGHT - USER_TILE_HEIGHT) / 2;
                EatCase = 0;
                /* eat 0~2 */
                if (current_user->can_eat[0])
                {
                    ...
                    gdi_image_draw_id(
                        PLAYER_SPECIAL_POS_X - shift_x + USER_TILE_WIDTH,
                        PLAYER_SPECIAL_POS_Y + PLAYER_SPECIAL_UNIT_HEIGHT + ((EatCase - 1) * 6 + 1) * MMI_GX_VSMJ_EATCASE_BG_HEIGHT,
                        (U16) (IMG_ID_GX_VSMJ_BRICK_EAST + highlight->id - 1));
                    gdi_image_draw_id(
                        PLAYER_SPECIAL_POS_X - shift_x + USER_TILE_WIDTH * 2,
                        PLAYER_SPECIAL_POS_Y + PLAYER_SPECIAL_UNIT_HEIGHT + ((EatCase - 1) * 6 + 1) * MMI_GX_VSMJ_EATCASE_BG_HEIGHT,
                        (U16) (IMG_ID_GX_VSMJ_BRICK_EAST + highlight->id));
                    if (highlight_eatcase == HIGHLIGHT_EATCASE_0)
                    {
                        gdi_image_draw_id(PLAYER_SPECIAL_POS_X - shift_x - (MMI_GX_VSMJ_EATCASE_HIGHLIGHT_WIDTH - USER_TILE_WIDTH * 3) / 2,
                            PLAYER_SPECIAL_POS_Y + PLAYER_SPECIAL_UNIT_HEIGHT + ((EatCase - 1) * 6 + 1) * MMI_GX_VSMJ_EATCASE_BG_HEIGHT - shift_y,
            ...
            if (GunCase > 0)
            {
                ...
                gdi_image_draw_id(PLAYER_SPECIAL_POS_X + 2 * PLAYER_SPECIAL_UNIT_WIDTH - USER_TILE_WIDTH + 5, 
                    PLAYER_SPECIAL_POS_Y + PLAYER_SPECIAL_UNIT_HEIGHT, 
                ...
                shift_x = USER_TILE_WIDTH - (MMI_GX_VSMJ_GUNCASE_BG_WIDTH - USER_TILE_WIDTH * 4) / 2 - 5;
                shift_y = (MMI_GX_VSMJ_GUNCASE_HIGHLIGHT_HEIGHT - USER_TILE_HEIGHT) / 2;
                GunCase = 0;
                for (i = 0; i < 4; i++)
                {
                    if (current_user->can_bugun[i])
                    {
                        GunCase++;
                        gdi_image_draw_id(
                            PLAYER_SPECIAL_POS_X + 2 * PLAYER_SPECIAL_UNIT_WIDTH - shift_x,
                        ...
                        gdi_image_draw_id(
                            PLAYER_SPECIAL_POS_X + 2 * PLAYER_SPECIAL_UNIT_WIDTH - shift_x + USER_TILE_WIDTH,
                            PLAYER_SPECIAL_POS_Y + PLAYER_SPECIAL_UNIT_HEIGHT + ((GunCase - 1) * 6 + 1) * MMI_GX_VSMJ_GUNCASE_BG_HEIGHT,
                            (U16) (IMG_ID_GX_VSMJ_BRICK_EAST + current_user->bugun_id[i]));
                        gdi_image_draw_id(
                            PLAYER_SPECIAL_POS_X + 2 * PLAYER_SPECIAL_UNIT_WIDTH - shift_x + 2 * USER_TILE_WIDTH,
                            PLAYER_SPECIAL_POS_Y + PLAYER_SPECIAL_UNIT_HEIGHT + ((GunCase - 1) * 6 + 1) * MMI_GX_VSMJ_GUNCASE_BG_HEIGHT,
                            (U16) (IMG_ID_GX_VSMJ_BRICK_EAST + current_user->bugun_id[i]));
                        gdi_image_draw_id(
                            PLAYER_SPECIAL_POS_X + 2 * PLAYER_SPECIAL_UNIT_WIDTH - shift_x + 3 * USER_TILE_WIDTH,
                            PLAYER_SPECIAL_POS_Y + PLAYER_SPECIAL_UNIT_HEIGHT + ((GunCase - 1) * 6 + 1) * MMI_GX_VSMJ_GUNCASE_BG_HEIGHT,
                            (U16) (IMG_ID_GX_VSMJ_BRICK_EAST + current_user->bugun_id[i]));
                        if (highlight_guncase == HIGHLIGHT_GUNCASE_0 + i)
                        {
                            gdi_image_draw_id(PLAYER_SPECIAL_POS_X + 2 * PLAYER_SPECIAL_UNIT_WIDTH - shift_x - (MMI_GX_VSMJ_GUNCASE_HIGHLIGHT_WIDTH - USER_TILE_WIDTH * 4) / 2,
                                PLAYER_SPECIAL_POS_Y + PLAYER_SPECIAL_UNIT_HEIGHT + ((GunCase - 1) * 6 + 1) * MMI_GX_VSMJ_GUNCASE_BG_HEIGHT - shift_y,
...
void mmi_gx_vsmj_render_scorescreen(void)
{
    ...
    gdi_draw_solid_rect(0, 0, LCD_WIDTH, LCD_HEIGHT, GDI_COLOR_WHITE);
#elif defined(__MMI_MAINLCD_320X240__)
    gdi_draw_solid_rect(0, 0, LCD_HEIGHT, LCD_WIDTH, GDI_COLOR_WHITE);
#endif
    /*gdi_draw_frame_rect(
    ...
    #elif defined(__MMI_MAINLCD_240X400__) 
        draw_x = SCORE_POS_X + 60;
    #elif defined(__MMI_MAINLCD_320X480__)
        draw_x = SCORE_POS_X + 67;
    #endif
    }
    else
    {
...
void mmi_gx_vsmj_pen_down_hdlr(mmi_pen_point_struct pos)    /* all done */
{
    ...
    /*----------------------------------------------------------------*/
#if defined(__MMI_MAINLCD_240X400__) || defined(__MMI_MAINLCD_320X480__)
    if (pos.x >= LCD_WIDTH- MMI_GX_VSMJ_BACK_ICON_HEIGHT && 
        pos.y >= LCD_HEIGHT - MMI_GX_VSMJ_BACK_ICON_WIDTH)
    {
        g_gx_vsmj_is_pen_down = MMI_TRUE;
        mmi_gx_vsmj_render();
    }
    else
    {
    ...
    if (pen_pos == PP_PENNOTDOWN)
    {
        ...
        else if (pos.x > PLAYER_SPECIAL_POS_X - USER_TILE_WIDTH
            && pos.x < PLAYER_SPECIAL_POS_X + 2 * USER_TILE_WIDTH + (MMI_GX_VSMJ_EATCASE_BG_WIDTH - USER_TILE_WIDTH * 3) / 2 
        ...
        else if (pos.x > PLAYER_SPECIAL_POS_X + 2 * PLAYER_SPECIAL_UNIT_WIDTH - USER_TILE_WIDTH + 5
            && pos.x < PLAYER_SPECIAL_POS_X + 2 * PLAYER_SPECIAL_UNIT_WIDTH + 3 * USER_TILE_WIDTH + (MMI_GX_VSMJ_GUNCASE_BG_WIDTH - USER_TILE_WIDTH * 4) / 2 
            ...
            && pos.y < PLAYER_SPECIAL_POS_Y + PLAYER_SPECIAL_UNIT_HEIGHT + (4 * 6 + 1) * MMI_GX_VSMJ_GUNCASE_BG_HEIGHT)
        {
            ...
            for (i = 0; i < 4; i++)
            {
                if (current_user->can_bugun[i])
                {
                    GunPos[GunCase] = (gx_vsmj_pen_pos_enum)(PP_SPECIAL_BUGUN_0 + i);
                    GunCase++;
                }
            }           
            for (i = 0; i < 4; i++)
            {
                if (current_user->can_handgun[i])
                {
                    GunPos[GunCase] = (gx_vsmj_pen_pos_enum)(PP_SPECIAL_HANDGUN_0 + i);
                    GunCase++;
                }
            }
...
void mmi_gx_vsmj_framemove(void)
{
    ...
    case MOVE_DISCARD_CHECK_CONTINUE:
        ...
        else
        {
            ...
            {
                target_id = (gx_vsmj_user_id_enum)(last_user->id + 1);
            }
            else
            {
                target_id = (gx_vsmj_user_id_enum)0;
            }
...
void mmi_gx_vsmj_com_think_st_1(gx_vsmj_user_struct *user_ptr)
{
    ...
    S16 ting_num = -1;
    S16 temp_ting_num = 0;
    gx_vsmj_tile_id_enum todrop_tile_id = TE_EAST;
    gx_vsmj_tile_id_enum temp_id = TE_EAST;
    ...
    case MOVE_DISCARD_TILE:
        ...
        /* normal drop case */
        for (temp_id = 0; temp_id <= (NU_9T - TE_EAST); temp_id++)
        {
            mmi_gx_vsmj_reset_chk_all(user_ptr->hand);
        ...
        else    /* no one-way ting,start to count connection value */
        {
            ...
            /* normal drop case */
            for (temp_id = TE_EAST; temp_id <= (NU_9T - TE_EAST); temp_id++)
            {
                mmi_gx_vsmj_reset_chk_all(user_ptr->hand);
                mmi_gx_vsmj_reset_chk_all_stat_only(think_temp);
            ...
            case MOVE_DISCARD_SPECIAL:
                ...
                if (user_ptr->can_eat[0] == TRUE)
                {
                    ...
                    mmi_gx_vsmj_set_chk((gx_vsmj_tile_id_enum)(highlight->id - 2), CHK_NOTUSED, CHK_MISSION_OCCUPY, user_ptr->hand);
                    mmi_gx_vsmj_set_chk((gx_vsmj_tile_id_enum)(highlight->id - 1), CHK_NOTUSED, CHK_MISSION_OCCUPY, user_ptr->hand);
                    ...
                    mmi_gx_vsmj_set_chk((gx_vsmj_tile_id_enum)(highlight->id - 2), CHK_MISSION_OCCUPY, CHK_NOTUSED, user_ptr->hand);
                    mmi_gx_vsmj_set_chk((gx_vsmj_tile_id_enum)(highlight->id - 1), CHK_MISSION_OCCUPY, CHK_NOTUSED, user_ptr->hand);
...
BOOL mmi_gx_vsmj_hou_trial(gx_vsmj_tile_struct *tile_set_ptr[], BOOL pair_used)
{
    ...
    if (pair_used == FALSE)
        ...
        if (mmi_gx_vsmj_check_link(3, tile_set_ptr[i]->id, tile_set_ptr))
        {
            ...
            mmi_gx_vsmj_set_chk((gx_vsmj_tile_id_enum)(tile_set_ptr[i]->id + 1), CHK_NOTUSED, CHK_LINE_M, tile_set_ptr);
            mmi_gx_vsmj_set_chk((gx_vsmj_tile_id_enum)(tile_set_ptr[i]->id + 2), CHK_NOTUSED, CHK_LINE_R, tile_set_ptr);
            ...
            mmi_gx_vsmj_set_chk((gx_vsmj_tile_id_enum)(tile_set_ptr[i]->id + 1), CHK_LINE_M, CHK_NOTUSED, tile_set_ptr);
            mmi_gx_vsmj_set_chk((gx_vsmj_tile_id_enum)(tile_set_ptr[i]->id + 2), CHK_LINE_R, CHK_NOTUSED, tile_set_ptr);
        }
...
void mmi_gx_vsmj_check_connection(gx_vsmj_tile_struct *tile_set_ptr[], gx_vsmj_chk_status_enum *temp_ptr)
{
    ...
    if (mmi_gx_vsmj_check_link(2, tile_set_ptr[i]->id, tile_set_ptr))
    {
        ...
        mmi_gx_vsmj_set_chk((gx_vsmj_tile_id_enum)(tile_set_ptr[i]->id + 1), CHK_NOTUSED, CHK_INHLINE_R, tile_set_ptr);
        
        mmi_gx_vsmj_check_connection(tile_set_ptr, temp_ptr);
        
        mmi_gx_vsmj_set_chk(tile_set_ptr[i]->id, CHK_INHLINE_L, CHK_NOTUSED, tile_set_ptr);
        mmi_gx_vsmj_set_chk((gx_vsmj_tile_id_enum)(tile_set_ptr[i]->id + 1), CHK_INHLINE_R, CHK_NOTUSED, tile_set_ptr);
    }
    /* check halfinlink */
    ...
    if (mmi_gx_vsmj_set_chk(tile_set_ptr[i]->id, CHK_NOTUSED, CHK_NOTUSED, tile_set_ptr)        /* simply using set chk bool to know its existence */
        && mmi_gx_vsmj_set_chk((gx_vsmj_tile_id_enum)(tile_set_ptr[i]->id + 2), CHK_NOTUSED, CHK_NOTUSED, tile_set_ptr))
            ...
            if (tile_set_ptr[i]->id != NU_8W && tile_set_ptr[i]->id != NU_9W)
                if (tile_set_ptr[i]->id != NU_8S && tile_set_ptr[i]->id != NU_9S)
                    if (tile_set_ptr[i]->id != NU_8T && tile_set_ptr[i]->id != NU_9T)
                    {
                        ...
                        mmi_gx_vsmj_set_chk((gx_vsmj_tile_id_enum)(tile_set_ptr[i]->id + 2), CHK_NOTUSED, CHK_OUTHLINE_R, tile_set_ptr);
                        
                        mmi_gx_vsmj_check_connection(tile_set_ptr, temp_ptr);
                        
                        mmi_gx_vsmj_set_chk(tile_set_ptr[i]->id, CHK_OUTHLINE_L, CHK_NOTUSED, tile_set_ptr);
                        mmi_gx_vsmj_set_chk((gx_vsmj_tile_id_enum)(tile_set_ptr[i]->id + 2), CHK_OUTHLINE_R, CHK_NOTUSED, tile_set_ptr);
                    }
                    /* check outinlink */
...
void mmi_gx_vsmj_key_ok_pressed(void)
{
	...
	if (pen_pos == PP_PENNOTDOWN)
	{
		if (game_move == MOVE_PICK_SPECIAL || game_move == MOVE_DISCARD_SPECIAL)
		{
			if (highlight_special == HIGHLIGHT_EAT)
			{
				pen_pos = (gx_vsmj_pen_pos_enum)highlight_eatcase;
			}
			else if (highlight_special == HIGHLIGHT_GUN)
			{
				pen_pos = (gx_vsmj_pen_pos_enum)highlight_guncase;
			}
			else
			{
				pen_pos = (gx_vsmj_pen_pos_enum)highlight_special;
			}
			highlight_special = -1;
			highlight_eatcase = -1;
            highlight_guncase = -1;
...
void mmi_gx_vsmj_key_up_pressed(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    g_vsmj_is_up_key_pressed = MMI_TRUE;
}
...
void mmi_gx_vsmj_key_right_pressed(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    g_vsmj_is_right_key_pressed = MMI_TRUE;
}
...
void mmi_gx_vsmj_key_right_release(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if (g_vsmj_is_right_key_pressed)
    {
        if (game_move == MOVE_PICK_SPECIAL || game_move == MOVE_DISCARD_SPECIAL)
        {
...
/*****************************************************************************
 * FUNCTION
 *  mmi_gx_vsmj_key_4_release
 * DESCRIPTION
 *  to be used debug, set COM1's tile
 * PARAMETERS
 *  void
 * RETURNS
 *  void
...
void mmi_gx_vsmj_key_4_release(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    user[1].hand[1] = &wall_end;
    user[1].lock[0] = &wall_pon;
    user[1].lock[1] = &tile_table[112];
    user[1].lock[2] = &tile_table[112];
    user[1].lock[3] = &tile_table[112];
    user[1].lock[4] = &tile_empty;
    user[1].lock[5] = &wall_pon;
    user[1].lock[6] = &tile_table[112];
    user[1].lock[7] = &tile_table[112];
    user[1].lock[8] = &tile_table[112];
    user[1].lock[9] = &tile_empty;
    user[1].lock[10] = &wall_gunshow;
    user[1].lock[11] = &tile_table[112];
    user[1].lock[12] = &tile_table[112];
    user[1].lock[13] = &tile_table[112];
    user[1].lock[14] = &tile_table[112];
    user[1].lock[15] = &wall_gunhide;
    user[1].lock[16] = &tile_table[112];
    user[1].lock[17] = &tile_table[112];
    user[1].lock[18] = &tile_table[112];
    user[1].lock[19] = &tile_table[112];
    user[1].lock[20] = &wall_pon;
    user[1].lock[21] = &tile_table[112];
    user[1].lock[22] = &tile_table[112];
    user[1].lock[23] = &tile_table[112];
    user[1].lock[24] = &tile_empty; 
    user[1].lock[25] = &wall_end; 
}
#endif 
