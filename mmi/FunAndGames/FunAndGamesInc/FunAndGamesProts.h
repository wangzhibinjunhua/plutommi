...
#ifndef FUNANDGAMESPROTS_H
#define FUNANDGAMESPROTS_H

#include "MMIDataType.h"

extern void mmi_fng_init_app(void);
extern void mmi_fng_entry_screen(void);

#ifdef __MMI_PICTURE_EDITOR_SUPPORT__
extern void Highlight_MENU_PICTURE_EDITOR(void);
#endif 
