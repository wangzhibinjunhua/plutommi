...
extern void RngcInitCursor(void);
extern void RngcClearStave(void);
...
extern void RngcGotoSelectedCompToneOpt(U16 item);
...
extern void EntryRngcPlayStyle(void);
extern void SetCurrCompRingToneStyle(void);
extern U8 GetIndexCurrCompRingToneStyle(void);
#endif
...
extern MMI_BOOL EntryRngcComposerEngine(void);
extern void RngcExecAdd(void);
extern U16 mmi_rngc_get_menuId(void);

extern void mmi_rngc_sd_plug_out_hdlr(void);
extern mmi_ret mmi_rngcomposer_notify_hdlr(mmi_event_struct *event);
