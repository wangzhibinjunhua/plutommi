 ...
 * $Log$
 *
 * 10 28 2015 baohua.ye
 * [MAUI_03547453] [2503] Time sync for 2503
 * .
 *
 * 11 19 2014 yunliu.mao
 * [MAUI_03521805] build error for scr autolock
 * build error for poweronoffdisplay
 *
 * 04 22 2014 yunliu.mao
 * [MAUI_03493395] it highlight wrong option when press back
 * .240 320 shortcut show in setting
 *
 * 04 18 2014 yunliu.mao
 * [MAUI_03492592] [6261][Settings]should not show the shortcuts list by upkey in idle screen
 * when add app_manager ,shorucut should show on phonesetting
 *
...
<APP id = "APP_PHONESETTING_NEW">
    ...
    #endif
#ifndef __MMI_MAINLCD_96X64__
#if defined( __MMI_VUI_HOMESCREEN_VIDEO_WALLPAPER__) || defined (__MMI_LAUNCHER_APP_LIST_VIDEO_WALLPAPER__) ||defined (__MMI_SCREEN_SAVER__) || defined(__MMI_POWER_ON_OFF_DISPLAY__)
...
#endif
#endif
#if ((defined(__MMI_MAINLCD_240X320__) || defined(__MMI_APP_MANAGER_SUPPORT__) || (defined (__WIFI_WIZARD_SUPPORT__) && defined (__MMI_WLAN_FEATURES__))) && !defined(__DISABLE_SHORTCUTS_MENU__) && \
