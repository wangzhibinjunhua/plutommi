...
<APP id = "APP_RESTORE">
    ...
    <STRING id = "STR_ID_RESTORE_TITLE"/>      
 		...
 		<STRING id = "STR_ID_RESTORE_RESET"/> 
 		<STRING id = "STR_ID_RESTORE_CONFIRM"/>
 		<STRING id = "STR_ID_RESET_CONFIRM"/>    
 		<STRING id = "STR_ID_RESET_ICON_STRING"/>    
#endif
    ...
    <!-- menu ------------------------------------------------------------------------------------->
#ifdef __MMI_WEARABLE_DEVICE_SETTING__
    <MENU id = "MENU_SETTING_RESTORE" type = "APP_MAIN" str = "STR_ID_RESTORE_RESET" img = "IMG_SETTING_STORE" highlight = "HighlightRstScr">
#else
