...
#define __MMI_WALLPAPER_NUM__ 1
#else
#define __MMI_WALLPAPER_NUM__ 10
#endif
#endif
#endif
...
typedef enum
{
    IMG_ID_PHNSET_WP_START = APP_DISPLAY_RESOURCE_BASE,
    ...
    IMG_ID_PHNSET_WP_THUMB_START,
    IMG_ID_PHNSET_WP_THUMB_0 = IMG_ID_PHNSET_WP_THUMB_START,
    IMG_ID_PHNSET_WP_THUMB_MAX = IMG_ID_PHNSET_WP_THUMB_START + __MMI_WALLPAPER_NUM__ - 1,
#endif
    ...
    IMG_ID_PHNSET_ON_7,
    IMG_ID_PHNSET_ON_8,
    IMG_ID_PHNSET_ON_MAX = IMG_ID_PHNSET_ON_START + __MMI_WALLPAPER_NUM__, /* there is one additional image for power on display */

    IMG_ID_PHNSET_ON_VDO_START,
    ...
    IMG_ID_PHNSET_OFF_7,
    IMG_ID_PHNSET_OFF_8,
    IMG_ID_PHNSET_OFF_MAX = IMG_ID_PHNSET_OFF_START + __MMI_WALLPAPER_NUM__, /* there is one additional image for power off display */

    IMG_ID_PHNSET_OFF_VDO_START,
	...
	IMG_ID_VIDEO_WP_START,
	IMG_ID_VIDEO_WP_VDO_0 = IMG_ID_VIDEO_WP_START,
	IMG_ID_VIDEO_WP_MAX = IMG_ID_VIDEO_WP_VDO_0,
...
#define MAX_VIDEO_WALLPAPER		 (IMG_ID_VIDEO_WP_MAX - IMG_ID_VIDEO_WP_START + 1)
#else /* __MMI_VUI_HOMESCREEN_VIDEO_WALLPAPER__ */
#define MAX_VIDEO_WALLPAPER		0
#endif /* __MMI_VUI_HOMESCREEN_VIDEO_WALLPAPER__ */
