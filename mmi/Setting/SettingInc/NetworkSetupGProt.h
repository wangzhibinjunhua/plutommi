...
extern void mmi_netset_3g_nocell_start_timer(void);
extern void mmi_netset_3g_nocell_stop_timer(void);
extern void mmi_netset_rat_selection(void);
extern U8 mmi_netset_rat_idle_notify(void);
