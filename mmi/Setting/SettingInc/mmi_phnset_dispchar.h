...
typedef enum
{
    ...
    MMI_PHNSET_TYPE_APPICON,
#endif    
    MMI_PHNSET_TYPE_MAX
} phnset_wpss_type_enum;

typedef enum {
	PHNSET_WALLPAPER_STATIC_SYSTEM = 0,
	PHNSET_WALLPAPER_LIVE_SYSTEM,
	PHNSET_WALLPAPER_VIDEO_SYSTEM,
	PHNSET_WALLPAPER_IVLW_SYSTEM,
	PHNSET_WALLPAPER_STATIC_FILE,
	PHNSET_WALLPAPER_LIVE_FILE,
	PHNSET_WALLPAPER_VODEO_FILE,
}phnset_wallpaper_type_enum;

/*
 * Global Function                                                                    
 */
extern void mmi_dispchar_get_img_id(U16 nDataItemId, U16 *data);
extern void mmi_dispchar_set_img_id(U16 nDataItemId, U16 *data);
