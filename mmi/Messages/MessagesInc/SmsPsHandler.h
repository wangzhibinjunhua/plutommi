...
extern void mmi_msg_handle_new_sms_flag(void);
extern MMI_BOOL mmi_msg_need_change_new_sms_flag(void);
#ifdef __UNIFIED_MESSAGE_SIMBOX_SUPPORT__
extern MMI_BOOL mmi_msg_need_change_new_sim_sms_flag(void);
#endif /* __UNIFIED_MESSAGE_SIMBOX_SUPPORT__ */
