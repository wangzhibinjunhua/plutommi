...
********************************************/
extern void mmi_msg_set_msg_waiting_icon(srv_sms_sim_enum sim_id, U8 line, U8 ind_type, U8 set);
...
extern pBOOL mmi_msg_is_new_msg_popup_scr_active(void);
...
extern void mmi_msg_get_new_msg_ind_string(U16 msg_id, WCHAR *ucs2_buff);
...
extern void mmi_msg_get_email_and_subject_from_msgtxt(S8 *pText, U16 txtLen, S8 *pEmail,U16 emailLen, S8 *pSubject, U16 subLen, U16 *actual_email_ucs2_length, U16 *actual_sub_ucs2_length);
extern void mmi_msg_remove_email_address_from_msgtxt(EMSData *data, U16 len);
#endif /* __MMI_MESSAGES_SMS_EMAIL__ */


#ifdef __MMI_BPP20_SUPPORT__
extern void mmi_msg_bpp_pre_print_ems(MMI_ID gid);
extern void mmi_msg_bpp_app_mem_stop_callback(void);
