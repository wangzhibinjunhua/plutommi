 ...
 void mmi_sms_entry_main_message_menu(void)
{
	...
	{
		if(mmi_frm_group_is_present(GRP_ID_SMS_MAIN))
			mmi_frm_group_close(GRP_ID_SMS_MAIN); // check added for the reentry scenario
