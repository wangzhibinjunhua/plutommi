...
#define __MMI_WATCH_SUPPORT_TINY_CLOCK__
#endif
#endif

#define CLOCK_SUPPORT_SWITCH_IMG_BY_LANG

//#define __MMI_TINY_ENCODE_1BIT__
/***************************************************************************** 
 * Define
 *****************************************************************************/
...
#define MMI_IDLE_SWATCH_WIDTH       LCD_WIDTH  //(240)
#define MMI_IDLE_SWATCH_HEIGHT      LCD_HEIGHT //(240)


#if defined(__MMI_MAINLCD_240X240__) || defined(__MMI_MAINLCD_320X320__)
#define MMI_DOWNLOADABLE_CLOCK
...
#define MMI_IDLE_SWATCH_PREVIEW_OK_X_OFFSET             (108)
...
#define MMI_IDLE_SWATCH_PREVIEW_BG_X                    (28)
#define MMI_IDLE_SWATCH_PREVIEW_BG_Y                    (26)
#define MMI_IDLE_SWATCH_PREVIEW_BG_WIDTH                (200)  //185
#define MMI_IDLE_SWATCH_PREVIEW_BG_HEIGHT               (170)
#define MMI_IDLE_SWATCH_PREVIEW_ARROW_X_OFFSET          (7)
#define MMI_IDLE_SWATCH_PREVIEW_ARROW_Y_OFFSET          (75)  //97
#define MMI_IDLE_SWATCH_PREVIEW_ARROW_WIDTH             (16)
#define MMI_IDLE_SWATCH_PREVIEW_ARROW_HEIGHT            (30)
#define MMI_IDLE_SWATCH_PREVIEW_OK_X_OFFSET             (0)  //68
#define MMI_IDLE_SWATCH_PREVIEW_OK_Y_OFFSET             (180)
#define MMI_IDLE_SWATCH_PREVIEW_OK_WIDTH                (240)
#define MMI_IDLE_SWATCH_PREVIEW_OK_HEIGHT               (60)
#define MMI_IDLE_SWATCH_PREVIEW_OK_THRESHOLD            (0)  //set threshold for touch 10
#define MMI_IDLE_SWATCH_PREVIEW_CENTER_Y                (MMI_IDLE_SWATCH_PREVIEW_ARROW_Y_OFFSET+MMI_IDLE_SWATCH_PREVIEW_ARROW_HEIGHT/2)
#endif

#define MMI_IDLE_SWATCH_PEN_MOVE_ENTER_MAINMENU_THREADSHOLD (20)
...
#define MMI_IDLE_SWATCH_SETTING_MOVE_SWITCH_THRESHOLD    20 //(MMI_IDLE_SWATCH_SETTING_WIDTH_IN_MOVE/3)

#define MMI_IDLE_SWATCH_SETTING_FREE_RUN_DELAY           (0)
#define MMI_IDLE_SWATCH_SETTING_FREE_RUN_SPEED           (60)
...
typedef struct {
    ...
    FuncPtr callback_func;  /* timer_expiry_func */
    MMI_BOOL is_valid;
} mmi_idle_swatch_timer;
...
typedef struct
{
    ...
    MMI_ID bg_img_id;
#ifdef __MMI_WATCH_SUPPORT_TINY_CLOCK__
    MMI_ID tiny_bg_img_id;
#endif
    MMI_ID hour_hand_img_id;   
#ifdef __MMI_WATCH_SUPPORT_TINY_CLOCK__
    MMI_ID tiny_hour_hand_img_id;
#endif
    MMI_ID minute_hand_img_id;
#ifdef __MMI_WATCH_SUPPORT_TINY_CLOCK__
    MMI_ID tiny_minute_hand_img_id;
#endif
    MMI_ID second_hand_img_id;
#ifdef __MMI_WATCH_SUPPORT_TINY_CLOCK__
    MMI_ID tiny_second_hand_img_id;
#endif
    MMI_ID nail_img_id;
#ifdef __MMI_WATCH_SUPPORT_TINY_CLOCK__
    MMI_ID tiny_nail_img_id;
#endif
...
typedef struct
{
    ...
    MMI_ID tiny_bg_img_id;
    #endif
    MMI_ID hour_num_0_img_id;
    #ifdef __MMI_WATCH_SUPPORT_TINY_CLOCK__
    MMI_ID tiny_hour_num_0_img_id;
    #endif
    MMI_ID minute_num_0_img_id; 
    #ifdef __MMI_WATCH_SUPPORT_TINY_CLOCK__
    MMI_ID tiny_minute_num_0_img_id;
    #endif
    MMI_ID am_img_id; 
    #ifdef __MMI_WATCH_SUPPORT_TINY_CLOCK__
    MMI_ID tiny_am_img_id;
    #endif
    MMI_ID pm_img_id;
    #ifdef __MMI_WATCH_SUPPORT_TINY_CLOCK__
    MMI_ID tiny_pm_img_id;
    #endif
...
typedef struct
{
	...
	#ifdef MMI_DOWNLOADABLE_CLOCK
	mmi_idle_image_info_struct image_info;
	#endif
...
{
    char str[20];
}mmi_idle_swatch_download_img_struct;
#endif
...
typedef struct 
{
    ...
    U8     aLangSSC[10];
}mmi_swatch_language_mapping_table_struct;

typedef enum
{
    MMI_SWATCH_LANGUAGEEN= 0,
    MMI_SWATCH_LANGUAGECH,
    MMI_SWATCH_LANGUAGECHTR,
...
typedef struct
{
	...
	S32 x2;
	S32 y2;
}mmi_idle_watch_rect_struct;

typedef struct
{
    S32 x;
    S32 y;
}mmi_idle_watch_position;
