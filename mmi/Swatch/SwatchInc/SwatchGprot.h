...
extern void mmi_idle_swatch_setting(MMI_ID parent_id);
...
extern mmi_ret mmi_idle_swatch_enter_proc(mmi_event_struct * evt);

extern void mmi_idle_swatch_pedometer_resgiter_callback(mmi_idle_swatch_pedometer_cb cb);
extern void mmi_idle_swatch_base_timer_expire_process(void *basetimer);
extern MMI_BOOL mmi_idle_swatch_is_base_timer(void *basetimer);
