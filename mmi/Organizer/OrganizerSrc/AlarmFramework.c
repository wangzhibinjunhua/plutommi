...
#if 0
#if defined(__MMI_ALM_FM_RADIO_SUPPORT__)
/* under construction !*/
/* under construction !*/
/* under construction !*/
#endif /* defined(__MMI_ALM_FM_RADIO_SUPPORT__) */ 
#endif
 ...
 * Local Function
 */
static MMI_BOOL AlmIsExpireAllowed(void);
static MMI_BOOL AlmIsPowerOffMode(void);
...
extern void DateTimerIndication(void *);

#ifdef __DM_LAWMO_SUPPORT__
static U8 mmi_alm_is_dm_lock(void);
#endif
#endif
...
void PendingAlarmReminder(void)
{
	...
	MMI_FRM_INIT_EVENT(&evt, EVT_ID_SRV_REMINDER_BOOTUP_COMPLETE);
...
{
	return (srv_reminder_is_expiring() ? 1 : 0);
}
...
MMI_BOOL mmi_alm_is_in_alarm(void)
{
	...
	if (mmi_frm_scrn_is_present(GRP_ID_ROOT, SCR_ID_ALM_PWRON_CONFIRM, MMI_FRM_NODE_ALL_FLAG))
	{
		return MMI_TRUE;
	}
...
void mmi_setting_restore_almfrm_data(void)
{
...
{
	// please use srv_reminder_set 
}

void AlmCancelAlarm(U8 index)
{
	// please use srv_reminder_cancel
}
...
void AlmEnableExpiryHandler_Ext(CHAR* file, U32 line)
{
	srv_reminder_enable(SRV_REMINDER_TYPE_TOTAL, MMI_TRUE);
}
void AlmDisableExpiryHandler_Ext(CHAR* file, U32 line)
{
	srv_reminder_enable(SRV_REMINDER_TYPE_TOTAL, MMI_FALSE);
}
void AlmEnableSPOF_Ext(CHAR* file, U32 line)
{
	srv_reminder_enable(SRV_REMINDER_TYPE_SPOF, MMI_TRUE);
}
void AlmDisableSPOF_Ext(CHAR* file, U32 line)
{
...
void AlmATPowerReset(U8 power_off, U8 time)
{
	...
	{
		rboot_time = ALM_FACTORY_RTC_TIME;
	}
...
{
	mmi_factory_alm_set(sec);
}
#ifndef __MMI_DEV_NEW_SLIM__ 

void mmi_alm_enable_pwroff_ext(CHAR* file, U32 line)
{
}
void mmi_alm_disable_pwroff_ext(CHAR* file, U32 line)
{
}

void AlmGetStringValue(CHAR *StringVal, U8 Val){}
...
void mmi_alm_check_next(void)
{}
void mmi_almfrm_notify_finish(U8 stop){}
#endif
