...
#include "AlarmSlim.h"
#if defined(__MMI_BLE_TIP_SUPPORT__) && defined(__MMI_WEARABLE_DEVICE_ALARM__)
...
>
    ...
    <TIMER id="ALARM_TIMER_WAIT_FOR_CALL"/>
		...
		<TIMER id="ALARM_TIMER_WAIT_FOR_STOP_TRIANGLE"/>
		<TIMER id="ALARM_TIMER_WAIT_FOR_SNOOZE_TRIANGLE"/>
		<TIMER id="ALARM_TIMER_BOOTUP_CANCEL_INVALID_ALM"/>
#endif
...
#ifdef __MMI_WEARABLE_DEVICE_ALARM__
		<STRING id="STR_ID_ALM_DELETE_CONFIRM"/>
		<STRING id="STR_ID_ALM_REPEAT_SET_ON"/>
		<STRING id="STR_ID_ALM_ADD_NEW_ALARM1"/>
		<STRING id="STR_ID_ALM_ADD_NEW_ALARM2"/>
		<STRING id="STR_ID_ALM_STOP_ALARM"/>
		<STRING id="STR_ID_ALM_SNOOZE_ALARM"/>
		<STRING id="STR_ID_ALM_SYNC_ALARM_1"/>
		<STRING id="STR_ID_ALM_SYNC_ALARM_2"/>
		<STRING id="STR_ID_ALM_SYNC_ALARM_3"/>
	#ifdef __ASTER_NEW_STYLE_CHANGE_FOR_ALARM__
		<STRING id="STR_ID_ALM_ADD_NEW_ALARM"/>
	#endif/*__ASTER_NEW_STYLE_CHANGE_FOR_ALARM__*/
#endif
...
#endif
#ifdef __MMI_WEARABLE_DEVICE_ALARM__
		<IMAGE id="IMG_ALM_ADD">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_add.png"</IMAGE>
	#ifdef __ASTER_NEW_STYLE_CHANGE_FOR_ALARM__
	  <IMAGE id="IMG_ALM_ADD_P">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_add_p.png"</IMAGE>
	#endif/*__ASTER_NEW_STYLE_CHANGE_FOR_ALARM__*/
		<IMAGE id="IMG_ALM_OFF">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_off.png"</IMAGE>
		<IMAGE id="IMG_ALM_ON">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_on.png"</IMAGE>
		<IMAGE id="IMG_ALM_TIME0">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_over_time0.png"</IMAGE>
		<IMAGE id="IMG_ALM_TIME1">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_over_time1.png"</IMAGE>
		<IMAGE id="IMG_ALM_TIME2">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_over_time2.png"</IMAGE>
		<IMAGE id="IMG_ALM_TIME3">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_over_time3.png"</IMAGE>
		<IMAGE id="IMG_ALM_TIME4">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_over_time4.png"</IMAGE>
		<IMAGE id="IMG_ALM_TIME5">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_over_time5.png"</IMAGE>
		<IMAGE id="IMG_ALM_TIME6">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_over_time6.png"</IMAGE>
		<IMAGE id="IMG_ALM_TIME7">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_over_time7.png"</IMAGE>
		<IMAGE id="IMG_ALM_TIME8">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_over_time8.png"</IMAGE>
		<IMAGE id="IMG_ALM_TIME9">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_over_time9.png"</IMAGE>
		<IMAGE id="IMG_ALM_TIMECOLON">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_over_timecolon.png"</IMAGE>
		<IMAGE id="IMG_ALM_DOWN">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_down.png"</IMAGE>
		<IMAGE id="IMG_ALM_UP">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\alarm_up.png"</IMAGE>
		<IMAGE id="IMG_ALM_STOP_NORMAL">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\slide_dismiss_normal.png"</IMAGE>
		<IMAGE id="IMG_ALM_STOP_PRESSED">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\slide_dismiss_pressed.png"</IMAGE>
		<IMAGE id="IMG_ALM_SNOOZE_NORMAL">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\slide_snooze_normal.png"</IMAGE>
		<IMAGE id="IMG_ALM_SNOOZE_PRESSED">CUST_IMG_PATH"\\\\MainLCD\\\\Alarm\\\\slide_snooze_pressed.png"</IMAGE>
		<IMAGE id="IMG_ALM_ARROW_SNOOZE1">CUST_IMG_PATH"\\\\MainLCD\\\\call\\\\incoming\\\\arrow_left01.png"</IMAGE>
		<IMAGE id="IMG_ALM_ARROW_SNOOZE2">CUST_IMG_PATH"\\\\MainLCD\\\\call\\\\incoming\\\\arrow_left02.png"</IMAGE>
		<IMAGE id="IMG_ALM_ARROW_SNOOZE3">CUST_IMG_PATH"\\\\MainLCD\\\\call\\\\incoming\\\\arrow_left03.png"</IMAGE>
		<IMAGE id="IMG_ALM_ARROW_SNOOZE4">CUST_IMG_PATH"\\\\MainLCD\\\\call\\\\incoming\\\\arrow_left04.png"</IMAGE>
		<IMAGE id="IMG_ALM_ARROW_SNOOZE5">CUST_IMG_PATH"\\\\MainLCD\\\\call\\\\incoming\\\\arrow_left05.png"</IMAGE>
		<IMAGE id="IMG_ALM_ARROW_STOP1">CUST_IMG_PATH"\\\\MainLCD\\\\call\\\\incoming\\\\arrow_right01.png"</IMAGE>
		<IMAGE id="IMG_ALM_ARROW_STOP2">CUST_IMG_PATH"\\\\MainLCD\\\\call\\\\incoming\\\\arrow_right02.png"</IMAGE>
		<IMAGE id="IMG_ALM_ARROW_STOP3">CUST_IMG_PATH"\\\\MainLCD\\\\call\\\\incoming\\\\arrow_right03.png"</IMAGE>
		<IMAGE id="IMG_ALM_ARROW_STOP4">CUST_IMG_PATH"\\\\MainLCD\\\\call\\\\incoming\\\\arrow_right04.png"</IMAGE>
		<IMAGE id="IMG_ALM_ARROW_STOP5">CUST_IMG_PATH"\\\\MainLCD\\\\call\\\\incoming\\\\arrow_right05.png"</IMAGE>
...
#ifdef __MMI_WEARABLE_DEVICE_ALARM__
#ifdef __MMI_ALM_ALERT_TYPE__
	<MENU id="MENU_ID_ALM_ALERT_TYPE_MAIN" type="APP_SUB" str="STR_ID_PROF_ALERT_TYPE">
		 		//<MENUITEM id="MENU_ID_ALM_ALERT_TYPE_VIBRING" str="STR_ID_PROF_VIB_AND_RING"></MENUITEM>
		 		<MENUITEM id="MENU_ID_ALM_ALERT_TYPE_RING" str="STR_ID_PROF_RING_ONLY"></MENUITEM>
		 		<MENUITEM id="MENU_ID_ALM_ALERT_TYPE_VIB" str="STR_ID_PROF_VIB_ONLY"></MENUITEM>
		 		<MENUITEM id="MENU_ID_ALM_ALERT_TYPE_VIBRING" str="STR_ID_PROF_VIB_AND_RING"></MENUITEM>
		</MENU>
#endif
#endif
...
#if defined(__MMI_BLE_TIP_SUPPORT__) && defined(__MMI_WEARABLE_DEVICE_ALARM__)
    <RECEIVER id="EVT_ID_GATT_UPDATE_TF" proc="mmi_alm_handle_time_format_update"/>
#endif
</APP>
