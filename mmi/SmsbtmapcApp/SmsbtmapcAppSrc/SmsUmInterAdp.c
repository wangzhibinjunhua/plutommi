...
mmi_sms_bt_cntx_struct g_sms_bt_ui_cntx;
mmi_sms_bt_cntx_struct *g_sms_bt_ui_p = &g_sms_bt_ui_cntx;
...
mmi_ret mmi_sms_um_bt_deinit_grp_cntx_on_shift(void)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
        ...
        (!g_sms_bt_ui_p->is_on_request))
    {
        ...
        {
            if (box_type == SRV_UM_MSG_BTMAPC_BOX_UNSENT)
            {
