...
extern void MakeMyCall(PS8 strNumber,U8 call_type);
#ifdef __MMI_USSD_REPLY_UCS2__
extern void MakeReplyUSSRCall(PS8 strNumber,U8 call_type);
#endif /*__MMI_USSD_REPLY_UCS2__*/
extern MMI_BOOL mmi_gsm_is_in_ss_session(void);
extern void CheckShortCutOrCall(U8 call_type);
...
extern void PsCBackSetCallFeatures(void *info, int mod_src);
