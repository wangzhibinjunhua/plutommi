...
#define MMI_IDLE_MAX_ICON_SHORTCUT          5

#ifdef __OP12__
/* For delayed RSK handler. Please refer to mmi_idle_set_delayed_rsk. */
#define MMI_IDLE_DELAYED_RSK_TOV            500     /* 500 msec */
#endif /* __OP12__ */
...
/* 
 * Cell information context structure:
 */
 
#define MAX_CELL_INFO_STR_LEN   (25)

typedef struct
{
    MMI_BOOL is_valid;
    S8       text[MAX_CELL_INFO_STR_LEN * ENCODING_LENGTH];
} mmi_nw_cell_info_struct;
