...
/* TODO: Remove this adaptation. */
#define IDLE_SCREEN_ID      GRP_ID_IDLE_MAIN


/* Screen IDs */
typedef enum
{
    IDLE_SCREEN_ID_DUMMY = IDLE_APP_BASE + 1, 
...
typedef enum
{
    STR_IDLE_DUMMY_SCREEN = IDLE_APP_BASE + 1, 
    STR_ID_IDLE_END
} IDLE_STR_ID_ENUM;
...
typedef enum
{
    IMG_ID_IDLE_BEGIN = IDLE_APP_BASE + 1,
    IMG_ID_IDLE_END
} IDLE_IMG_ID_ENUM;
