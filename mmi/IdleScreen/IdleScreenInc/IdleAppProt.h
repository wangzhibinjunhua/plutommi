...
extern void mmi_idle_dial_pad_clear_star_key_long_press_hdlr(void);
#endif

extern void mmi_idle_set_digit_key_handler(void);
extern void mmi_idle_dialer_handle_send_key(void);
extern void mmi_idle_dialer_handle_center_key(void);
extern void mmi_idle_entry_dialer(void);
...
extern void mmi_idle_generic_keypad_lock_key_hdlr(void);
...
extern void mmi_idle_notify_dual_sim_status_to_spa_from_sim1(void);
extern void mmi_idle_notify_dual_sim_status_to_spa_from_sim2(void);
extern void mmi_idle_notify_dual_sim_status_to_spa_from_switch(void);
...
#endif
extern void mmi_idle_entry_main_menu(void);
extern void mmi_idle_remove_dialer_screen_exit_handler(void);

extern void mmi_idle_key_event_backlight_check(void);
extern void mmi_idle_key_event_keypad_lock_check(mmi_frm_key_evt_struct *key_evt);
...
extern void mmi_idle_highlight_dial_pad_option_exit(void);
...
extern void mmi_idle_highlight_dial_pad_option_dialer_search(void);
extern void mmi_idle_hint_dial_pad_option_dialer_search(U16 index);
...
extern void mmi_idle_flight_mode_dialpad_call(void);

#ifdef __MMI_QWERTY_KEYPAD_SUPPORT__
extern MMI_BOOL mmi_idle_dial_pad_qwerty_key_handler(
                    S16 mmi_key_code, 
                    S16 mmi_key_type, 
                    U16 ucs2_value, 
...
extern void mmi_idle_dial_pad_set_disable_long_press_handler(void);
