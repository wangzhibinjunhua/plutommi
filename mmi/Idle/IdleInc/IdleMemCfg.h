 ...
 */
    ...
    #define MMI_IDLE_SWATCH_STATUS_BAR_BUFFER_SIZE 0
    #define MMI_IDLE_SWATCH_UPDATE_LAYER_BUFFER_SIZE 0
	#define MMI_IDLE_SWATCH_TEMP_LAYER_BUFFER_SIZE 0
	#else
    #define MMI_IDLE_SWATCH_STATUS_BAR_BUFFER_SIZE ((LCD_WIDTH*MMI_STATUS_ICON_BAR_HEIGHT*GDI_MAINLCD_BIT_PER_PIXEL*2)>>3)  //19200
    /* Update layer */
    #define MMI_IDLE_SWATCH_UPDATE_LAYER_BUFFER_SIZE ((LCD_WIDTH*LCD_HEIGHT*GDI_MAINLCD_BIT_PER_PIXEL*2)>>3)  //230400

    #define MMI_IDLE_SWATCH_CLOCK_POINT_MAX_WIDTH (40)
    #define MMI_IDLE_SWATCH_CLOCK_POINT_MAX_HEIGHT (240)
