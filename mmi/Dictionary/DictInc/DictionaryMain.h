...
typedef enum
{
    GRP_ID_DICT_WELCOME = DICTIONARY_BASE + 1,
    GRP_ID_DICT_MAIN
} MMI_DICTIONARY_GROUP_ID_ENUM;
...
extern MMI_BOOL mmi_dictionary_entry_search(void);
...
extern MMI_DICTIONARY_LANGUAGE mmi_dictionary_check_input_family_bymode(U16 inputmode);
