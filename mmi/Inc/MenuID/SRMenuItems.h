 ...
 *******************************************************************************/
    ...
    MENU_ID_SNDREC_DELETE_ANIMATION,
    MENU_ID_SNDREC_FORWARD_USE,
    MENU_ID_SNDREC_FORWARD_SEND,
//#ifdef __MMI_OP12_SNDREC_STYLE__    
    MENU_ID_SNDREC_SAVE_OPTION,
    MENU_ID_SNDREC_SAVE_OPTION_DISCARD,
    MENU_ID_SNDREC_SAVE_OPTION_PLAY,
    MENU_ID_SNDREC_SAVE_OPTION_SAVE,
    MENU_ID_SNDREC_SAVE_OPTION_SEND,
    MENU_ID_SNDREC_SAVE_OPTION_RENAME_OPTION,
    MENU_ID_SNDREC_SAVE_OPTION_RENAME_SAVE,
