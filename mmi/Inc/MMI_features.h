...
#if (defined(__MMI_VIRTUAL_KEYBOARD__) && defined(__MMI_FTE_SUPPORT__) && !defined(__MMI_UI_VIRTUAL_KEYBOARD_DEFAULT_VERSION_3__))
...
#if (defined(__MMI_BT_DIALER_SUPPORT__) && defined(__MMI_BT_SUPPORT__) && defined(__BT_DIALER_SUPPORT__) && (defined(__BT_MAP_CLIENT__) || defined(__MMI_BT_MAPC_BY_SPP__)))
...
#if ((!defined(__MMI_SLIM_FILE_MANAGER__)) && (!defined(__MMI_TAB_BARS_SUPPORT__)))
	#error "Dependence conflict, if undef __MMI_SLIM_FILE_MANAGER__, please turn on __MMI_TAB_BARS_SUPPORT__"
#endif
...
#define __MMI_UI_CATEGORY_DIAL_TYPE_SEL__	DIAL_TYPE_DEFAULT
	...
	(defined(DAF_DECODE) && !defined(MED_V_NOT_PRESENT) && defined(__MMI_FILE_MANAGER__) && !defined(__MMI_MEDIA_PLAYER__) &&    defined(__PLUTO_MMI_PACKAGE__))
...
#if ((!defined(__COSMOS_MMI_PACKAGE__) && defined(JPG_DECODE) && (defined(CAMERA_MODULE) || defined(ISP_SUPPORT)) && defined(__MMI_FILE_MANAGER__)))
...
#if ((defined(MP4_ENCODE) || defined(MJPG_ENCODE)) && (defined(ISP_SUPPORT) || defined(__DIRECT_SENSOR_SUPPORT__)) && !defined(__COSMOS_MMI_PACKAGE__))
...
#if (!defined(__32_32_SEG__) && !defined(__64_64_SEG__))
...
#if defined(CFG_MMI_EM_MISC_AUTO_ANSWER) && ((CFG_MMI_EM_MISC_AUTO_ANSWER == __ON__)||(CFG_MMI_EM_MISC_AUTO_ANSWER == __AUTO__)) && \
	(defined(__MMI_ENGINEER_MODE__))
	#ifndef __MMI_EM_MISC_AUTO_ANSWER__
	#define __MMI_EM_MISC_AUTO_ANSWER__
	#endif
#endif
...
/* under construction !*/
	...
	(defined(__MMI_BTD_BOX_UI_STYLE__) && defined(__LINE_IN_SUPPORT__))
