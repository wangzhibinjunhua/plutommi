...
#if 1//def __MMI_SLEEP_MONITOR_FUNCTION__   //luwl
    SLEEP_TIMER_CONTROL,
#endif
#ifdef __HC_S6100__
    CWH_TEST_TIMER,
    HC_GPS_OPEN_TIMER,
    HC_GPS_LOCATING_TIMER,
    HC_FIND_TONE_STOP_TIMER,
    HC_SOC_LINK_KEEP_TIMER,
    HC_SOC_LK_TIMEOUT,
    HC_SOC_UD_TIMER,
    HC_SOC_AL_TIMEOUT,
    
    HC_SOS_CALL_REQ_TIMER,
    HC_CREATE_CLIENT_TIMER,
    HC_CREATE_EPO_CLIENT_TIMER,
    HC_CLIENT_CONNECT_TIMER,
    HC_PHOTO_UPLOAD_TIMER,
    HC_SNDREC_TIMER,
    HC_TKQ_TIMER,
    HC_TK_DL_TIMEOUT_TIMER,
    HC_TK_UD_TIMEOUT_TIMER,
    HC_BAT_CHECK_TIMER,
    HC_NW_CHECK_TIMER,
    HC_LED_R_BLINK_TIMER,
    HC_LED_G_BLINK_TIMER,
    HC_LED_B_BLINK_TIMER,
    HC_UD2_TIMER,
    HC_EPO_REQ_TIMER,
    HC_SAVE_PLMN_TIMER,
    HC_PLMN_AVALIABLE_TIMER,
#endif
