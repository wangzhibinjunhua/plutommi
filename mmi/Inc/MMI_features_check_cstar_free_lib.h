 ...
 * Description:
 * ------------
 *  check that only SC tc vetnamese and english are enabled on s build with cstar free lib
 *
 * Author:
 * -------
 * -------
