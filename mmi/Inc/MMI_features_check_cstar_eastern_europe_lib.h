 ...
 * Description:
 * ------------
 *  Disabling all the languages(except English) supported in the MMI 
 *  in an easy and convenient manner, so that the complexity of configuration 
 *  and validation of feature file requests for enabling and disabling the 
...
#undef	CFG_MMI_LANG_SA_PORTUGUESE	
#define	CFG_MMI_LANG_SA_PORTUGUESE	  (__OFF__)

#undef	CFG_MMI_LANG_BENGALI	
...
#undef	CFG_MMI_LANG_HINDI	
#define	CFG_MMI_LANG_HINDI	  (__OFF__)



#undef	CFG_MMI_LANG_INDONESIAN	
#define	CFG_MMI_LANG_INDONESIAN	  (__OFF__)

#undef	CFG_MMI_LANG_ITALIAN	
...
#undef	CFG_MMI_LANG_MALAY	
#define	CFG_MMI_LANG_MALAY	  (__OFF__)

#undef	CFG_MMI_LANG_MALAYALAM	
...
#undef	CFG_MMI_LANG_SM_CHINESE	
#define	CFG_MMI_LANG_SM_CHINESE	  (__OFF__)

#undef	CFG_MMI_LANG_SPANISH	
