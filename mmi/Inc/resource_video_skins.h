...
typedef enum
{
	...
	MMI_VDOPLY_BTN_NEXT,
	MMI_VDOPLY_BTN_FULL,
	MMI_VDOPLY_BTN_TOTAL
}mmi_vdoply_pannel_icon_enum;
...
typedef struct {
            ...
            video_pos_struct button_bg;
        #endif
	video_pos_ex_struct button[MMI_VDOPLY_BTN_TOTAL];	
	video_pos_struct volume;
        #ifdef __VDOPLY_FEATURE_FTE20__
             video_pos_struct speaker;
        #endif
        video_pos_struct mode;
	video_pos_struct play_time;
	video_pos_struct duration;
	video_rect_struct progress_empty;
	video_rect_struct progress_fill;
...
typedef struct {
	...
	video_pos_struct	play;	
	video_pos_struct	stop;	
#endif
} video_osd_vodply_panel_struct;
...
typedef struct {
	BOOL				is_show;
    video_icon_struct	video_size;
    video_icon_struct	video_qty;
	video_icon_struct	night;
    video_icon_struct	wb;
...
typedef struct
{
    video_rect_struct region_0;
	video_rect_struct region_1;
    video_rect_struct region_2;
    video_rect_struct region_3;
} vdorec_osd_layer_region_struct;

typedef struct {
    vdorec_osd_layer_region_struct  osd_layer_region;
