...
#if !defined(__MMI_BASIC_UI_STYLE__) || defined(__MMI_PROF_SLIM_PROFILES__)
...
<STRING id="STR_ID_PROF_QUESTION_MARK"/>
    ...
    <STRING id="STR_ID_PROF_SOUND_SETTING"/>
    <STRING id="STR_ID_PROF_VOLUME_SETTING"/>

    <STRING id="STR_ID_PROF_ALERT_TYPE"/>
    <STRING id="STR_ID_PROF_RING_TONE"/>
    <STRING id="STR_ID_PROF_NOTIFICATION_TONE"/>

    <STRING id="STR_ID_PROF_MEDIA_VOL"/>
    <STRING id="STR_ID_PROF_RINGTONE_VOL"/>
    <STRING id="STR_ID_PROF_NOTIFICATION_VOL"/>
    ...
    <MENUITEM id="MENU_ID_PROF_VIB_AND_RING" str="STR_ID_PROF_VIB_AND_RING"/>
    <MENUITEM id="MENU_ID_PROF_VIB_THEN_RING" str="STR_ID_PROF_VIB_THEN_RING"/>
    <MENUITEM id="MENU_ID_PROF_SILENT" str="STR_GLOBAL_MUTE"/>
    ...
    /* Launcher menu items */
    <MENU id="MAIN_MENU_PROF_SOUND_SETTING" type="APP_MAIN" str="STR_ID_PROF_SOUND_SETTING" highlight="mmi_profiles_highlight_sound_settings" >
    </MENU>

    <MENU id="MAIN_MENU_PROF_VOLUME_SETTING" type="APP_MAIN" str="STR_ID_PROF_VOLUME_SETTING" highlight="mmi_profiles_highlight_volume_settings" >
    </MENU>

    /* Sound setting */
    <MENUITEM id="MENU_ID_PROF_SNDSET_ALERT_TYPE" str="STR_ID_PROF_ALERT_TYPE"/>
    <MENUITEM id="MENU_ID_PROF_SNDSET_RING_TONE" str="STR_ID_PROF_RING_TONE"/>
    <MENUITEM id="MENU_ID_PROF_SNDSET_MSG_TONE" str="STR_ID_PROF_NOTIFICATION_TONE"/>

    <MENU id = "MENU_ID_PROF_SOUND_SETTING" type = "APP_SUB" str = "STR_ID_PROF_SOUND_SETTING">
        <MENUITEM_ID>MENU_ID_PROF_SNDSET_ALERT_TYPE</MENUITEM_ID>
        <MENUITEM_ID>MENU_ID_PROF_SNDSET_RING_TONE</MENUITEM_ID>
        <MENUITEM_ID>MENU_ID_PROF_SNDSET_MSG_TONE</MENUITEM_ID>
    </MENU>

    /* Volume setting */
    <MENUITEM id="MENU_ID_PROF_VOLSET_MEDIA_VOL" str="STR_ID_PROF_MEDIA_VOL"/>
    <MENUITEM id="MENU_ID_PROF_VOLSET_RING_VOL" str="STR_ID_PROF_RINGTONE_VOL"/>
    <MENUITEM id="MENU_ID_PROF_VOLSET_MSG_VOL" str="STR_ID_PROF_NOTIFICATION_VOL"/>

    <MENU id = "MENU_ID_PROF_VOLUME_SETTING" type = "APP_SUB" str = "STR_ID_PROF_VOLUME_SETTING">
        <MENUITEM_ID>MENU_ID_PROF_VOLSET_MEDIA_VOL</MENUITEM_ID>
        <MENUITEM_ID>MENU_ID_PROF_VOLSET_RING_VOL</MENUITEM_ID>
        <MENUITEM_ID>MENU_ID_PROF_VOLSET_MSG_VOL</MENUITEM_ID>
    </MENU>
    ...
    <SCREEN id="SCR_ID_PROF_SETTING"/>
#endif

#ifdef __MMI_WEARABLE_DEVICE__
    <SCREEN id="GRP_ID_VOL_HANDLER"/>
#endif
