...
typedef struct
{
    ...
    && !defined (__MMI_PROF_ADD_DEL_PROF_SUPPORT__)
...
#endif /*#ifndef __MMI_BASIC_UI_STYLE__*/
...
/* under construction !*/
    ...
    #elif (defined(__MMI_BASIC_UI_STYLE__) || defined(__INLINE_CUI_SLIM_SELECT_ITEM_STYLE__))
        cui_inline_set_title_string(inline_id, (WCHAR*)GetString(g_prof.curr_profile - MMI_PROF_PROF_ID_BEGIN + STR_ID_PROF_GENERAL));
    #elif defined(__MMI_PROF_ADD_DEL_PROF_SUPPORT__)
...
/*****************************************************************************
 * FUNCTION
 *  mmi_prof_bt_music_disconnect_callback_ext
 * DESCRIPTION
 *  callback for BT music disconnect
 * PARAMETERS
 *  MMI_BOOL result - MMI_TRUE if BT music disconnected
 ...
 *  void
 *****************************************************************************/
static void mmi_prof_bt_music_disconnect_callback_ext(MMI_BOOL result)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/
...
static void mmi_prof_set_volume_level(void)
{
    ...
    if (mmi_bt_music_check_connection())
    {
        mmi_bt_music_disconnect(mmi_prof_bt_music_disconnect_callback_ext);
        return;
    }
#endif
