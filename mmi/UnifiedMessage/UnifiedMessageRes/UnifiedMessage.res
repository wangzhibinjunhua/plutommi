...
#if defined(__MMI_CAMCORDER__) && defined(__MMI_APP_MANAGER_SUPPORT__) && defined(__MMI_TELEPHONY_SUPPORT__)
 ...
 <!-- 
...
#else
		<IMAGE id="IMG_UM_ENTRY_SCRN_CAPTION">CUST_IMG_BASE_PATH"\\\\EmptyImage.bmp"</IMAGE>
#endif
#ifdef __MMI_ICON_BAR_SUPPORT__
    ...
    ***************************************************************
...
#if (defined (__MMI_SMS_SLIM__) && !defined(__MMI_BT_MAP_CLIENT__))
    ...
    <MENU id="MENU_ID_UM_SETTING" type="APP_SUB" str="STR_UM_SETTING_ID" img="IMG_UM_SETTING_ID" highlight="mmi_um_highlight_setting">
                                    ...
                                    #if defined(__WAP_PUSH_SUPPORT__) && !defined(__WAP_PUSH_SERVICE_ONLY_SUPPORT__) && defined(BROWSER_SUPPORT)
