 ...
 * Description:
 * ------------
 *  MyTone function declaration and defines
 *
 * Author:
 * -------
 * -------
...
#ifndef _MMI_MY_TONE_H
#define  _MMI_MY_TONE_H

// #define MY_TONE_PATH "USER\\MyTone\\"                // MyTone folder path
#define MY_TONE_PATH "Audio\\"
