...
extern mmi_ret mmi_shct_quick_menu_scr_group_proc(mmi_event_struct *evt);
extern mmi_ret mmi_shct_quick_menu_cfg_scr_group_proc(mmi_event_struct *evt);
extern mmi_ret mmi_shct_dedicated_key_cfg_scr_group_proc(mmi_event_struct *evt);
extern void mmi_shct_launch_app_by_quick_menu(void);
extern void mmi_shct_entry_quick_menu(void);
extern void mmi_shct_create_folder(void);
...
extern void EntryShctDeleteScreen(void);
extern mmi_ret mmi_shct_del_cnf_cb(mmi_event_struct *evt);
...
extern void mmi_shct_launch_dedicated_key(void);
extern void mmi_shct_launch_dedicated_key_ext(MMI_ID parent_gid);
...
extern void mmi_shct_launch_app_by_nav_key(mmi_shct_nav_key_enum key);
