...
const swatch_icon_map_struct g_mmi_swatch_icon_table_one[]=
{
	...
	{"native.mtk.camcera", MAIN_MENU_SWATCH_BT_RMCP_ICON}, 
	{"native.mtk.sndrec", MAIN_MENU_SWATCH_SNDREC_ICON},
	{"native.mtk.bluetooth", 0},
	{"native.mtk.imageviewer",0},
	{"native.mtk.fmrdo", MAIN_MENU_ARROW_FM_ICON},
	{"native.mtk.audioplayerbt", MAIN_MENU_ARROW_AUDPLY_ICON},
	{"native.mtk.audioplayer", MAIN_MENU_ARROW_AUDPLY_ICON},
...
const swatch_icon_map_struct g_mmi_swatch_icon_table_four[]=
{
	...
	{"native.mtk.phonebook", MAIN_MENU_SWATCH_PHONE_BOOK_ICON_S},
	{"native.mtk.messaging", MAIN_MENU_SWATCH_MESSAGE_ICON_S},
	...
	{"native.mtk.camcera", MAIN_MENU_SWATCH_BT_RMCP_ICON_S},
	{"native.mtk.sndrec", MAIN_MENU_SWATCH_SNDREC_ICON_S},
    {"native.mtk.bluetooth", 0},
    {"native.mtk.imageviewer",0},
    {"native.mtk.fmrdo", MAIN_MENU_ARROW_FM_ICON_S},
    {"native.mtk.audioplayerbt", MAIN_MENU_ARROW_AUDPLY_ICON_S},
    {"native.mtk.audioplayer", MAIN_MENU_ARROW_AUDPLY_ICON_S},
    {"native.mtk.calllog", MAIN_MENU_ARROW_CALLLOG_ICON_S},
    {"native.mtk.mspace", 0},
    {"native.mtk.profile", 0},
  #if defined(__MTK_TARGET__)
    {"native.mtk.filemgr", 0},
 ...
 static void mmi_mainmenu_get_swatch_package_list()
{
	...
	for(j = 0; j < mmi_watch_default_order_count; j++)
	{
		...
		if(found == MMI_TRUE)
		{
			...
			if(result_icon != 0)
			{
                ...
                mainmenu_swatch_list.panel_cell[icon_index].pos.y = 
                    mainmenu_swatch_list.top_gap + page_count * mainmenu_swatch_list.page_size + row_num * mainmenu_swatch_list.cell_height+ mainmenu_swatch_list.cell_height/2;    
				//SWATCH_MAINMENU_STATUS_ICON_HEIGHT + row_num * SWATCH_MAINMENU_CELL_HEIGHT + SWATCH_MAINMENU_CELL_HEIGHT/2;
                #endif
	...
	//kal_prompt_trace(MOD_MMI,"mmi_mainmenu_get_swatch_package_list icon_index = %d\n", icon_index);
	//kal_prompt_trace(MOD_MMI,"mmi_mainmenu_get_swatch_package_list mainmenu_swatch_list.total_icon_num = %d\n", mainmenu_swatch_list.total_icon_num);
	if (icon_index < mainmenu_swatch_list.total_icon_num)// has app uninstall
	{
		//kal_prompt_trace(MOD_MMI,"mmi_mainmenu_get_swatch_package_list prevpen_move_offset = %d\n", mainmenu_swatch_list.prevpen_move_offset);
		...
		if (0 == mainmenu_swatch_list.swatch_mm_style)
	 	{
	 		if (mainmenu_swatch_list.prevpen_move_offset > ((icon_index-1) * mainmenu_swatch_list.page_size))
	 		{
				...
				//kal_prompt_trace(MOD_MMI,"mmi_mainmenu_get_swatch_package_list ajust prevpen_move_offset = %d\n", mainmenu_swatch_list.prevpen_move_offset);
	 		}
	 	}
		else if(1 == mainmenu_swatch_list.swatch_mm_style)
		{
			page_nums = icon_index / mainmenu_swatch_list.mainmenu_page_num - 1;
			//kal_prompt_trace(MOD_MMI,"mmi_mainmenu_get_swatch_package_list page_nums = %d\n", page_nums);
...
/* under construction !*/
#else
#ifdef __MMI_SMART_WATCH_MAINMENU_ONE__
/* under construction !*/
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
#endif
#ifdef __MMI_SMART_WATCH_MAINMENU_FOUR__
/* under construction !*/
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
static void mmi_main_menu_entry_swarch_style()
{
	...
	//#ifdef __MMI_MAINLCD_128X128__
	//mmi_mainmenu_swatch_draw_small_screen();
	//#else
