 ...
 *============================================================================
 *****************************************************************************/
#ifndef __SMS_BTMAPC_SRV_PROT_H__
#define __SMS_BTMAPC_SRV_PROT_H__
...
#define SRV_SMS_BTMAPC_MSG_LEN             160
...
#define SRV_SMS_BTMAPC_MAX_SPDU_SIZE       (sizeof(srv_sms_btmapc_spdu_struct))
#define SRV_SMS_BTMAPC_MAX_PDU_SIZE        (175)
...
typedef enum
{
    SRV_SMS_BTMAPC_NEW_MSG,
    SRV_SMS_BTMAPC_DELI_SUCC,
    SRV_SMS_BTMAPC_SEND_SUCC,
    SRV_SMS_BTMAPC_DELI_FAIL,
    SRV_SMS_BTMAPC_SEND_FAIL,
    SRV_SMS_BTMAPC_MEM_FULL,
    SRV_SMS_BTMAPC_MEM_AVAILABLE,
    SRV_SMS_BTMAPC_MSG_DELETED,
    SRV_SMS_BTMAPC_MSG_SHIFT,
    SRV_SMS_BTMAPC_FILE_ERROR
}srv_sms_btmapc_ind_enum;
...
typedef struct
{
    ...
    U16 real_size; // real size
    
    U8 msg_handle[(SRV_BT_MAP_MAX_HANDLE_STR_LEN + 1) * 2];

    U16 sender_name[SRV_BT_MAP_MAX_SENDER_NAME_LEN + 1];
} srv_sms_btmapc_msg_node_struct;
...
typedef struct
{
    ...
    U8 status;
    U8 pdu[SRV_SMS_BTMAPC_MAX_PDU_SIZE];
    U32 timestamp;
#ifdef __SRV_SMS_MULTI_SIM__
    U16 sim_id;
#endif /* __SRV_SMS_MULTI_SIM__ */
...
} srv_sms_btmapc_delete_cntx_struct;
...
typedef struct
{
    ...
    MYTIME timestamp;
} srv_sms_btmapc_int_msg_data_struct;
...
typedef struct
{
    ...
    SrvSmsCallbackFunc callback_func;
    void *user_data;
} srv_sms_btmapc_send_handle_struct;
