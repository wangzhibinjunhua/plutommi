 ...
 * Global function 
 *****************************************************************************/
extern srv_sync_type* srv_sync_remote_create(U8 accnt_index, void* user_data);
extern void srv_sync_remote_init(void);
extern U8 srv_sync_remote_app_id(void);
extern void srv_sync_remote_start(srv_sync_type *obj, const U8 *imei);
