...
mmi_ret srv_sim_ctrl_adp_init(mmi_event_struct *evt)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    mmi_frm_set_multi_protocol_event_handler(MSG_ID_MMI_SMU_PASSWORD_REQUIRED_IND, (PsIntFuncPtr)srv_sim_ctrl_adp_password_required_ind_hdlr);
    mmi_frm_set_multi_protocol_event_handler(MSG_ID_MMI_SMU_FAIL_IND, (PsIntFuncPtr)srv_sim_ctrl_adp_smu_fail_ind_hdlr);
