...
void srv_bt_cm_init_event_handler(void)
{
    ...
    SetProtocolEventHandler(srv_bt_cm_restart_req_ind_hdler, MSG_ID_BT_RESET_REQ_IND);
    SetProtocolEventHandler(srv_bt_cm_restart_rsp_hdler, MSG_ID_BT_MMI_RESET_CNF);

    SetProtocolEventHandler(srv_bt_cm_discovery_result_ind_hdler, MSG_ID_BT_BM_DISCOVERY_RESULT_IND);
    SetProtocolEventHandler(srv_bt_cm_discovery_cnf_hdler, MSG_ID_BT_BM_DISCOVERY_CNF);
    SetProtocolEventHandler(srv_bt_cm_cancel_discovery_cnf_hdler, MSG_ID_BT_BM_DISCOVERY_CANCEL_CNF);
    SetProtocolEventHandler(srv_bt_cm_set_local_name_cnf_hdler, MSG_ID_BT_BM_WRITE_LOCAL_NAME_CNF);

    mmi_frm_set_multi_protocol_event_handler(
        MSG_ID_BT_BM_READ_LOCAL_ADDR_CNF,
        srv_bt_cm_read_local_bd_addr_cnf_hdler);
    SetProtocolEventHandler(srv_bt_cm_read_remote_name_cnf_hdler, MSG_ID_BT_BM_READ_REMOTE_NAME_CNF);
    ...
    SetProtocolEventHandler(srv_bt_cm_link_connect_accept_ind_hdler, MSG_ID_BT_BM_LINK_CONNECT_ACCEPT_IND);

    SetProtocolEventHandler(srv_bt_cm_bond_ind_hdler, MSG_ID_BT_BM_BONDING_RESULT_IND);
    SetProtocolEventHandler(srv_bt_cm_bond_cnf_hdler, MSG_ID_BT_BM_BONDING_CNF);

    SetProtocolEventHandler(srv_bt_cm_debond_cnf_hdler, MSG_ID_BT_BM_DELETE_TRUST_CNF);

    SetProtocolEventHandler(srv_bt_cm_passkey_ind_hdler, MSG_ID_BT_BM_PIN_CODE_IND);
    SetProtocolEventHandler(srv_bt_cm_security_level_cnf_hdler, MSG_ID_BT_BM_WRITE_AUTHENTICATION_MODE_CNF);

    mmi_frm_set_multi_protocol_event_handler(
        MSG_ID_BT_BM_WRITE_SCANENABLE_MODE_CNF,
        srv_bt_cm_write_scanenable_mode_cnf_hdler);
    SetProtocolEventHandler(srv_bt_cm_link_state_ind_hdler, MSG_ID_BT_BM_LINK_STATE_IND);

#ifdef __MMI_BT_SIMPLE_PAIR__
    SetProtocolEventHandler(srv_bt_cm_security_user_confirm_ind_hdler, MSG_ID_BT_BM_SECURITY_USER_CONFIRM_IND);
    SetProtocolEventHandler(srv_bt_cm_security_passkey_notify_ind_hdler, MSG_ID_BT_BM_SECURITY_PASSKEY_NOTIFY_IND);
    SetProtocolEventHandler(srv_bt_cm_security_keypress_notify_ind_hdler, MSG_ID_BT_BM_SECURITY_KEYPRESS_NOTIFY_IND);
#endif /* __MMI_BT_SIMPLE_PAIR__ */

#ifdef __MMI_BT_AUTHORIZE__
    SetProtocolEventHandler(srv_bt_cm_block_active_link_cnf_hdler, MSG_ID_BT_BM_BLOCK_ACTIVE_LINK_CNF);
    SetProtocolEventHandler(srv_bt_cm_block_list_update_cnf_hdler, MSG_ID_BT_BM_BLOCK_LIST_UPDATE_CNF);
#endif /* __MMI_BT_AUTHORIZE__ */

#ifdef __BT_BOND_CANCEL__
    SetProtocolEventHandler(srv_bt_cm_bond_cancel_cnf_hdler, MSG_ID_BT_BM_BONDING_CANCEL_CNF);
#endif
}
