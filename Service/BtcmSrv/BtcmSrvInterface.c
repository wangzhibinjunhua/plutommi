...
static void srv_bt_cm_nvram_read_info(void)
{
    ...
    MMI_BT_ASSERT(NVRAM_EF_BT_INFO_SIZE == sizeof(srv_bt_cm_nvram_struct));
    MMI_BT_ASSERT(NVRAM_EF_BT_SYS_INFO_SIZE == sizeof(srv_bt_cm_sys_nvram_struct));
    MMI_BT_ASSERT((NVRAM_EF_BT_DEV_LIST_SIZE * NVRAM_EF_BT_DEV_LIST_TOTAL) ==
                  sizeof(srv_bt_cm_nvram_dev_list_struct));
    MMI_BT_ASSERT((NVRAM_EF_BT_DEV_LIST_INDEX_SIZE * NVRAM_EF_BT_DEV_LIST_INDEX_TOTAL) ==
                  sizeof(srv_bt_cm_nvram_dev_list_index_struct));
...
void srv_bt_cm_nvram_write_info(U16 LID, void* para)
{
    ...
    switch (LID)
    {
        ...
        //case NVRAM_EF_BT_DEV_LIST_INDEX_LID:
        {
            ...
            MMI_BT_ASSERT(
                (NVRAM_EF_BT_DEV_LIST_INDEX_SIZE * NVRAM_EF_BT_DEV_LIST_INDEX_TOTAL) ==
                sizeof(srv_bt_cm_nvram_dev_list_index_struct));
            MMI_BT_ASSERT(
                (NVRAM_EF_BT_DEV_LIST_SIZE * NVRAM_EF_BT_DEV_LIST_TOTAL) ==
                sizeof(srv_bt_cm_nvram_dev_list_struct));
