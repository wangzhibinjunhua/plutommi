...
class MmsService : public GS_CBase, public IMms
{

public:
    MmsService(U32 handle):GS_CBase(handle){}
    ...
    /* Functional API */
    virtual S32 CALLCC send_mms(gs_send_mms_req_t * req_ptr,  gs_mms_callback_type callback);
    virtual void CALLCC cancel_send_mms(void);
