...
/* To use the following functions, you must #define __SRV_PHB_CALLER_RES_DATA_STORE__ */
...
typedef struct
{
    UI_character_type db_file[SRV_FMGR_PATH_MAX_LEN + 1];
    U16 record_num;
    U16 record_size;
    U16 max_record_num;
    BOOL is_active;
...
extern S32 mmi_data_init_record_store(mmi_data_record_store_type *context, CHAR *db_file, S32 record_size);
