...
#else /* __MMI_CLOG_SLIM_FOR_MT6261__ */
    return srv_clog_idx_get_ur_mclt_num(srv_clog_cntx_p->comp->idx_tbl, num_list, sim_num);
#endif /* __MMI_CLOG_SLIM_FOR_MT6261__ */
}
...
#else /* __MMI_CLOG_SLIM_FOR_MT6261__ */
    srv_clog_get_idt((srv_clog_log_identity_struct*) identity, &idt);
    
    ret = srv_clog_idx_get_num_info(srv_clog_cntx_p->comp->idx_tbl, &idt, num_info);
#endif /* __MMI_CLOG_SLIM_FOR_MT6261__ */
...
#endif /* __MMI_CLOG_SLIM_FOR_MT6261__ 8/
...
#else /* __MMI_CLOG_SLIM_FOR_MT6261__ */
    memcpy(out_idt, src_idt, sizeof(srv_clog_log_identity_struct));
#endif /* __MMI_CLOG_SLIM_FOR_MT6261__ */
...
#else /* __MMI_CLOG_SLIM_FOR_MT6261__ */
    srv_clog_get_idt((srv_clog_log_identity_struct*) req_data, (srv_clog_log_identity_struct*) cnf_data);
#endif /* __MMI_CLOG_SLIM_FOR_MT6261__ */
...
#else /* __MMI_CLOG_SLIM_FOR_MT6261__ */
    srv_clog_idx_refresh(
        srv_clog_cntx_p->comp->idx_tbl,
        SRV_CLOG_LIST_LEVEL_SORT,
        (srv_clog_log_identity_struct*) cnf_data,
        &info_type);
    cnf_data->ret = (srv_clog_ret_enum)srv_clog_idx_get_list_ids(srv_clog_cntx_p->comp->idx_tbl, info_type, req_data, cnf_data);
#endif /* __MMI_CLOG_SLIM_FOR_MT6261__ */
...
#else /* __MMI_CLOG_SLIM_FOR_MT6261__ */
    ret = srv_clog_idx_get_log_by_id(srv_clog_cntx_p->comp->idx_tbl, SRV_CLOG_IDX_INFO_UNKNOWN, log_id, fields, log);
#endif /* __MMI_CLOG_SLIM_FOR_MT6261__ */
        ...
        srv_clog_get_last_log_cnf_struct *cnf_data)
{
    ...
    cnf_data->fields = req_data->fields;
    si_log = srv_clog_idx_get_last_log(srv_clog_cntx_p->comp->idx_tbl, (srv_clog_log_identity_struct*) cnf_data);
#endif /* __MMI_CLOG_SLIM_FOR_MT6261__ */
        ...
        SRV_CLOG_BASE_CB func_cb)
{
    ...
    SRV_CLOG_ID new_log_id;
    srv_clog_si_struct *si_log;
    srv_clog_add_log_req_struct* req;
    ...
    req = srv_clog_comp_new_para(sizeof(srv_clog_add_log_req_struct));

    /* General new log id */
    new_log_id = srv_clog_new_log_id(srv_clog_cntx_p);
    ...
    srv_clog_add_log_hdlr(new_log_id, req, func_cb);

    srv_clog_mfree(SRV_CLOG_MEM_TYPE_TEMP, req);
...
static void srv_clog_revise_add_req(srv_clog_log_struct *log, SRV_CLOG_ID log_id)
{
    ...
    if (SRV_CLOG_IS_PHB_ID_VALID(log->data.call_log.phb_id))
    {
        ret = srv_phb_get_number_by_number_id(phb_num, log->data.call_log.phb_id, SRV_CLOG_CID_MAX_LEN);
        if (ret && srv_phb_compare_number(phb_num, log->data.call_log.cid))
        {
            ;
        }
        else
        {
            ...
            memset(log->data.call_log.name, 0x00, SRV_CLOG_NAME_MAX_LEN);
        }
    }
        ...
        SRV_CLOG_BASE_CB func_cb)
{
...
#else /* __MMI_CLOG_SLIM_FOR_MT6261__ */
    log_id = srv_clog_cmn_get_log_id((srv_clog_log_struct*) & req_data->log_data);
#endif /* __MMI_CLOG_SLIM_FOR_MT6261__ */
    ...
    return job->pid;
#else /* __MMI_CLOG_SLIM_FOR_MT6261__ */
    srv_clog_update_log_hdlr(log_id, (srv_clog_update_log_req_struct*)req_data, func_cb);
    return pid;
#endif /* __MMI_CLOG_SLIM_FOR_MT6261__ */
}
        ...
        SRV_CLOG_BASE_CB func_cb)
{
...
#else /* __MMI_CLOG_SLIM_FOR_MT6261__ */
    req = srv_clog_comp_new_para(sizeof(srv_clog_update_all_logs_req_struct));
    if (req && req_data)
        memcpy(req, req_data, sizeof(srv_clog_update_all_logs_req_struct));

    srv_clog_get_idt((srv_clog_log_identity_struct*) req_data, (srv_clog_log_identity_struct*) req);
#endif /* __MMI_CLOG_SLIM_FOR_MT6261__ */
    ...
    return job->pid;
#else /* __MMI_CLOG_SLIM_FOR_MT6261__ */
    srv_clog_update_all_logs_hdlr(req, func_cb);
    srv_clog_mfree(SRV_CLOG_MEM_TYPE_TEMP, req);
    return pid;
#endif /* __MMI_CLOG_SLIM_FOR_MT6261__ */
}
...
S32 srv_clog_delete_log_by_id(SRV_CLOG_HANDLE handle, S32 pid, SRV_CLOG_ID log_id, SRV_CLOG_BASE_CB func_cb)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    SRV_CLOG_PARAM_CHECK (log_id > srv_clog_cntx_p->max_log_id, SRV_CLOG_RET_INVALID_PARAM);

    MMI_TRACE(SRV_CLOG_TRC_INFO, TRC_SRV_CLOG_DELETE_LOG_BY_ID, pid, log_id, func_cb == NULL ? 0 : 1);

    srv_clog_delete_log_by_id_hdlr(log_id, func_cb);
        ...
        SRV_CLOG_BASE_CB func_cb)
{
...
#else /* __MMI_CLOG_SLIM_FOR_MT6261__ */
    req = srv_clog_comp_new_para(sizeof(srv_clog_del_all_logs_req_struct));
    if (req && req_data)
        memcpy(req, req_data, sizeof(srv_clog_del_all_logs_req_struct));
    ...
    return job->pid;
#else /* __MMI_CLOG_SLIM_FOR_MT6261__ */
    srv_clog_delete_logs_hdlr(req, func_cb);
    srv_clog_mfree(SRV_CLOG_MEM_TYPE_TEMP, req);
    return pid;
#endif /* __MMI_CLOG_SLIM_FOR_MT6261__ */
}
        ...
        SRV_CLOG_BASE_CB func_cb)
{
    ...
    srv_clog_get_idt(inst, (srv_clog_log_identity_struct*) req_data, (srv_clog_log_identity_struct*) job->req_data);
#else /* __MMI_CLOG_SLIM_FOR_MT6261__ */
    req = srv_clog_comp_new_para(sizeof(srv_clog_search_list_log_ids_req_struct));
    if (req && req_data)
        memcpy(req, req_data, sizeof(srv_clog_search_list_log_ids_req_struct));
    ...
    return job->pid;
#else /* __MMI_CLOG_SLIM_FOR_MT6261__ */
    srv_clog_search_list_log_ids_hdlr(req, func_cb);
    srv_clog_mfree(SRV_CLOG_MEM_TYPE_TEMP, req);
    return pid;
#endif /* __MMI_CLOG_SLIM_FOR_MT6261__ */
}
