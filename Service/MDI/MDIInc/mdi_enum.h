...
typedef enum
{
    MDI_MTV_SERVICE_STATE_CLOSED = 0,
    MDI_MTV_SERVICE_STATE_CLOSING,
    MDI_MTV_SERVICE_STATE_OPENED,
    MDI_MTV_SERVICE_STATE_SCANNING,
    MDI_MTV_SERVICE_STATE_ESG_DOWNLOADING,
    MDI_MTV_SERVICE_STATE_SAVING,
    MDI_MTV_SERVICE_STATE_INIT,
    MDI_MTV_SERVICE_STATE_READY,

    MDI_MTV_SERVICE_STATE_SUBSCRIBING,
    MDI_MTV_SERVICE_STATE_UNSUBSCRIBING,
    MDI_MTV_SERVICE_STATE_ACCOUNT_INQUIRY,
    MDI_MTV_SERVICE_STATE_SUBSCRIPTION_UPDATE,
    MDI_MTV_SERVICE_STATE_UPGRADE_QUERY,
    MDI_MTV_SERVICE_STATE_AREA_SET_RETRIEVE,
    MDI_MTV_SERVICE_STATE_INTERACTIVITY_RETRIEVE,
    MDI_MTV_SERVICE_STATE_EMM,
    MDI_MTV_SERVICE_STATE_CA,
...
typedef enum
{
    ...
    MDI_MTV_RECORDER_STATE_PAUSED,
    MDI_MTV_RECORDER_STATE_SAVING,
    MDI_MTV_RECORDER_STATE_DELETING,
...
/* Should be sync with media_mtv_service_type_enum */
typedef enum
{
