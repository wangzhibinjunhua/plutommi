...
typedef void (*mdi_seek_callback) (kal_uint8 reason /* aud_seek_reason_enum */, void* data);
...
#define MDI_RES_VDOREC_REACH_TIME_LIMIT               2004
...
#define MDI_RES_VDOREC_ERR_MEMORY_INSUFFICIENT        -2014
#define MDI_RES_VDOREC_ERR_STORAGE_INSUFFICIENT       -2015
#define MDI_RES_VDOREC_ERR_NO_FRAME_ENCODED           -2016
...
#define MDI_RES_VDOPLY_ONLY_VIDEO_TRACK_ERROR         3008
#define MDI_RES_VDOPLY_ONLY_AUDIO_TRACK_ERROR         3009
...
#define MDI_RES_VDOPLY_ERR_GET_FRAME_FAILED           -3021
...
/* video clip 5000 */
#define MDI_RES_VDOCLIP_SUCCEED                         0
#define MDI_RES_VDOCLIP_ERR_FAILED                    -5001
#define MDI_RES_VDOCLIP_ERR_DISK_FULL                 -5002
#define MDI_RES_VDOCLIP_ERR_NO_DISK                   -5003

/* Mobile TV 6000 */
#define MDI_RES_MTV_COMPLETE_SAVING             (6001)
#define MDI_RES_MTV_UNSAVE_RECORDING_IND        (6002)
#define MDI_RES_MTV_MBBMS_SG_UPDATED            (6003)
#define MDI_RES_MTV_UPGRADE_NONE                (6004)
#define MDI_RES_MTV_UPGRADE_NEED                (6005)
#define MDI_RES_MTV_UPGRADE_MANDATORY           (6006)
#define MDI_RES_MTV_FILE_EXISTED                (6007)
...
#define MDI_RES_MTV_ERR_SNAPSHOT_FAILED         (-6011)
#define MDI_RES_MTV_FIND_UNSAVED_RECORDING_FAIL (-6012)
#define MDI_RES_MTV_START_PLAY_FAIL             (-6013)
#define MDI_RES_MTV_ERR_DISC_IO_ERROR           (-6014)
#define MDI_RES_MTV_ERR_OVER_LIMIT              (-6015)
#define MDI_RES_MTV_ERR_SUBSCRIBE_FAIL          (-6016)
#define MDI_RES_MTV_ERR_UNSUBSCRIBE_FAIL        (-6017)
#define MDI_RES_MTV_ERR_ACCOUNT_INQUIRY_FAIL    (-6018)
#define MDI_RES_MTV_ERR_MSK_RETRIEVE_FAIL       (-6019)
#define MDI_RES_MTV_ERR_SAVE_FAILED             (-6020)
#define MDI_RES_MTV_ERR_AREA_RETRIEVE_FAIL      (-6021)
#define MDI_RES_MTV_ERR_INTERACTIVITY_RETRIEVE_FAIL (-6022)



#define MDI_RES_MTV_MBBMS_DEVICE_AUTHENTICATION_FAILED      (-6050)
#define MDI_RES_MTV_MBBMS_PURCHASE_ITEM_UNKNOWN             (-6051)
#define MDI_RES_MTV_MBBMS_SERVICE_ERROR                     (-6052)
#define MDI_RES_MTV_MBBMS_MAL_FORMED_MESSAGE_ERROR          (-6053)
#define MDI_RES_MTV_MBBMS_NO_SUBSCRIPTION                   (-6054)
#define MDI_RES_MTV_MBBMS_OPERATION_NOT_PERMITTED           (-6055)
#define MDI_RES_MTV_MBBMS_REQUESTED_SERVICE_UNAVAILABLE     (-6056)
#define MDI_RES_MTV_MBBMS_REQUESTED_SERVICE_ACCEPTED        (-6057)
#define MDI_RES_MTV_MBBMS_INVALID_REQUEST                   (-6058)
#define MDI_RES_MTV_MBBMS_DELIVERY_OF_WRONG_KEY_INFORMATION (-6059)
#define MDI_RES_MTV_MBBMS_ALREADY_IN_USE                    (-6060)
#define MDI_RES_MTV_MBBMS_NO_MATCHING_FRAGMENT              (-6061)
#define MDI_RES_MTV_MBBMS_NOW_SUBSCRIBED                    (-6062)
#define MDI_RES_MTV_MBBMS_INSUFFICIENT_CHARGE               (-6063)
#define MDI_RES_MTV_MBBMS_INVALID_NW_PARAM                  (-6064)
#define MDI_RES_MTV_MBBMS_NW_TIMEOUT                        (-6065)
#define MDI_RES_MTV_MBBMS_LOCATION_DETECT_FAIL              (-6066)
