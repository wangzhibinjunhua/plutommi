 ...
 *==============================================================================
 *******************************************************************************/
#ifndef _WAPPROVISIONINGSRVGPROT_H
#define _WAPPROVISIONINGSRVGPROT_H
...
/* EVENT STRUCTURE for EVT_ID_SRV_UPP_CREATE_PROV_SCR_IND 
typedef struct{
 ...
 EVENT STRUCTURE for EVT_ID_SRV_UPP_PREENTRY_PROV_SCR_IND 
typedef struct{
   MMI_EVT_PARAM_HEADER

}srv_wap_prov_preentry_prov_scrn_evt_struct;  	
...
#endif
#endif /* WAP_SUPPORT */ 
#endif /* _WAPPROVISIONINSRVGPROT_H */ 
