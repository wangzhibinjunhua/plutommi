...
#include "DevApp_ImgDecoderDef.h"
...
int BMPLoader(char *in_filename, char *out_filename, S8 color_depth)
{
    ...
    if (toolFlag == 1)
    {
        ...
        if (g_is9slice)
        {
            ...
            mmi_rg_write_9slice_header(IMAGE_TYPE_DEVICE_BITMAP, dest_file, MMI_TRUE);
        }
    ...
    else if (enfbFlag == 1) 
    {
        ...
        {
            /* Write 9slice file header */
            mmi_rg_write_9slice_header(IMAGE_TYPE_DEVICE_BITMAP, enfb_img_data_file, MMI_TRUE);
        }
    ...
    else    /* Write to .c .h file */
    {
        ...
        {
            /* Write 9slice file header */
            mmi_rg_write_9slice_header(IMAGE_TYPE_DEVICE_BITMAP, outfile, MMI_FALSE);
        }
